...
The conditional compilation expression refers to a non-intrinsic type, but only intrinsic types are allowed.  
 ...
 For more information about the intrinsic type in [!INCLUDE[vbprvb](../code-quality/includes/vbprvb_md.md)], see [Data Types Summary](/dotnet/visual-basic/language-reference/keywords/data-types-summary).  
