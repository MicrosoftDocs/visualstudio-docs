...
|[DA0013: High usage of String.Split or String.Substring](../profiling/da0013-high-usage-of-string-split-or-string-substring.md)|Calls to the <xref:System.String.Split*?displayProperty=fullName> or <xref:System.String.Substring*> methods are a significant portion of the profiling data. Consider using <xref:System.String.IndexOf*> or <xref:System.String.IndexOfAny*> if you are testing for the existence of a substring in a string.|  
