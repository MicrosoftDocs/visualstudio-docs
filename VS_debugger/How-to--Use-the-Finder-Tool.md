...
You can use the Finder Tool in the **Find Window** dialog box to display window properties or messages. The Finder Tool can also locate disabled child windows, and discern which window to highlight if disabled child windows overlap.  
 ...
 ![Spy&#43;&#43; Find Window Dialog Box](../VS_debugger/media/Icon_Spy--_Find.png "Icon_Spy++_Find")  
...
2.  From the **Spy** menu, choose **Find Window**.  
     ...
     The [Find Window Dialog Box](../VS_debugger/Find-Window-Dialog-Box.md) opens.  
...
5.  Press **OK**.  
     ...
     If you selected **Properties**, the [Window Properties Dialog Box](../VS_debugger/Window-Properties-Dialog-Box.md) opens. If you selected **Messages**, a [Messages View](../VS_debugger/Messages-View.md) window opens.  
