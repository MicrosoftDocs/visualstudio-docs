...
1.  In the **Call Stack** window, open the shortcut menu. Choose **Show Call Stack on Code Map**. (Keyboard: **CTRL** + **SHIFT** + **`**)  
     ...
     See [Map methods on the call stack while debugging](../VS_debugger/Map-methods-on-the-call-stack-while-debugging-in-Visual-Studio.md).  
...
-   See [Run to a specified location or function](../VS_debugger/Navigating-through-Code-with-the-Debugger.md#BKMK_Run_to_a_specified_location_or_function).  
  
### To set a breakpoint on the exit point of a function call  
  
-   See [Set a breakpoint at a source line, assembly instruction, or call stack function](../VS_debugger/Using-Breakpoints.md#BKMK_Set_a_breakpoint_at_a_source_line__assembly_instruction__or_call_stack_function_).  
