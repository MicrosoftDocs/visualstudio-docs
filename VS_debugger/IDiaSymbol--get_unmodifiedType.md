...
Retrieves the original type for this symbol. Use when the [SymTagEnum Enumeration](../VS_debugger/SymTagEnum.md) is set to a type.  
...
#### Parameters  
 `pRetVal`  
 [out] Returns an [IDiaSymbol](../VS_debugger/IDiaSymbol.md) object that represents the original type of this symbol.  
