...
Use the **Windows** tab to show information on windows related to the selected window. To display the [Window Properties Dialog Box](../VS_debugger/Window-Properties-Dialog-Box.md), move the focus to the [Windows View](../VS_debugger/Windows-View.md) window. Select any window node in the tree, then choose **Properties** from the **View** menu.  
