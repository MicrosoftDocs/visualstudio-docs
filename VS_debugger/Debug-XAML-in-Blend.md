...
10. Press Ctrl+Shift+B to build the project.  
 ...
 ![Debug XAML in Blend for Visual Studio](../VS_debugger/media/blend_debugXAML_XAML.png "blend_debugXAML_XAML")  
...
5.  Double-click "The property 'Mame' does not exist in the 'http://schemas.microsoft.com/winfx/2006/xaml' namespace." The "M" in "Mame" should be an "N." Replace the "M" with an "N." Now that the XAML can be parsed, the app appears on the design surface.  
     ...
     ![Debugging XAML in Blend for Visual Studio](../VS_debugger/media/blend_debugArtboard_XAML.png "blend_debugArtboard_XAML")  
...
## Getting help  
 If you need more help debugging your Blend app, you can search the [Windows Store app community forums](http://go.microsoft.com/fwlink/?LinkId=280308) for posts related your issue or post a question.