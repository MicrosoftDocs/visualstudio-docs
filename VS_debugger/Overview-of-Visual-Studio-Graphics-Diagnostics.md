...
### Diagnostics capture interface  
 ...
 See [Capturing Graphics Information](../VS_debugger/Capturing-Graphics-Information.md) for more information.  
...
### GPU Usage  
 ...
 See [GPU Usage](../VS_debugger/GPU-Usage.md) for more information.  
...
## Graphics Analyzer  
 ...
 ![All of the graphics debugger windows](../VS_debugger/media/GraphicsDebuggerWindows.png "GraphicsDebuggerWindows")  
  
### The graphics toolbar (Graphics Analyzer)  
 The Graphics toolbar provides quick access to Graphics Analyzer tool windows.  
  
 ![The Graphics toolbar in graphics diagnostics mode](../VS_debugger/media/vsg_toolbar.png "vsg_toolbar")  
...
### Graphics State  
 ...
 The [State](../VS_debugger/Graphics-State.md) window collects the state information relevant to each draw call together in one place so that it's easier to find, and also highlights the state changes that have occurred since the previous draw call.  
