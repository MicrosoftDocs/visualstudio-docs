...
The code in this topic is the sample file for the [Control execution in a debug session (JavaScript)](../VS_debugger/Control-execution-of-a-Store-app-in-a-Visual-Studio-debug-session-for-Windows-Store-apps--JavaScript-.md) topic.  
