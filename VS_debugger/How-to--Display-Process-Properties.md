...
To find out more about a process listed in [Processes View](../VS_debugger/Processes-View.md), use the [Process Properties Dialog Box](../VS_debugger/Process-Properties-Dialog-Box.md).  
