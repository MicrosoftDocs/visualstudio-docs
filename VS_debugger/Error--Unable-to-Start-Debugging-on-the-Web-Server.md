...
##  <a name="vxtbshttpservererrorsthingstocheck"></a> Make sure IIS is configured properly  
 ...
 For information about deploying to IIS7.5, see [Remote Debugging ASP.NET on a Remote IIS 7.5 Computer](../VS_debugger/Remote-Debugging-ASP.NET-on-a-Remote-IIS-7.5-Computer.md).  
  
##  <a name="vxtbshttpservererrorswebapplicationsonremoteservers"></a> Make sure the Visual Studio Remote Tools are installed  
 If you are trying to debug on a remote Web server, the Visual Studio Remote Tools must be installed. For information about downloading and installing the remote tools, see [Remote Debugging](../VS_debugger/Remote-Debugging.md).  
