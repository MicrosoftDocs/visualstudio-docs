...
1.  Arrange your windows so that Spy++, the [Windows View](../VS_debugger/Windows-View.md) window, and the target window are visible.  
  
2.  From the **Search** menu, choose **Find Window**.  
  
     The [Window Search Dialog Box](../VS_debugger/Window-Search-Dialog-Box.md) opens.  
...
5.  Click **OK**.  
     ...
     If a matching window is found, it is highlighted in the [Windows View](../VS_debugger/Windows-View.md) window.