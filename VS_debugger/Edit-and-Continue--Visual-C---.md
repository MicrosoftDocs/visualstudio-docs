...
You can use Edit and Continue in Visual C++ projects. See [Supported Code Changes (C++)](../VS_debugger/Supported-Code-Changes--C---.md) for information about the limitations of Edit and Continue.  
 ...
 **/Zo** disables Edit and Continue. See [How to: Debug Optimized Code](../VS_debugger/How-to--Debug-Optimized-Code.md).  
