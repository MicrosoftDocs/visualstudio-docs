...
## Remarks  
 To determine the type of checksum algorithm that was used to generate the checksum bytes, call the [IDiaSourceFile::get_checksumType](../VS_debugger/IDiaSourceFile--get_checksumType.md) method.  
