...
## UIElement List  
 **Print a Message**  
 Prints a message, using DebuggerDisplay syntax. For more information, see [Using the DebuggerDisplay Attribute](../VS_debugger/Using-the-DebuggerDisplay-Attribute.md).  
