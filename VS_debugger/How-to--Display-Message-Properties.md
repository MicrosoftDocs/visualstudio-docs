...
To find out more about a message listed in [Messages View](../VS_debugger/Messages-View.md), use the [Message Properties Dialog Box](../VS_debugger/Message-Properties-Dialog-Box.md).  
