...
#### Parameters  
 `pRetVal`  
 [out] Returns a value from the [StackFrameTypeEnum Enumeration](../VS_debugger/StackFrameTypeEnum.md) enumeration that indicates the compiler-specific frame type.  
