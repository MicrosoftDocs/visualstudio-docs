...
9. Choose the **Events** tab in the pane on the right side of DOM Explorer.  
     ...
     ![Events Tab of the DOM Explorer](../VS_debugger/media/JS_DOM_Events.png "JS_DOM_Events")  
...
11. To quickly identify event listeners for parent elements in the DOM hierarchy, choose a parent element in the hierarchy list at the bottom of the DOM Explorer.  
     ...
     ![Selecting parent elements in the DOM hierarchy](../VS_debugger/media/JS_DOM_Breadcrumbs.png "JS_DOM_Breadcrumbs")  
...
-   Use the JavaScript memory analyzer to [JavaScript Memory](../VS_IDE/JavaScript-Memory.md) in your app. Event listeners that must be explicitly removed might appear as a memory leak.  
