...
## Attributes  
 In C# and Visual Basic, you can add expansions for custom data using <xref:System.Diagnostics.DebuggerTypeProxyAttribute?qualifyHint=False>, <xref:System.Diagnostics.DebuggerDisplayAttribute?qualifyHint=False>, and <xref:System.Diagnostics.DebuggerBrowsableAttribute?qualifyHint=False>.  
...
## Visualizers  
 You can write a visualizer to display any managed data type. For more information, see [How to: Write a Visualizer](../VS_debugger/How-to--Write-a-Visualizer.md).  
