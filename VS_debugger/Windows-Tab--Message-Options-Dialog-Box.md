...
Use the **Windows** tab to set the scope of the messages listed in [Messages View](../VS_debugger/Messages-View.md). To display the [Message Options Dialog Box](../VS_debugger/Message-Options-Dialog-Box.md), choose **Log Messages** from the **Spy** menu.  
