...
1.  Arrange your windows so that Spy++ and an active [Threads View](../VS_debugger/Threads-View.md) window are visible.  
  
2.  From the **Search** menu, choose **Find Thread**.  
  
     The [Thread Search Dialog Box](../VS_debugger/Thread-Search-Dialog-Box.md) opens.  
