...
> [!TIP]
>  The optional Graphics Tools feature of Windows 10 provides lightweight capture and playback functionality—such as the command-line capture program **dxcap.exe**—that can be used in support, testing, and diagnostic scenarios on machines where developer tools aren't installed. For more information, see the [Command-Line Capture Tool](../VS_debugger/Command-Line-Capture-Tool.md) topic.  
...
### 4 – Examine captured frames in the Graphics Analyzer  
 ...
 To learn more about how to use the Graphics Analyzer tools together, see the [Examples](../VS_debugger/Graphics-Diagnostics-Examples.md).  
