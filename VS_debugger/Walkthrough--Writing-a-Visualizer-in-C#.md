...
2.  On the **Debug** menu, choose **Start**.  
 ...
 If you want to use your visualizer in Visual Studio rather than just calling it from the test harness, you have to install it. For more information, see [How to: Install a Visualizer](../VS_debugger/How-to--Install-a-Visualizer.md).  
