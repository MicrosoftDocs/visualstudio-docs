...
5.  In the **Policy** column, double-click **Debug programs** to view current local group policy assignments in the **Local Security Policy Setting** dialog box.  
     ...
     ![Local Security Policy User Rights](../VS_debugger/media/DBG_ERR_LocalSecurityPolicy_UserRightsDebugPrograms.png "DBG_ERR_LocalSecurityPolicy_UserRightsDebugPrograms")  
...
5.  In the **Network access: Sharing and security model for local accounts** dialog box, change the value to **Classic - local users authenticate as themselves** and click the **Apply** button.  
     ...
     ![Local Security Policy Security Options](../VS_debugger/media/DBG_ERR_LocalSecurityPolicy_SecurityOptions_NetworkAccess.png "DBG_ERR_LocalSecurityPolicy_SecurityOptions_NetworkAccess")  
