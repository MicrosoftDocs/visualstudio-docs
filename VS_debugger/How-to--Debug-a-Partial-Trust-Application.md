...
Applies to Windows and console applications.  
 ...
 [ClickOnce Security and Deployment](../VS_IDE/ClickOnce-Security-and-Deployment.md) makes it easy to deploy partial trust applications that take advantage of [Code Access Security](../Topic/Code%20Access%20Security.md) to limit access to resources on a machine.  
