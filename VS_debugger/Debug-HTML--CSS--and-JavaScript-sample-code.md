...
![Applies to Windows and Windows Phone](../VS_debugger/media/windows_and_phone_content.png "windows_and_phone_content")  
 ...
 The code in this topic is the sample file for [Quickstart: Debug HTML and CSS](../VS_debugger/Quickstart--Debug-HTML-and-CSS.md). The errors present by design in the QuickStart are fixed in this version of the code.  
