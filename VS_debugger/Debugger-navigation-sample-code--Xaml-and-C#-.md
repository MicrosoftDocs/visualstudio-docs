...
The code in this topic is the sample file for the [Navigate a debug session  (Xaml and C#)](../VS_debugger/Navigate-a-debugging-session-in-Visual-Studio--Xaml-and-C#-.md) topic.  
