...
1.  On the device or server machine that you want to debug (rather than the machine running Visual Studio), open the download page at [My.VisualStudio.com](https://my.visualstudio.com/Downloads?q=remote%20tools%20visual%20studio%202015)  
     ...
     ![DBG&#95;remote&#95;dbg&#95;download](../VS_debugger/media/DBG_remote_dbg_download.png "DBG_remote_dbg_download")  
...
3.  When you start the remote tools for the first time (or before you have configured it), the **Remote Debugging Configuration** dalog box appears.  
     ...
     ![RemoteDebuggerConfWizardPage](../VS_debugger/media/RemoteDebuggerConfWizardPage.png "RemoteDebuggerConfWizardPage")  
...
7.  When configuration is complete, the Remote Debugger window appears.  
     ...
     ![RemoteDebuggerWindow](../VS_debugger/media/RemoteDebuggerWindow.png "RemoteDebuggerWindow")  
...
-   To change the Authentication mode or the port number, or to specify a timeout value for the remote tools: choose **Tools / Options**.  
     ...
     For a listing of the port numbers used by default, see [Remote Debugger Port Assignments](../VS_debugger/Remote-Debugger-Port-Assignments.md).  
...
4.  Set the **Debugger to launch** to **Remote Windows Debugger**.  
     ...
     ![RemoteDebuggingCPlus](../VS_debugger/media/RemoteDebuggingCPlus.png "RemoteDebuggingCPlus")  
...
7.  For the **Debug** configuration, select the **Deploy** check box.  
     ...
     ![RemoteDebugCplusDeploy](../VS_debugger/media/RemoteDebugCplusDeploy.png "RemoteDebugCplusDeploy")  
...
4.  On the **Properties** page, choose the **Debug** tab.  
     ...
     ![RemoteDebuggerCSharp](../VS_debugger/media/RemoteDebuggerCSharp.png "RemoteDebuggerCSharp")  
...
## Remote debug an ASP.NET application  
 ...
 For remote computers running Windows 7 or Windows Server 2008 that have IIS 7.5 installed, please see [Remote Debugging ASP.NET on a Remote IIS 7.5 Computer](../VS_debugger/Remote-Debugging-ASP.NET-on-a-Remote-IIS-7.5-Computer.md).  
