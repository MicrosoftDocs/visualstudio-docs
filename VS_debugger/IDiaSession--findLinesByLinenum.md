...
#### Parameters  
 ...
 `file`  
 [in] An [IDiaSourceFile](../VS_debugger/IDiaSourceFile.md) object that represents the source file to search in. This parameter cannot be `NULL`.  
...
>  You cannot use zero to specify all lines (use the [IDiaSession::findLines](../VS_debugger/IDiaSession--findLines.md) method to find all lines).  
 ...
 `ppResult`  
 [out] Returns an [IDiaEnumLineNumbers](../VS_debugger/IDiaEnumLineNumbers.md) objta that contains a list of the line numbers retrieved.  
