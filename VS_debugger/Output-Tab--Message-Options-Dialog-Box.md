...
Use the **Output** tab to specify what data from each message to list in [Messages View](../VS_debugger/Messages-View.md). To display the [Message Options Dialog Box](../VS_debugger/Message-Options-Dialog-Box.md), choose **Log Messages** from the **Spy** menu.  
