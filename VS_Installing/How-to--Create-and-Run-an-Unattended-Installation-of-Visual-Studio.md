...
You can run the installation application for Visual Studio as an unattended (that is, customized silent) installation over an intranet instead of from media such as DVDs. This topic describes how to prepare Visual Studio for this type of installation from a network share.  
...
2.  Click the **Details** tab, and then make note of the **Product version** property.  
     ...
     ![Example of the Properties dialog box in an unattended installation of Visual Studio](../VS_Installing/media/Unattended-Install---Properties-Dialog-Box.PNG "Unattended Install - Properties Dialog Box")  
