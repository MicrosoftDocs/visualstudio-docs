...
|**/norestart**|Prevents the installation application from restarting the computer during or after installation. See the Return Codes section of the [Visual Studio Administrator Guide](../VS_Installing/Visual-Studio-Administrator-Guide.md) for the return codes to look for.|  
...
|**/u**<br /><br /> **/Uninstall**|Uninstalls Visual Studio.|  
