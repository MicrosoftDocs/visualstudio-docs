...
2.  Install or reinstall the earlier version of Visual Studio that you want to use.  
 ...
 Even if you install a previous version of Visual Studio, the Setup program might still try to use a newer version or release if one is available. For more detailed information, see the [How to: Install a Specific Release of Visual Studio](../VS_Installing/How-to--Install-a-Specific-Release-of-Visual-Studio.md) topic.  
