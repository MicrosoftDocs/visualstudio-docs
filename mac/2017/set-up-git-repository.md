...
3. Choose the **Registered Repositories** tab and press the **Add** button:
    ...
    ![Screenshot of Quick setup page, which provides an option to display and copy either the HTTPS or SSH address to the repo.](media/version-control-git5.png)
