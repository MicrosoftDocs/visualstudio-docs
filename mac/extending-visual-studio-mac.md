...
Visual Studio for Mac [introduces a new native Cocoa text editor UI](/visualstudio/releasenotes/vs2019-mac-relnotes) built on top of the same editor layers from Visual Studio on Windows.
