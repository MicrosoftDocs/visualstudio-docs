...
|----------------|-----------------|  
|**Theme Name:**|The name that identifies the theme in the [Themes, Workflow Designer, Options Dialog Box (Legacy)](../WF_Design/Themes--Workflow-Designer--Options-Dialog-Box--Legacy-.md). A changeable name is generated for new themes.|  
