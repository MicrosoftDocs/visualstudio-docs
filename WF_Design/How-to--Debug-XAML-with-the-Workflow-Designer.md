...
2.  Set a breakpoint on the activity or activities you want to debug as described in [How to: Set Breakpoints in Workflows](../WF_Design/How-to--Set-Breakpoints-in-Workflows.md).  
...
4.  Invoke the debugger as described in [How to: Invoke the Workflow Debugger](../WF_Design/How-to--Invoke-the-Workflow-Debugger.md).  
