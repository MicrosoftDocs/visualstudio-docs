...
## Remarks  
 These values are returned in the `Fields` member of the [PROVIDER_PROCESS_DATA](../extensibility/provider_process_data.md) structure to indicate which fields of the structure were explicitly filled in.  
