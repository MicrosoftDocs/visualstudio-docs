...
#### Parameters  
 ...
 `wLangId`  
 [in] Locale of the debug engine. This can be 0 if the [SetLocale](../extensibility/idebugengine2--setlocale.md) method should not be called.  
...
## See Also  
 ...
 [SetLocale](../extensibility/idebugengine2--setlocale.md)