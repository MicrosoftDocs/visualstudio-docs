...
|\<xref:Microsoft.VisualStudio.Shell.Interop.SLicensedClassManager>|\<xref:Microsoft.VisualStudio.Shell.Interop.ILicensedClassManager>|Yes|Yes|Enables a VSPackage to indicate to [!INCLUDE[vsprvs](../codequality/includes/vsprvs_md.md)] the classes that it requires by specifying a list of license keys.|  
