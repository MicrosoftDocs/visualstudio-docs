...
## Members  
 ...
 Indicates that the managed code debugger should handle exceptions. If not set, the default debugger handles the exceptions. This is passed to the [SetAllExceptions](../extensibility/idebugengine3--setallexceptions.md) method and not used in the [EXCEPTION_INFO](../extensibility/exception_info.md) structure.  
...
## Remarks  
 Used as the `dwState` member of the [EXCEPTION_INFO](../extensibility/exception_info.md) structure to indicate the state of the exception and what can be done about it.  
  
 These values are also passed to the [SetAllExceptions](../extensibility/idebugengine3--setallexceptions.md) method to set the state of all exceptions.  
...
## See Also  
 ...
 [SetAllExceptions](../extensibility/idebugengine3--setallexceptions.md)