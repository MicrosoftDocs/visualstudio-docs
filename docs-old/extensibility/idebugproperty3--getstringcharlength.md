...
## Remarks  
 Typically, this method is used as a prelude to allocating a buffer for a call to the [GetStringChars](../extensibility/idebugproperty3--getstringchars.md) method.  
...
## See Also  
 [GetStringChars](../extensibility/idebugproperty3--getstringchars.md)   
