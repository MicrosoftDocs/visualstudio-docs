...
Retrieves a flag that specifies whether the preprocesser directive for a safe buffer is used. Use when the [SymTagEnum Enumeration](../debugger/symtagenum.md) is set to `SymTagFunction`.  
