...
-   Install Mage.exe and MageUI.exe.  
     ...
     Mage.exe and MageUI.exe are part of the [!INCLUDE[winsdklong](../deployment/includes/winsdklong_md.md)]. You must either have the [!INCLUDE[winsdkshort](../debugger/includes/winsdkshort_md.md)] installed or the version of the [!INCLUDE[winsdkshort](../debugger/includes/winsdkshort_md.md)] included with Visual Studio. For more information, see [Windows SDK](http://go.microsoft.com/fwlink/?LinkId=158044) on MSDN.  
...
4.  Open the [!INCLUDE[winsdkshort](../debugger/includes/winsdkshort_md.md)] or Visual Studio command prompt and change to the version subdirectory.  
