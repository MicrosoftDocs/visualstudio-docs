...
> [!TIP]
>  You can also add delays before actions using the Coded UI Test Editor. For more information, see [How to: Insert a Delay Before a UI Action Using the Coded UI Test Editor](../test_notintoc/how-to--insert-a-delay-before-a-ui-action-using-the-coded-ui-test-editor.md).  
  
 **UITestControl.WaitForControlXXX() Methods**  
  
 \<xref:Microsoft.VisualStudio.TestTools.UITesting.UITestControl.WaitForControlReady*>  
 ...
 \<xref:Microsoft.VisualStudio.TestTools.UITesting.UITestControl.WaitForControlEnabled*>  
 ...
 \<xref:Microsoft.VisualStudio.TestTools.UITesting.UITestControl.WaitForControlExist*>  
 ...
 \<xref:Microsoft.VisualStudio.TestTools.UITesting.UITestControl.WaitForControlNotExist*>  
  
 Waits for the control to   disappear from the UI. For example, you can wait for the progress bar to disappear.  
  
 \<xref:Microsoft.VisualStudio.TestTools.UITesting.UITestControl.WaitForControlPropertyEqual*>  
 ...
 \<xref:Microsoft.VisualStudio.TestTools.UITesting.UITestControl.WaitForControlPropertyNotEqual*>  
 ...
 \<xref:Microsoft.VisualStudio.TestTools.UITesting.UITestControl.WaitForControlCondition*>  
...
```  
 ...
 \<xref:Microsoft.VisualStudio.TestTools.UITesting.UITestControl.WaitForCondition*>  
...
```  
 ...
 The implicit timeout for the wait operation is specified by \<xref:Microsoft.VisualStudio.TestTools.UITesting.PlaybackSettings.WaitForReadyTimeout*> property. The default value of this property is 60000 milliseconds (one minute).  
