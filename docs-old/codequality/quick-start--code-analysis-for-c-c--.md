...
-   [Configure rule sets for a project](../codequality/quick-start--code-analysis-for-c-c--.md#BKMK_ConfigureRuleSets)  
  
-   [Run code analysis](../codequality/quick-start--code-analysis-for-c-c--.md#BKMK_Run)  
  
-   [Analyze and resolve code analysis warnings](../codequality/quick-start--code-analysis-for-c-c--.md#BKMK_Analyze)  
  
-   [Suppressing code analysis warnings](../codequality/quick-start--code-analysis-for-c-c--.md#BKMK_Suppress)  
  
-   [Creating work items for code analysis warnings](../codequality/quick-start--code-analysis-for-c-c--.md#BKMK_Creating_work_items_for_code_analysis_warnings)  
  
-   [Searching and filtering code analysis results](../codequality/quick-start--code-analysis-for-c-c--.md#BKMK_Search)  
