...
## In This Section  
 ...
 [Samples and Walkthroughs](../datatools/data-applications-samples-and-walkthroughs.md)  
...
## Related Sections  
 ...
 Provides links to topics about how to create [!INCLUDE[vbtecdlinq](../datatools/includes/vbtecdlinq_md.md)] classes by using the [!INCLUDE[vs_ordesigner_short](../datatools/includes/vs_ordesigner_short_md.md)].  
