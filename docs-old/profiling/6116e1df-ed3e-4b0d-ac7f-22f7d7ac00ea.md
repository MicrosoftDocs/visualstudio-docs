...
|----------|---------------------|  
|**Profile a .NET service**|-   [How to: Instrument a .NET Service and Collect Detailed Timing Data](../profiling/9f73593a-69a7-41b7-a21c-81d3ab0eb8fe.md)|  
...
|**Profile a C/C++ service**|-   [How to: Instrument a Native Service and Collect Detailed Timing Data](../profiling/dfe58b39-63f8-4a87-ab3a-2b5b14faa8d0.md)|  
