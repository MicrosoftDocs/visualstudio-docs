...
## Tool Window Essentials  
 ...
 Tool windows are typically created or opened by clicking a menu command. To create a tool window programmatically, see [Opening a Tool Window Programmatically](../VS_not_in_toc/Opening-a-Tool-Window-Programmatically.md).  
 ...
 Tool window panes can host WPF user controls and support toolbars. You can override the <xref:Microsoft.VisualStudio.Shell.WindowPane.Window?qualifyHint=False> property to return the handle of the hosted control.  
...
## See Also  
 [Tool Windows](../VS_not_in_toc/Extending-Tool-Windows.md)   
