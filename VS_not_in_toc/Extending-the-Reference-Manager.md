...
You can add references to your project by using the Reference Manager in a Visual Studio extension. Before the Reference Manager appears, your projects must configure it to show data from the correct locations. For example, a project that targets the .NET Framework 4 must populate assemblies from a different folder than a project that targets the .NET Framework 3.5.  
  
 You typically configure the Reference Manager by using a collection of ProviderContexts from the following providers:  
  
-   <xref:Microsoft.VisualStudio.Shell.Interop.IVsAssemblyReferenceProviderContext?qualifyHint=False>  
  
-   <xref:Microsoft.VisualStudio.Shell.Interop.IVsComReferenceProviderContext?qualifyHint=False>  
  
-   <xref:Microsoft.VisualStudio.Shell.Interop.IVsFileReferenceProviderContext?qualifyHint=False>  
  
-   <xref:Microsoft.VisualStudio.Shell.Interop.IVsProjectReferenceProviderContext?qualifyHint=False>  
  
-   <xref:Microsoft.VisualStudio.Shell.Interop.IVsPlatformReferenceProviderContext?qualifyHint=False>  
 ...
 ![Configuring the Reference Manager](../VS_not_in_toc/media/RefMgrExtend.png "RefMgrExtend")  
  
 ![Configuring the Reference Manager](../VS_not_in_toc/media/RefMgrExtend2.png "RefMgrExtend2")  
