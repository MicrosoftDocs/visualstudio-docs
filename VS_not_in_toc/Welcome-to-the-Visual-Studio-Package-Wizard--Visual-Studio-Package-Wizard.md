...
The Visual Studio Package Template creates a basic implementation of a VSPackage that you can expand later. You can also use the Visual Studio Package Template to add optional components to a VSPackage.  
