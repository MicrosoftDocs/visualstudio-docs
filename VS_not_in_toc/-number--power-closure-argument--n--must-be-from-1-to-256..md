...
1.  Enter a number between 1 and 256 and try again. For more information on syntax, see [Regular Expressions](../VS_IDE/Using-Regular-Expressions-in-Visual-Studio.md).  
