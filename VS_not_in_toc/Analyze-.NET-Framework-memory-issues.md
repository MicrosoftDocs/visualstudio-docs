...
##  <a name="BKMK_Identify_a_memory_issue_in_an_app"></a> Identify a memory issue in an app  
 ...
 ![Consistent memory growth in Resource Monitor](../VS_not_in_toc/media/MNGDMEM_ResourceManagerConsistentGrowth.png "MNGDMEM_ResourceManagerConsistentGrowth")  
 ...
 ![Memory spikes in Resource Manager](../VS_not_in_toc/media/MNGDMEM_ResourceManagerSpikes.png "MNGDMEM_ResourceManagerSpikes")  
...
1.  You can create a dump file for a process that was started from a Visual Studio project, or you can attach the debugger to a running process. See [Attach to Running Processes](../VS_debugger/Attach-to-Running-Processes-with-the-Visual-Studio-Debugger.md).  
...
2.  On the **Minidump File Summary** page, choose **Debug Managed Memory**.  
     ...
     ![Dump file summary page](../VS_not_in_toc/media/MNGDMEM_DumpFileSummary.png "MNGDMEM_DumpFileSummary")  
...
###  <a name="BKMK_Analyze_memory_data_in_from_a_single_snapshot"></a> Analyze memory data in from a single snapshot  
 ...
 ![The Object Type list](../VS_not_in_toc/media/DBG_MMA_ObjectTypeList.png "DBG_MMA_ObjectTypeList")  
...
-   **Inclusive Size (Bytes)** includes the sizes of referenced objects.  
 ...
 You can choose the instances icon (![The instance icon in the Object Type column](../VS_IDE/media/DBG_MMA_InstancesIcon.png "DBG_MMA_InstancesIcon")) in the **Object Type** column to view a list of the instances of the type.  
  
#### Instance table  
 ![Instances table](../VS_not_in_toc/media/DBG_MMA_InstancesTable.png "DBG_MMA_InstancesTable")  
...
-   **Value** shows the actual value of value types. You can hover over the name of a reference type to view its data values in a data tip.  
     ...
     ![Instance values in a data tip](../VS_not_in_toc/media/DBG_MMA_InstanceValuesInDataTip.png "DBG_MMA_InstanceValuesInDataTip")  
...
2.  On the memory analysis report page, open the **Select baseline** list, and then choose **Browse** to specify the first dump file.  
 ...
 ![Diff columns in the type list](../VS_not_in_toc/media/MNGDMEM_DiffColumns.png "MNGDMEM_DiffColumns")  
