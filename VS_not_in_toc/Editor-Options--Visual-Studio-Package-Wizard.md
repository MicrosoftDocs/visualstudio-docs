 ...
 **File Extension**  
 Define the file name extension that is associated with your editor. You can specify multiple extensions by typing a comma-delimited list. Your editor is the default Visual Studio editor for files that have the file name extension you define.  
