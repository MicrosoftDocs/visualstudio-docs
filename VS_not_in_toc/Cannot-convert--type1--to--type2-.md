...
-   Use the `Value` property of the XML literal to reference its value as a `String`. Use the `CType` function, another type conversion function, or the <xref:System.Convert?qualifyHint=False> class to cast the value as the specified type.  
  
## See Also  
 <xref:System.Convert?qualifyHint=False>   
