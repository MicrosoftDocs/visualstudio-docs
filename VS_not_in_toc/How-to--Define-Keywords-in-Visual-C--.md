...
6.  Set the font and color properties of your user-defined keywords as described in [Fonts and Colors, Environment, Options Dialog Box](../VS_IDE/Fonts-and-Colors--Environment--Options-Dialog-Box.md).  
