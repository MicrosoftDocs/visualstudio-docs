...
-   If you require that this type remain within its current containment hierarchy, remove the <xref:System.CLSCompliantAttribute?qualifyHint=False> from its definition or mark it as `<CLSCompliant(False)>`.  
