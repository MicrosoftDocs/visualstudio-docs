...
1.  Verify that the arguments and switches entered are currently available. For more information, see [Visual Studio Commands with Arguments](../VS_IDE/Visual-Studio-Commands.md).  
