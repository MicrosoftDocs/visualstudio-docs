...
The <xref:System.AddIn.Hosting.AddInSegmentDirectoryNotFoundException?qualifyHint=False> exception is thrown when a segment directory is missing from the pipeline directory structure.  
...
## See Also  
 <xref:System.AddIn.Hosting.AddInSegmentDirectoryNotFoundException?qualifyHint=False>   
