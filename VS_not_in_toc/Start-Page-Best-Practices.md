...
### Windows Presentation Framework (WPF)  
 Your XAML markup should follow WPF best practices. For information about Windows Presentation Foundation (WPF) and Microsoft .NET Framework best practices for application development, see the following topics, as appropriate.  
