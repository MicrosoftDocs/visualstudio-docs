...
An assembly uses the <xref:System.Runtime.CompilerServices.TypeForwardedToAttribute?qualifyHint=False> to forward one of its types to another assembly, but specifies the same type in the same assembly.  
