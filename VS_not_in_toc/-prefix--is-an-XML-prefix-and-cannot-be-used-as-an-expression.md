...
-   If you have to refer to part of the imported XML namespace, use the `GetXmlNamespace` operator to retrieve an <xref:System.Xml.Linq.XNamespace?qualifyHint=False> object. Use that object instead of the XML namespace prefix.  
