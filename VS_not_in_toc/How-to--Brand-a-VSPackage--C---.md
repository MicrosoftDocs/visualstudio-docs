...
To appear in the **Help About** dialog box and the splash screen, VSPackages must implement the <xref:Microsoft.VisualStudio.Shell.Interop.IVsInstalledProduct?qualifyHint=False> interface. Doing this provides the following information to Visual Studio:  
...
## Example  
 The following class declaration for the VSPackage class is from the [VSSDK Samples](../VS_not_in_toc/VSSDK-Samples.md).  
