...
As an active Visual Studio subscriber, you can use a range of features in Azure DevOps that are included with your subscription as a benefit. You'll be able to use these same features in each Azure DevOps account in which you are a member, whether you created the account or were added by someone else.
...
[Sign up for a free Azure DevOps account](https://visualstudio.microsoft.com/team-services/)
...
-  Complete [Azure DevOps documentation](/azure/devops/).