...
If you need to be added to the new Visual Studio Subscriptions Administration Portal and you aren’t sure who your Primary/Notices Contact is, you can find this information after signing in to the [VLSC](https://www.microsoft.com/Licensing/servicecenter/default.aspx). Take a look at [this article](https://www.visualstudio.com/subscriptions/support/locate-primary-contact/ "How Do I Locate My Primary Contact?") for steps on locating your Primary/Notices Contact in the VLSC.
