...
The steps to sign in to your Visual Studio Subscription depend on the kind of account you're using. For example, you might be using a Microsoft account (MSA) or an email address supplied by your employer or school. You can also use your GitHub account to sign in to some subscriptions. 

This article explains how GitHub sign-in works for Visual Studio Subscriptions.
...
When you sign in with GitHub, Microsoft checks whether any email addresses associated with your GitHub account match an existing personal or enterprise Microsoft account. If the address matches your enterprise account, you're prompted to sign in to that account instead. The sign-in experience can vary depending on the Microsoft product or service you're accessing. In some cases, you might be redirected or signed in automatically instead of seeing a separate Microsoft account prompt. If the address matches a personal account, your GitHub account can be added as a sign-in method for that account.
