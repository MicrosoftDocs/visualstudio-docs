...
- If your organization uses Microsoft Azure Active Directory (Azure AD), you can [use Azure AD groups to assign subscriptions](assign-license-bulk#use-azure-active-directory-groups-to-assign-subscriptions) to groups of users.  
