...
<sup>\*NFR (Not for Resale) refers to subscriptions provided through programs such as FTE, Most Valuable Professional (MVP), Regional Director (RD), Microsoft AI Cloud Partner Program (MAICPP), Microsoft Partner Program (MPN), Visual Studio Industry Partner (VSIP), Microsoft Certified Trainer (MCT), Azure Dev Tools for Teaching (ADTfT), Open Source Heroes, Student Ambassadors, Microsoft Bug Bounty, Independent Software Vendor (ISV), NFR Basic programs such as Xbox and Alumni, and Microsoft for Startups.</sup>
...
1. Select **Activate**. 
   > [!div class="mx-imgBorder"]
     [![Screenshot of the DataCamp benefit tile in the Visual Studio Subscriptions portal.](media/datacamp/datacamp-benefit-tile.png "The DataCamp benefit tile with the Activate button highlighted.")](media/datacamp/datacamp-benefit-tile.png#lightbox)
1. Follow the prompts to create your account and select **Start Learning**.
   > [!div class="mx-imgBorder"]
     [![Screenshot of the DataCamp activation landing page shwoing after selecting Activate.](media/datacamp/datacamp-activation-landing-page.png "The DataCamp activation landing page after selecting Activate.")](media/datacamp/datacamp-activation-landing-page.png#lightbox)
