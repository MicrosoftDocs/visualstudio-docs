...
1. Select “get key” to see all keys that are available for the product you want to download. Then select “claim key” to claim a product key if the download requires a key to get started. 
