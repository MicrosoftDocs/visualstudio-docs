...
The Pluralsight benefit provides eligible subscribers with access to online technical training through the Pluralsight platform. Depending on your subscription level, the benefit provides up to 12 months of access.

The [eligibility table](#eligibility) details the Pluralsight training benefit that's available with select Visual Studio Subscriptions and Visual Studio Dev Essentials memberships. 
...
|  Visual Studio Deve Essentials | N/A | 1 month | NA |

<sup>1</sup> *Not for Resale (NFR), Visual Studio Industry Partner (VSIP), MCT Software & Services Developer, Most Valuable Professional (MVP), Regional Director (RD), Microsoft Cloud Partner Program, FTE, Imagine, NFR Basic.*
