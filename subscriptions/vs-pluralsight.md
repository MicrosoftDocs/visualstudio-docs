...
1. To activate your subscription, connect to [https://my.visualstudio.com/benefits](https://my.visualstudio.com/benefits?wt.mc_id=o~msft~docs) and select the **Activate** link on the Pluralsight benefit tile.  To narrow the list of tiles displayed, you can choose a group filter.  Pluralsight is located in the Professional Development benefits group.
   > [!div class="mx-imgBorder"]
   > ![Pluralsight Benefit Tile](_img/vs-pluralsight/vs-pluralsight-tile.png "Screenshot of the Pluralsight benefit tile.  The Activate button is selected.")
...
1. You'll be redirected to the Pluralsight page for the benefit that's included with your Visual Studio subscription.
   ...
   + Select **REDEEM**.
   > [!div class="mx-imgBorder"]
   > ![Pluralsight registration](_img/vs-pluralsight/vs-pluralsight-registration.png "Screenshot of the account creation dialog.  The terms of use checkbox and Redeem button are highlighted.")
...
At the bottom of the tile, you'll see text showing both the activation date and expiration date of your Pluralsight subscription.
   ...
   > [!div class="mx-imgBorder"]
   > ![Pluralsight tile after activation](_img/vs-pluralsight/vs-pluralsight-activated.png "Screenshot of benefit tile showing the days remaining in the subscription term.")
...
When your Pluralsight subscription expires, the status will change to "0 days remaining" and the link to the Pluralsight portal will be removed. You'll still be able to see the date that you activated the subscription, as well as the date it expired.  
   > [!div class="mx-imgBorder"]
   > ![Pluralsight tile after expiration](_img/vs-pluralsight/vs-pluralsight-expired.png "Screenshot of the benefit tile showing that the benefit has expired.")
...
A:  The Pluralsight benefit in selected Visual Studio subscriptions renews when your subscription renews. For example, if you have an annual subscription that you renew each year, the benefit is available to you each year when you renew. If you have a multi-year subscription, the Pluralsight benefit is available to you once during the term of the subscription.  If you renew a multi-year subscription, the benefit will be available again following the renewal.  To find your renewal date, visit <https://my.visualstudio.com/subscriptions> and select *Support Information* and locate the "Valid through:" date. 
...
A:  If you have already activated your Pluralsight benefit, the "Activate" link will be replaced by a link that takes you to the sign-in page for Pluralsight.  You'll also see the date you activated the benefit as well as information about how much time remains on your subscription.  If you've already used a subscription, you won't be able to activate another one.
...
After you've created your account, you're ready to start training.  Visit [https://www.pluralsight.com](https://www.pluralsight.com) and tap **log in** at the top right corner of the page to start a new course, or return to a course already in progress.
