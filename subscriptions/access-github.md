...
A:  If you're using GitHub Enterprise Server, you can select the **Support** link visible at the bottom of the client to be connected with your administrator.
