...
Visual Studio with GitHub Enterprise subscriptions are assigned in two parts:
1. The Visual Studio subscription (Enterprise or Professional)
2. GitHub Enterprise 

When you are assigned a Visual Studio with GitHub subscription, you'll receive an email letting you know that your Visual Studio subscription administrator has assigned a subscription to you.  At that point, you will be able to view available subscription benefits at <https://my.visualstudio.com/subscriptions>.  This includes the GitHub Enterprise benefit as seen below.
...
When an invitation is sent by your GitHub organization administrator, you will receive an email from GitHub and the benefit tile will update again:
   ...
   > [!div class="mx-imgBorder"]
   > ![GitHub Enterprise pending invite acceptance](_img/access-github/pending-acceptance.png "Accept the invitation you receive in the email from GitHub")  

After accepting the GitHub organization invitation the tile will show the status has changed from "Pending" to "Activated".
...
- You can find answers to questions on a wide array of GitHub topics at [GitHub Help](https://help.github.com).
