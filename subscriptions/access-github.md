...
When you're assigned a Visual Studio subscription with GitHub Enterprise, you'll receive an email letting you know that your Visual Studio subscriptions admin has assigned a subscription to you.  At that point, you'll be able to view available subscription benefits at <https://my.visualstudio.com/benefits>.  This includes the GitHub Enterprise benefit as seen below.
...
When an invitation is sent by your GitHub organization admin, you'll receive an email from GitHub and the benefit tile will update again:
