...
+ [Quickstart: Configure the Microsoft Dev Box service](https://review.learn.microsoft.com/azure/dev-box/quickstart-configure-dev-box-service)
+ [Quickstart: Create a Dev Box](https://review.learn.microsoft.com/azure/dev-box/quickstart-create-dev-box)
