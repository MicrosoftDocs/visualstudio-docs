...
Visual Studio Subscriptions have specific durations and expire unless you renew them. When a subscription expires, it affects the benefits that the subscription provides. This article explains how expiration affects aspects of a Visual Studio subscription.
...
To determine if your subscription is eligible for perpetual use rights, check the [Visual Studio licensing guidance](https://aka.ms/vslicensing). If your subscription is eligible, you continue to have access to your *current version* of the IDE but don't receive updates to future versions. For earlier versions that use product keys, claim any required product keys before your subscription expires. Visual Studio 2026 doesn't require a product key. Instead, the IDE is available when you sign in with the account your Visual Studio Subscription is assigned to. Product keys for other eligible products remain available on the Product Keys page in the Subscriber portal.

If your organization uses Volume Licensing for qualifying broad, offline, or managed deployment scenarios, Visual Studio 2026 product keys may still be available through your Volume Licensing administrator.

### Azure DevOps

You can't access Azure DevOps through a Visual Studio Subscription.
