...
-  Need help with Power BI Pro?  
    - Check out the [online documentation](https://docs.microsoft.com/en-us/power-bi/).
    - Problems signing up?  Check out [Signing up for Power BI as an Individual](https://docs.microsoft.com/en-us/power-bi/service-self-service-signup-for-power-bi)
    - Explore top issues, get help from the community or submit a support ticket on the [Support page](https://powerbi.microsoft.com/en-us/support/).
