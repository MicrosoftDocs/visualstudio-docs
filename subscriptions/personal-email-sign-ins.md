...
> ![Connect Emails Button](_img/connect-emails/connect-emails-button.png "Select Connect Emails to match your users with Microsoft accounts to your Azure Active Directory")
...
> [!div class="mx-imgBorder"]
> ![Connect Emails Fly-out](_img/connect-emails/connect-emails-flyout.png "Select which subscribers you want to match to their Azure AD identities and select Continue.")
...
> [!div class="mx-imgBorder"]
> ![Connect Emails Confirmation](_img/connect-emails/connect-emails-confirm.png "Select Continue to implement the proposed changes, then select Save.") 
