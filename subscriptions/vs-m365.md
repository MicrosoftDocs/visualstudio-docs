...
\* *Includes:  Not for Resale (NFR), Visual Studio Industry Partner (VSIP), Full time Employee (FTE), Microsoft Certified Trainer (MCT) Software & Services Developer.  
Excludes: Visual Studio Enterprise (Microsoft for Startups), Microsoft AI Cloud Partner Program (MAICPP) formerly known as Microsoft Cloud Partner Program (MCPP) or Microsoft Partner Network (MPN), Imagine, Most Valuable Professional (MVP), Regional Director (RD), Not for Reslare Basic (NFR Basic), Independent Software Vendors (ISV).*
