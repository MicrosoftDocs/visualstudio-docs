...
0. Locate the Microsoft 365 developer subscription benefit tile in the "Tools" category, and select on **Get Started**.
...
Excludes: Visual Studio Enterprise (Microsoft for Startups), MCT Software & Services, Microsoft Cloud Partner Program, Imagine, Most Valuable Professional (MVP), Regional Director (RD), NFR Basic, ISV.*
