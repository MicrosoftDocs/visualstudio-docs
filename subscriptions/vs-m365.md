...
0. Locate the Microsoft 365 developer subscription benefit tile in the "Tools" category, and click on **Activate**.

    > [!div class="mx-imgBorder"]
    >![Microsoft 365 Developer Tile](_img/visualstudio-microsoft365/visualstudio-microsoft365-tile.png "Click 'Activate' on the Microsoft 365 developer subscription tile to get started.")
...
0. On the welcome screen, choose your region/country, enter your company name, and click the checkbox to accept the terms of use.  Then click **Next**.
    ...
    > [!div class="mx-imgBorder"]
    >![Microsoft 365 Developer welcome screen](_img/visualstudio-microsoft365/visualstudio-microsoft365-welcome.png "Choose your area of development focus.")

0. Indicate your primary area of interest, and click **Next**.

    > [!div class="mx-imgBorder"]
    >![Microsoft 365 Developer focus choice](_img/visualstudio-microsoft365/visualstudio-microsoft365-focus.png "Choose your primary development focus area.")

0. You'll see a list of development areas based on the primary area of interest you previously selected.  Choose any areas of interest, and click **Save**.

    > [!div class="mx-imgBorder"]
    >![Microsoft 365 Developer area choice](_img/visualstudio-microsoft365/visualstudio-microsoft365-areas.png "Choose your development areas based on your choice of focus area.")


0. Next, you'll have the opportunity to set up your Microsoft 365 sandbox.  (If you choose to skip this step now, you can complete it later by logging in to the dashboard and choosing the **Set up E5 subscription** button.)  Choose your preferred type of sandbox - instant or configurable - and click **Next**.

    > [!div class="mx-imgBorder"]
    >![Microsoft 365 Developer sandbox choice](_img/visualstudio-microsoft365/visualstudio-microsoft365-sandbox.png "Choose your preferred sandbox type, or click Later to skip this step.")

0. In the **Set up your Microsoft 365 E5 instant sandbox** screen, provide your region, admin username, and admin password.  You can also choose to provide an alternate password for fictitious users.  Click **Continue**.

    > [!div class="mx-imgBorder"]
    >![Microsoft 365 Developer sandbox setup](_img/visualstudio-microsoft365/visualstudio-microsoft365-sandbox-setup.png "Provide your region, admin username and admin password.")

0. In the **Add phone number for security** dialog, provide your country code and phone number, and click **Send Code**.

0. Enter the code you received and select **Setup**.

    > [!div class="mx-imgBorder"]
    >![Microsoft 365 Developer sandbox confirmation code](_img/visualstudio-microsoft365/visualstudio-microsoft365-code.png "Enter the confirmation code and select Setup.")
...
0. After the automated process of setting up your sandbox is complete, you'll see the dashboard.  To use your subscription, select the **Go to subscription** link.
    ...
    > [!div class="mx-imgBorder"]
    >![Microsoft 365 Developer dashboard](_img/visualstudio-microsoft365/visualstudio-microsoft365-go-to-subscription.png "Select Go to subscription to continue.")

0. You'll have an opportunity to protect your account by enabling additional authentication factors.  (For this example, we'll skip this process and continue to the subscription.  If you skip the process now, you'll have 14 days to complete it.)

    > [!div class="mx-imgBorder"]
    >![Microsoft 365 Developer enable protection](_img/visualstudio-microsoft365/visualstudio-microsoft365-protect.png "Enable additional account protection.")

0. Pick an account to sign in. 

0. On your first visit, you'll see a brief slide show about the benefits of the subscription.  

0. At the completion of the slideshow, you'll see the www.office.com landing page. In the left navigation pane, click on the **Admin** button. 

    > [!div class="mx-imgBorder"]
    >![Microsoft 365 Developer admin](_img/visualstudio-microsoft365/visualstudio-microsoft365-office-admin.png "Select the Admin button in the left nav pane.")

0. In the Microsoft 365 admin center, you can perform a range of tasks, including:
  - Manage Teams to support users
  - Install Office apps
  - Add, edit or remove user accounts
  Click on the **Go to guided setup** button to walk through installing Office, adding users, and setting up and connecting domains. 

    > [!div class="mx-imgBorder"]
    >![Microsoft 365 Developer guided setup](_img/visualstudio-microsoft365/visualstudio-microsoft365-guided-setup.png "Select the Go to guided setup button to install Office, add users, and manage domains.")
