...
3. When the message appears asking you to confirm the deletion, click **OK**.
   ...
   > ![Delete subscribers](_img/delete-license/delete-subscribers.png "Screenshot of manage subscribers page in admin portal.  The Delete menu option is highlighted.")
