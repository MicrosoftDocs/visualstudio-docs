...
-   Windows 8.x Store apps. To build Windows 8.x Store apps, you must install Visual Studio on the build computer.  
...
-   [Installing software on the computers](../VS_IDE/Walkthrough--Creating-a-Multiple-Computer-Build-Environment.md#InstallingSoftware)  
  
-   [Copying files from the host computer to the build computer](../VS_IDE/Walkthrough--Creating-a-Multiple-Computer-Build-Environment.md#CopyingFiles)  
  
-   [Creating registry settings](../VS_IDE/Walkthrough--Creating-a-Multiple-Computer-Build-Environment.md#CreatingRegistry)  
  
-   [Setting environment variables on the build computer](../VS_IDE/Walkthrough--Creating-a-Multiple-Computer-Build-Environment.md#SettingEnvVariables)  
  
-   [Installing MSBuild assemblies to the Global Assembly Cache (GAC) on the build computer](../VS_IDE/Walkthrough--Creating-a-Multiple-Computer-Build-Environment.md#InstallingMSBuildToGAC)  
  
-   [Building projects](../VS_IDE/Walkthrough--Creating-a-Multiple-Computer-Build-Environment.md#BuildingProjects)  
  
-   [Creating the build environment so that it can be checked into source control](../VS_IDE/Walkthrough--Creating-a-Multiple-Computer-Build-Environment.md#CreatingForSourceControl)  
...
-   Open a Command Prompt window on the build computer and run %Program Files%\Microsoft Visual Studio 11.0\VC\vcvarsall.bat. You can use a command-line argument to specify the toolset you want to use—x86, native x64, or x64 cross-compiler. If you don't specify a command-line argument, the x86 toolset is used.  
    ...
    |amd64|x64 Native|x64|x64|  
     ...
     If vcvarsall.bat runs successfully—that is, no error message is displayed—you can skip the next step and continue at the [Installing MSBuild assemblies to the Global Assembly Cache (GAC) on the build computer](../VS_IDE/Walkthrough--Creating-a-Multiple-Computer-Build-Environment.md#InstallingMSBuildToGAC) section of this document.  
 ...
 **msbuild** *solution.sln*  
 ...
 For more information about how to use MSBuild on the command line, see [Command-Line Reference](../VS_IDE/MSBuild-Command-Line-Reference.md).  
