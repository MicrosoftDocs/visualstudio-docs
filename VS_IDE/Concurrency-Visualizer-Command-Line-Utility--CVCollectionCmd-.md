...
> [!NOTE]
>  When you use Visual Studio to collect traces, don't directly modify the configuration file.  Instead, use the [Advanced Settings](../VS_IDE/Advanced-Settings-Dialog-Box--Concurrency-Visualizer-.md) dialog box to modify settings.  
