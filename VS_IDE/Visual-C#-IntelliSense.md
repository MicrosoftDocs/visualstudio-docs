...
Visual C# IntelliSense is available when coding in the editor, and while you debugging in the [Immediate Mode](../VS_IDE/Immediate-Window.md) command window.  
...
> [!NOTE]
>  The completion list does not display all extension methods for <xref:System.String?qualifyHint=False> objects.  
  
 Extension methods use a different icon than instance methods. For a listing of list icons, see [Class View and Object Browser Icons](../VS_IDE/Class-View-and-Object-Browser-Icons.md). When an instance method and extension method with the same name are both in scope, the completion list displays the extension method icon.  
...
-   **Attributes**: When you apply an attribute to a type, the completion list is filtered so that the list only contains those types that descend from the namespaces that contain those types, such as <xref:System.Attribute?qualifyHint=False>.  
...
## Most recently used members  
 IntelliSense remembers the members that you have recently selected in the pop-up [List Members](../VS_IDE/Using-IntelliSense.md) box for automatic object name completion. The next time you use Member List, the most recently used members are shown at the top. The history of most recently used members is cleared between each session in the IDE.  
...
### Add using  
 ...
 ![Add Using Smart Tag Image](../VS_IDE/media/AddUseSmart.gif "AddUseSmart")  
 ...
 ![Add using, smart tag expanded image](../VS_IDE/media/AddUseSmartExp.gif "AddUseSmartExp")  
...
### Implement abstract base class  
 ...
 The method stubs that are generated by the Implement Abstract Base Class feature are modeled by the code snippet defined in the file MethodStub.snippet. Code Snippets are modifiable. For more information, see [Walkthrough: Creating a Code Snippet](../VS_IDE/Walkthrough--Creating-a-Code-Snippet.md).  
...
## Generate event handlers  
 ...
 ![Button Auto Hook Up](../VS_IDE/media/vxAutoHookUp.gif "vxAutoHookUp")  
 ...
 ![Generate Event Handler](../VS_IDE/media/vxGenerateEventHandler.gif "vxGenerateEventHandler")  
