...
2.  Add the `AssignIconsToSquares()` method as shown in the previous step. You can put it just below the code you added in [Step 2: Add a Random Object and a List of Icons](../VS_IDE/Step-2--Add-a-Random-Object-and-a-List-of-Icons.md).  
...
5.  Close your program, and then run it again. Notice that different icons are assigned to each label, as shown in the following picture.  
     ...
     ![Matching game with random icons](../VS_IDE/media/Express_Tut4Step3.png "Express_Tut4Step3")  
...
-   To go to the next tutorial step, see [Step 4: Add a Click Event Handler to Each Label](../VS_IDE/Step-4--Add-a-Click-Event-Handler-to-Each-Label.md).  
  
-   To return to the previous tutorial step, see [Step 2: Add a Random Object and a List of Icons](../VS_IDE/Step-2--Add-a-Random-Object-and-a-List-of-Icons.md).