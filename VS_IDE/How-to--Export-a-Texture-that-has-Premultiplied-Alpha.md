...
1.  Begin with a basic texture. Load an existing image file, or create one as described in [How to: Create a Basic Texture](../VS_IDE/How-to--Create-a-Basic-Texture.md).  
