...
2.  Create .vstemplate files for every project. For more information, see [How to: Create Project Templates](../VS_IDE/How-to--Create-Project-Templates.md).  
...
## See Also  
 ...
 [Visual Studio Template Schema Reference](../Topic/Visual%20Studio%20Template%20Schema%20Reference.md)   
 [SolutionFolder Element (Visual Studio Templates)](../Topic/SolutionFolder%20Element%20\(Visual%20Studio%20Templates\).md)   
 [ProjectTemplateLink Element (Visual Studio Templates)](../Topic/ProjectTemplateLink%20Element%20\(Visual%20Studio%20Templates\).md)