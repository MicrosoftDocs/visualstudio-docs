...
---
# Demo Sample
This following procedures show you how to create the sample for [Walkthrough: Analyzing C/C++ Code for Defects](../VS_IDE/Walkthrough--Analyzing-C-C---Code-for-Defects.md). The procedures create:  
...
4.  Copy the following code and paste it into the **Bug.cpp** file in the Visual Studio editor.  
...
8.  Copy the following code and paste it into the Bug.h file in the Visual Studio editor.  
