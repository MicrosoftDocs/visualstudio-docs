...
7.  Choose the plus sign (+) next to the **Font** property, and then change the value of the **Size** property to **15.75**.  
     ...
     ![Properties window showing font size](../VS_IDE/media/Express_setFontSize.png "Express_setFontSize")  
...
16. Change the value of the **(Name)** property for the **NumericUpDown** control to **sum**.  
     ...
     ![First row of math quiz](../VS_IDE/media/Express_firstRow.png "Express_firstRow")  
...
7.  Set the value of the **TabIndex** property for the NumericUpDown sum control to **2**, for the difference control to **3**, for the product control to **4**, and for the quotient control to **5**.  
     ...
     ![Initial math quiz form](../VS_IDE/media/Express_FormLaidOut.png "Express_FormLaidOut")  
...
-   To go to the next tutorial step, see [Step 2: Create a Random Addition Problem](../VS_IDE/Step-2--Create-a-Random-Addition-Problem.md).  
  
-   To return to the overview topic, see [Tutorial 2: Create a Timed Math Quiz](../VS_IDE/Tutorial-2--Create-a-Timed-Math-Quiz.md).