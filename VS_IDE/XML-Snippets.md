...
```  
 ...
 For more information, see [How to: Use XML Snippets](../VS_IDE/How-to--Use-XML-Snippets.md).  
...
## Schema-Generated XML Snippets  
 ...
 For more information, see [How to: Generate an XML Snippet From an XML Schema](../VS_IDE/How-to--Generate-an-XML-Snippet-From-an-XML-Schema.md).  
...
## Create New XML Snippets  
 ...
 For more information, see [How to: Create XML Snippets](../VS_IDE/How-to--Create-XML-Snippets.md).  
