...
## List Members  
 ...
 In the member list, the icon to the left represents the type of the member, such as namespace, class, function, or variable. For a list of icons, see [Class View and Object Browser Icons](../VS_IDE/Class-View-and-Object-Browser-Icons.md). The list may be quite long, so you can press PAGE UP and PAGE DOWN to move up or down in the list.  
...
## Parameter Info  
 ...
 ![Parameter Info](../VS_IDE/media/VS2015_param_Info.png "VS2015_param_Info")  
  
 When you annotate functions and parameters with XML Documentation comments, the comments will display as Parameter Info. For more information, see [Supplying XML Code Comments](../VS_IDE/Supplying-XML-Code-Comments.md).  
...
## Quick Info  
 ...
 ![Visual Studio Quick Info](../VS_IDE/media/VS2015_Quick_info.png "VS2015_Quick_info")  
  
 When you select a member from the **List Members** box, Quick Info also appears.  
  
 ![Parameter Info in a C&#35; code file](../VS_IDE/media/VS2015_ParamInfo.png "VS2015_ParamInfo")  
