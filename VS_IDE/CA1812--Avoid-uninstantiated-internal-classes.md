...
-   The class is created automatically by the runtime or ASP.NET. For example, classes that implement <xref:System.Configuration.IConfigurationSectionHandler?qualifyHint=True> or <xref:System.Web.IHttpHandler?qualifyHint=True>.  
