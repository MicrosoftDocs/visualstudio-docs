...
### Gesture Handlers  
 ...
 You can write handlers to deal with drags from other DSL models and UML models. For more information, see [How to: Add a Drag-and-Drop Handler](../VS_IDE/How-to--Add-a-Drag-and-Drop-Handler.md).  
...
### Validation constraints  
 ...
 For more information, see [Validation in a Domain-Specific Language](../VS_IDE/Validation-in-a-Domain-Specific-Language.md).  
