...
## Example  
 The following code example illustrates an `assemblyIdentity` element in a ClickOnce deployment manifest. This code example is part of a larger example provided for the [ClickOnce Deployment Manifest](../VS_IDE/ClickOnce-Deployment-Manifest.md) topic.  
...
## See Also  
 ...
 [<assemblyIdentity\> Element](../VS_IDE/-assemblyIdentity--Element--ClickOnce-Application-.md)