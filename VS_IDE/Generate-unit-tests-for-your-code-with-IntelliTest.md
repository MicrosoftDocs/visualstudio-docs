...
2.  Right-click in a method in your code and choose **Run IntelliTest** to generate unit tests for the code in your method.  
     ...
     ![Right&#45;click in your method to generate unit tests](../VS_IDE/media/RunPEX.png "RunPEX")  
     ...
     ![Exploration Results window is displayed with tests](../VS_IDE/media/PEXExplorationResults.png "PEXExplorationResults")  
     ...
     ![Select the test results to view from the list](../VS_IDE/media/SelectPEXTest.png "SelectPEXTest")  
...
1.  Select the data rows that you want to save with the parameterized unit test into a test project.  
     ...
     ![Select tests; right&#45;click and choose Save](../VS_IDE/media/SavePEXTests.png "SavePEXTests")  
     ...
     ![Open class file in test method to view unit test](../VS_IDE/media/TestMethodPEX.png "TestMethodPEX")  
...
1.  If you have more complex code, IntelliTest assists you with focusing exploration of your code. For example, if you have a method that has an interface as a parameter, and there is more than one class that implements that interface, IntelliTest discovers those classes and reports a warning.  
     ...
     ![View warnings](../VS_IDE/media/PEXViewWarning.png "PEXViewWarning")  
...
2.  After you investigate the code and understand what you want to test, you can fix the warning to choose which classes to use to test the interface.  
     ...
     ![Right&#45;click the warning and choose Fix](../VS_IDE/media/PEXFixWarning.png "PEXFixWarning")  
...
3.  Now you can rerun IntelliTest to generate a parameterized unit test and test data just using the class that you fixed.  
     ...
     ![Rerun IntelliTest to generate the test data](../VS_IDE/media/PEXWarningsFixed.png "PEXWarningsFixed")  
 ...
 **A:** Yes, use assumptions to specify which test data is not required for the unit test for a specific method. Use the <xref:Microsoft.Pex.Framework.PexAssume?qualifyHint=False> class to add assumptions. For example, you can add an assumption that the lengths variable is not null like this.  
 ...
 **A:** Yes, right-click in the class or method, then choose **Create IntelliTest**.  
 ...
 ![Right&#45;click editor, choose Create IntelliTest](../VS_IDE/media/PEXCreateIntelliTest.png "PEXCreateIntelliTest")  
 ...
 ![Create IntelliTest with MSTest default](../VS_IDE/media/PEXCreateIntelliTestMSTest.png "PEXCreateIntelliTestMSTest")  
  
### Q: Can I use other unit test frameworks with IntelliTest?  
 **A:** Yes, follow these steps to [find and install other frameworks](../VS_IDE/Install-third-party-unit-test-frameworks.md). After you restart Visual Studio and reopen your solution, right-click in the class or method, then choose **Create IntelliTest**. Select your installed framework here:  
  
 ![Select other unit test framework for IntelliTest](../VS_IDE/media/PEXCreateIntelliTestExtensions.png "PEXCreateIntelliTestExtensions")  
