...
5.  To stop profiling, switch back to the .diagsession window and click **Stop** at the top of the window.  
     ...
     ![Timeline profiler report](../VS_IDE/media/TIMELINE_Base.png "TIMELINE_Base")  
...
###  <a name="BKMK_Diagnostic_session_timeline"></a> Diagnostic session timeline  
 ![Performance and Diagnostics timeline](../VS_IDE/media/DIAGHUB_TimelineWithUserMarks.png "DIAGHUB_TimelineWithUserMarks")  
...
###  <a name="BKMK_UI_thread_utilization_graph"></a> UI thread utilization graph  
 ![CPU Utilization Graph](../VS_IDE/media/TIMELINE_CpuUtilization.png "TIMELINE_CpuUtilization")  
...
###  <a name="BKMK_Visual_throughput_FPS_graph"></a> Visual throughput (FPS) graph  
 ![Visual throughput graph](../VS_IDE/media/TIMELINE_VisualThroughput.png "TIMELINE_VisualThroughput")  
...
|![Group events by frame](../VS_IDE/media/TIMELINE_GroupByFrames.png "TIMELINE_GroupByFrames")|Adds or removes a top-level **Frame** category that groups events by frame.|  
|![Filter Timeline details list](../VS_IDE/media/TIMELINE_Filter.png "TIMELINE_Filter")|Filters the list by selected categories and the length of events.|  
|![Customize Timeline details information](../VS_IDE/media/TIMELINE_ViewSettings.png "TIMELINE_ViewSettings")|Lets you specify the annotations to events.|  
