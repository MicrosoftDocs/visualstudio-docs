...
This class extends the <xref:Microsoft.VisualStudio.TestTools.UITest.Extension.UITestExtensionPackage?qualifyHint=False> class and provides the entry point for a coded UI test that is testing an Microsoft Excel Worksheet.  
