...
## Cause  
 A type extends <xref:System.Windows.Forms.Control?qualifyHint=True> and contains two or more top level controls that have identical access keys that are stored in a resource file.  
...
## Example  
 ...
 [!CODE [FxCop.Globalization.AvoidDuplicateAccels#1](../CodeSnippet/VS_Snippets_CodeAnalysis/FxCop.Globalization.AvoidDuplicateAccels#1)]  
