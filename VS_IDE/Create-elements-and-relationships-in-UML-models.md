...
```  
 ...
 Some types have more complex creation methods, particularly in Sequence Diagrams. See [Edit UML sequence diagrams by using the UML API](../VS_IDE/Edit-UML-sequence-diagrams-by-using-the-UML-API.md).  
