...
-   To go to the next tutorial step, see [Step 8: Add a Method to Verify Whether the Player Won](../VS_IDE/Step-8--Add-a-Method-to-Verify-Whether-the-Player-Won.md).  
  
-   To return to the previous tutorial step, see [Step 6: Add a Timer](../VS_IDE/Step-6--Add-a-Timer.md).