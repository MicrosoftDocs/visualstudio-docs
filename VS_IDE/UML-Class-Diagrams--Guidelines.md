...
-   To clarify the glossary of terms used for communication between the application and its users, and in descriptions of the users' needs. See [Model user requirements](../VS_IDE/Model-user-requirements.md).  
...
### Relationship to Other Diagrams  
 ...
 See [UML Activity Diagrams: Guidelines](../VS_IDE/UML-Activity-Diagrams--Guidelines.md).  
 ...
 See [UML Sequence Diagrams: Guidelines](../VS_IDE/UML-Sequence-Diagrams--Guidelines.md).  
  
 Component diagram  
  
 Component interfaces, listing their operations.  
  
 See [UML Component Diagrams: Guidelines](../VS_IDE/UML-Component-Diagrams--Guidelines.md).  
  
 Use case diagram  
  
 Types mentioned in descriptions of the goals and steps of a use case.  
  
 See [UML Use Case Diagrams: Guidelines](../VS_IDE/UML-Use-Case-Diagrams--Guidelines.md).  
  
##  <a name="BasicSteps"></a> Basic Steps for Drawing Class Diagrams  
 For reference information about the elements on UML class diagrams, see [UML Class Diagrams: Reference](../VS_IDE/UML-Class-Diagrams--Reference.md).  
...
##  <a name="UsingTypes"></a> Using Classes, Interfaces, and Enumerations  
 ...
 ![A class, an enumeration, and an interface](../VS_IDE/media/UML_ClassGuideTypes.png "UML_ClassGuideTypes")  
...
### Getting Types from Other Diagrams  
 ...
 To create a class from a lifeline, open the shortcut menu for the lifeline, and then choose **Create Class** or **Create Interface**. See [UML Sequence Diagrams: Guidelines](../VS_IDE/UML-Sequence-Diagrams--Guidelines.md).  
...
-   **Is Navigable**. If true for only one role, an arrow appears in the navigable direction. You can use this to indicate navigability of links and database relations in the software.  
 ...
 For the full details of these and other properties, see [Properties of associations on UML class diagrams](../VS_IDE/Properties-of-associations-on-UML-class-diagrams.md).  
...
### Attributes and Associations  
 ...
 ![Equivalent association and attributes](../VS_IDE/media/UML_ClassGuideAttrib.png "UML_ClassGuideAttrib")  
...
### Realization  
 ...
 ![Realization shown with conector and lollipop](../VS_IDE/media/UML_ClassGuideRealize.png "UML_ClassGuideRealize")  
...
##  <a name="Templates"></a> Template Types  
 ...
 ![Template class with two parameters](../VS_IDE/media/UML_ClassGuideTemplate1.png "UML_ClassGuideTemplate1")  
...
9. Add attributes and operations to the template type as you would do for other classes.  
 ...
 ![A  class bound from the Dictionary template](../VS_IDE/media/UML_ClassGuideTemplate2.png "UML_ClassGuideTemplate2")  
...
##  <a name="Packages"></a> Packages  
 ...
 See [Define packages and namespaces](../VS_IDE/Define-packages-and-namespaces.md).  
...
-   Open the shortcut menu for the diagram or an element, choose **Generate Code**, and then set the necessary properties.  
     ...
     For more information about how to set these properties and customize the provided templates, see [Generate code from UML class diagrams](../VS_IDE/Generate-code-from-UML-class-diagrams.md).  
