...
|Title|Description|  
|-----------|-----------------|  
|[Model Editor](../VS_IDE/Model-Editor.md)|Describes how to use the Model Editor to work with 3-D models.|  
|[Model Editor Examples](../VS_IDE/Model-Editor-Examples.md)|Provides links to topics that demonstrate how to use the Model Editor to perform common 3-D modeling tasks.|