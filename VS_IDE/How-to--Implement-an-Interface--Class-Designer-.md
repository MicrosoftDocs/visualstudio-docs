...
> [!TIP]
>  You can create interfaces the same way you create other types. If the interface exists but does not appear on the class diagram, then first display it. For more information, see [How to: Create Types by using Class Designer](../VS_IDE/How-to--Create-Types-by-using-Class-Designer.md) and [How to: View Existing Types (Class Designer)](../VS_IDE/How-to--View-Existing-Types--Class-Designer-.md).  
...
2.  Draw an inheritance line from the class and the interface.  
 ...
 For more information, see [How to: Create Inheritance Between Types (Class Designer)](../VS_IDE/How-to--Create-Inheritance-Between-Types--Class-Designer-.md).  
