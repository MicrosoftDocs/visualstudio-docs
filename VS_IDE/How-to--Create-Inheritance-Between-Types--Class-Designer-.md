...
1.  From your project in Solution Explorer, open a class diagram (.cd) file.  
     ...
     If you don't have a class diagram, create it. See [How to: Add Class Diagrams to Projects (Class Designer)](../VS_IDE/How-to--Add-Class-Diagrams-to-Projects--Class-Designer-.md).  
...
4.  Optionally, when you have a derived type from a generic type, click the inheritance line. In the **Properties** window, set the **Type Arguments** property to match the type that you want for the generic type.  
    ...
    > [!NOTE]
    >  If a parent abstract class contains at least one abstract member, then all abstract members are implemented as non-abstract inheriting classes. See [Implementing Abstract Base Classes](../VS_IDE/Refactoring-Classes-and-Types--Class-Designer-.md#ImplementingAbstractBaseClasses).  
    >   
