...
2.  Choose the **Enter** event, enter `answer_Enter`, and then choose the Enter key.  
     ...
     ![Properties dialog box](../VS_IDE/media/Express_AnswerEnter.png "Express_AnswerEnter")  
...
-   To go to the next tutorial step, see [Step 6: Add a Subtraction Problem](../VS_IDE/Step-6--Add-a-Subtraction-Problem.md).  
  
-   To return to the previous tutorial step, see [Step 4: Add the CheckTheAnswer() Method](../VS_IDE/Step-4--Add-the-CheckTheAnswer---Method.md).