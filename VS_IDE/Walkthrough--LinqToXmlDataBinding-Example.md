...
## Prerequisites  
 Before you read this walkthrough, we highly recommended that you build and run the LinqToXmlDataBinding program as described in [How to: Build and Run the LinqToXmlDataBinding Example](../VS_IDE/How-to--Build-and-Run-the-LinqToXmlDataBinding-Example.md).  
...
|Topic|Description|  
|-----------|-----------------|  
|[L2DBForm.xaml Source Code](../VS_IDE/L2DBForm.xaml-Source-Code.md)|Contains the contents and description of the XAML code in file L2DBForm.xaml.|  
|[L2DBForm.xaml.cs Source Code](../VS_IDE/L2DBForm.xaml.cs-Source-Code.md)|Contains the contents and description of the C# source code in the file L2DBForm.xaml.cs.|  
