...
3.  When adding the `List` object, notice the **IntelliSense** window that opens. The following is a Visual C# example, but similar text appears when you add a list in Visual Basic.  
     ...
     ![Properties window showing Click event](../VS_IDE/media/Express_ListIntellisense.png "Express_ListIntellisense")  
IntelliSense window  
...
-   To go to the next tutorial step, see [Step 3: Assign a Random Icon to Each Label](../VS_IDE/Step-3--Assign-a-Random-Icon-to-Each-Label.md).  
  
-   To return to the previous tutorial step, see [Step 1: Create a Project and Add a Table to Your Form](../VS_IDE/Step-1--Create-a-Project-and-Add-a-Table-to-Your-Form.md).