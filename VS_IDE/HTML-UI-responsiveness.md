...
8.  If you have added user marks, they will appear in the [View the diagnostic session timeline](#Ruler) of the profiler. The following illustration shows a single user mark used to specify a particular operation in your code.  
     ...
     ![Diagnostics Ruler showing a user mark](../VS_IDE/media/JS_HTMLVizProfiler_UserMark.png "JS_HTMLVizProfiler_UserMark")  
...
10. Select the area of interest in one of the graphs by clicking a part of the graph and dragging the pointer to make a selection (or by using the Tab key and arrow keys). When you select a time period by making a selection, the timeline details graph in the profiler's lower pane changes to show only the selected time period.  
     ...
     ![CPU utilization graph](../VS_IDE/media/JS_HTMLVizProf_CPU_Util.png "JS_HTMLVizProf_CPU_Util")  
...
```  
 ...
 ![User measure event in the timeline details view](../VS_IDE/media/JS_HTMLVizProfiler_User_Measure.png "JS_HTMLVizProfiler_User_Measure")  
...
###  <a name="Ruler"></a> View the diagnostic session timeline  
 ...
 ![Diagnostic session ruler](../VS_IDE/media/JS_HTMLVizProf_Ruler.png "JS_HTMLVizProf_Ruler")  
...
-   The graph shows a value of zero if frames are being dropped.  
 ...
 ![Visual throughput graph](../VS_IDE/media/JS_HTMLVizProf_VizThru.png "JS_HTMLVizProf_VizThru")  
...
>  When an event occurs on a background thread, the thread ID appears in brackets next to the event name.  
 ...
 ![Timeline details graph](../VS_IDE/media/JS_HTMLVizProf_TimelineDet.png "JS_HTMLVizProf_TimelineDet")  
...
###  <a name="FilterTimelineDetails"></a> Filter timeline details  
 ...
 ![Filtering timeline to an event](../VS_IDE/media/JS_HTMLVizProfiler_FilterToEvent.png "JS_HTMLVizProfiler_FilterToEvent")  
...
###  <a name="FilterEvents"></a> Filter events  
 ...
 ![Filtering events in the timeline](../VS_IDE/media/JS_HTMLVizProfiler_Event_Filter.png "JS_HTMLVizProfiler_Event_Filter")  
...
###  <a name="GroupFrames"></a> Group events by frame  
 ...
 ![Group top level events by frame](../VS_IDE/media/JS_HTMLVizProfiler_Frame_Grouping_Button.png "JS_HTMLVizProfiler_Frame_Grouping_Button")  
  
 When you group the events by frame, the top-level events in the timeline details view each represent a frame.  
  
 ![Timeline events grouped by frame](../VS_IDE/media/JS_HTMLVizProfiler_Frame_Grouping.png "JS_HTMLVizProfiler_Frame_Grouping")  
