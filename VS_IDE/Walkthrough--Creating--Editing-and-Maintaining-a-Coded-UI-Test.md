...
12. Select the Checkbox control. In the Properties window, change the value for the **Name** property from <No Name\> to checkBox1 and clear the **IsEnabled** property.  
     ...
     ![Simple WPF Application](../VS_IDE/media/CodedUI_WPFApp.png "CodedUI_WPFApp")  
...
7.  Select the **Record actions, edit UI map or add assertions** option and choose **OK**.  
     ...
     For more information about the options in the dialog box, see [Creating Coded UI Tests](../VS_IDE/Use-UI-Automation-To-Test-Your-Code.md#VerifyingCodeUsingCUITCreate).  
  
8.  Choose **Start Recording** on the UIMap – Coded UI Test Builder.  
  
     ![Start recording](../VS_IDE/media/CUIT_Builder_Record.png "CUIT_Builder_Record")  
  
     You can pause the recording if needed, for example if you have to deal with incoming mail.  
  
     ![Pause the recording](../VS_IDE/media/CUIT_.png "CUIT_")  
...
### Videos  
 ![link to video](../VS_IDE/media/PlayVideo.gif "PlayVideo") [Coded UI Tests-DeepDive-Episode1-GettingStarted](http://go.microsoft.com/fwlink/?LinkID=230573)  
  
 ![link to video](../VS_IDE/media/PlayVideo.gif "PlayVideo") [Coded UI Tests-DeepDive-Episode2-MaintainenceAndDebugging](http://go.microsoft.com/fwlink/?LinkID=230574)  
  
 ![link to video](../VS_IDE/media/PlayVideo.gif "PlayVideo") [Coded UI Tests-DeepDive-Episode3-HandCoding](http://go.microsoft.com/fwlink/?LinkID=230575)  
