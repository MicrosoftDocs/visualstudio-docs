...
3.  There has been an environment event that you might be interested in  
 ...
 If you choose to always ignore a notification, Visual Studio will stop showing it. You can reset the list of ignored notifications in the [Notifications, Environment, Options Dialog Box](../VS_IDE/Notifications--Environment--Options-Dialog-Box.md).  
  
 ![Visual Studio notification icon](../VS_IDE/media/vs2015_NotificationIcon.png "vs2015_NotificationIcon")  
