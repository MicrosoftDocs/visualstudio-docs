...
|||  
|-|-|  
|![Run after build](../VS_IDE/media/UTE_RunAfterBuild_btn.png "UTE_RunAfterBuild_btn")|To run your unit tests after each local build, choose **Test** on the standard menu, and then choose **Run Tests After Build** on the Test Explorer toolbar.|  
...
###  <a name="BKMK_View_test_details"></a> View test details  
 ...
 ![Test execution details](../VS_IDE/media/UTE_TestDetails.png "UTE_TestDetails")  
...
###  <a name="BKMK_Grouping_the_test_list"></a> Grouping the test list  
 To change the way that tests are organized, choose the down arrow next to the **Group By** button ![Test Explorer group button](../VS_IDE/media/UTE_GroupBy_btn.png "UTE_GroupBy_btn") and select a new grouping criteria.  
  
 ![Group tests by category in Test Explorer](../VS_IDE/media/UTE_GroupByCategory.png "UTE_GroupByCategory")  
 ...
 **Traits in the Microsoft Unit Testing Framework for Managed Code**  
 ...
 In the Microsoft unit test framework for managed apps, you define a trait name/ value pair in a  <xref:Microsoft.VisualStudio.TestTools.UnitTesting.TestPropertyAttribute?qualifyHint=False> attribute. The test framework also contains these predefined traits:  
  
|Trait|Description|  
|-----------|-----------------|  
|<xref:Microsoft.VisualStudio.TestTools.UnitTesting.OwnerAttribute?qualifyHint=False>|The Owner category is defined by the unit test framework and requires you to provide a string value of the owner.|  
|<xref:Microsoft.VisualStudio.TestTools.UnitTesting.PriorityAttribute?qualifyHint=False>|The Priority category is defined by the unit test framework and requires you to provide an integer value of the priority.|  
|<xref:Microsoft.VisualStudio.TestTools.UnitTesting.TestCategoryAttribute?qualifyHint=False>|The TestCategory attribute enables you to provide a category without a value. A category defined by the TestCategory attribute can also be the category of a TestProperty attribute.|  
|<xref:Microsoft.VisualStudio.TestTools.UnitTesting.TestPropertyAttribute?qualifyHint=False>|The TestProperty attribute enables you to define trait category/value pair.|  
...
3.  Enter the filter value between the quotation marks.  
 ...
 ![Filter tests in Test Explorer](../VS_IDE/media/UTE_FilterTestList.png "UTE_FilterTestList")  
...
##  <a name="BKMK_Create_custom_playlists"></a> Create custom playlists  
 ...
 ![Choose a playlist](../VS_IDE/media/UTE_Playlist.png "UTE_Playlist")  
...
2.  In Test Explorer, select the test methods and then choose **Debug Selected Tests** on the context menu.  
 ...
 For more information, about the debugger, see [Debugging in Visual Studio](../VS_debugger/Debugging-in-Visual-Studio.md).  
  
 ![Back to top](../VS_debugger/media/PCS_BackToTop.png "PCS_BackToTop") [Contents](#BKMK_Contents)  
  
###  <a name="BKMK_Diagnose_test_method_performance_issues"></a> Diagnose test method performance issues  
 To diagnose why a test method is taking too much time, select the method in Test Explorer and then choose Profile on the context menu. See [Performance Explorer](../VS_IDE/Performance-Explorer.md).  
