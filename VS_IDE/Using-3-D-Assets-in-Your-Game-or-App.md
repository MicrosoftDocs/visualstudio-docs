...
|[Working with 3-D Assets for Games and Apps](../VS_IDE/Working-with-3-D-Assets-for-Games-and-Apps.md)|Describes the editing tools that Visual Studio provides for creating and manipulating 3-D assets, which include textures and images, 3-D models, and shaders.|  
|[How to: Export a Shader](../VS_IDE/How-to--Export-a-Shader.md)|Describes how to export a shader from the Shader Designer.|