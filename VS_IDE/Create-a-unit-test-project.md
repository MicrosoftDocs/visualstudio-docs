...
> [!NOTE]
>  The location of unit tests for native code and the test project structure can be different than the structure that is described in this topic. For more information, see [Adding unit tests to existing C++ applications](../VS_IDE/Unit-testing-existing-C---applications-with-Test-Explorer.md).  
...
5.  If the code that you want to test is in another location, see [Managing references in a project](../VS_IDE/Managing-references-in-a-project.md) for information about adding references.  
