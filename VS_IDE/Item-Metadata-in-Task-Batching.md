...
-   Filtering item lists  
 ...
 For more information on batching with MSBuild, see [Batching](../VS_IDE/MSBuild-Batching.md).  
...
```  
 ...
 The [Message Task](../VS_IDE/Message-Task.md) task displays the following information:  
...
## See Also  
 [Well-known Item Metadata](../VS_IDE/MSBuild-Well-known-Item-Metadata.md)   
