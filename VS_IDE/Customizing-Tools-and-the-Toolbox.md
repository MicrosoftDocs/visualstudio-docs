...
##  <a name="connections"></a> Customizing Connection Tools  
 ...
 When you create a reference relationship between domain classes, a connection builder is automatically created. You can use this connection builder when you map a connection tool. For more information about how to create connection tools, see [Configuring the Toolbox](../VS_IDE/Customizing-Tools-and-the-Toolbox.md).  
...
> [!NOTE]
>  To add custom code, create a partial class definition in a code file separate from the code files in the GeneratedCode folders. To avoid losing your work, you should not edit the generated code files. For more information, see [Overriding and Extending the Generated Classes](../VS_IDE/Overriding-and-Extending-the-Generated-Classes.md).  
 ...
 **Connection Coming in to an OutPort from a Nested Component**  
 ...
 ![Connection Builder](../VS_IDE/media/ConnectionBuilder_3.png "ConnectionBuilder_3")  
 ...
 **Link Connect Directive in DSL Explorer**  
 ...
 ![Connection builder image](../VS_IDE/media/ConnectionBuilder_4a.png "ConnectionBuilder_4a")  
  
 **Link Connect Directive in DSL Details Window**  
  
 ![](../VS_IDE/media/ConnectionBuilder_4b.png "ConnectionBuilder_4b")  
