...
2.  Before you open a picture, choose the **Set the background color** button. The **Color** dialog box opens.  
     ...
     ![Color dialog box](../VS_IDE/media/Express_ColorDialog.png "Express_ColorDialog")  
Color dialog box  
...
-   To go to the next tutorial, see [Tutorial 2: Create a Timed Math Quiz](../VS_IDE/Tutorial-2--Create-a-Timed-Math-Quiz.md).  
  
-   To return to the previous tutorial step, see [Step 10: Write Code for Additional Buttons and a Check Box](../VS_IDE/Step-10--Write-Code-for-Additional-Buttons-and-a-Check-Box.md).