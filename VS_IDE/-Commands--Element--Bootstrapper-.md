...
|Attribute|Description|  
|---------------|-----------------|  
|`Property`|Required. The name of the property to test. The property must previously have been defined by a child of the `InstallChecks` element. For more information, see [<InstallChecks\> Element](../VS_IDE/-InstallChecks--Element--Bootstrapper-.md).|  
...
## See Also  
 ...
 [<InstallChecks\> Element](../VS_IDE/-InstallChecks--Element--Bootstrapper-.md)