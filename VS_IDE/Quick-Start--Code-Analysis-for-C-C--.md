...
-   [Configure rule sets for a project](../VS_IDE/Quick-Start--Code-Analysis-for-C-C--.md#BKMK_ConfigureRuleSets)  
  
-   [Run code analysis](../VS_IDE/Quick-Start--Code-Analysis-for-C-C--.md#BKMK_Run)  
  
-   [Analyze and resolve code analysis warnings](../VS_IDE/Quick-Start--Code-Analysis-for-C-C--.md#BKMK_Analyze)  
  
-   [Suppressing code analysis warnings](../VS_IDE/Quick-Start--Code-Analysis-for-C-C--.md#BKMK_Suppress)  
  
-   [Creating work items for code analysis warnings](../VS_IDE/Quick-Start--Code-Analysis-for-C-C--.md#BKMK_Creating_work_items_for_code_analysis_warnings)  
  
-   [Searching and filtering code analysis results](../VS_IDE/Quick-Start--Code-Analysis-for-C-C--.md#BKMK_Search)  
