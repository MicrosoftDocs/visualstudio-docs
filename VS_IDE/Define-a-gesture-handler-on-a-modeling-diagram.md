...
## Requirements  
 See [Requirements](../VS_IDE/Extend-UML-models-and-diagrams.md#Requirements).  
...
2.  Add the following references to your project.  
     ...
     `Microsoft.VisualStudio.ArchitectureTools.Extensibility.Layer` – You need this only if you are extending Layer diagrams. For more information, see [Extend layer diagrams](../VS_IDE/Extend-layer-diagrams.md).  
...
2.  In the experimental Visual Studio, open or create a modeling project, and open or create a modeling diagram. Use a diagram that belongs to one of the types listed in the attributes of your gesture handler class.  
...
### The Gesture Handler Methods  
 The gesture handler class implements and exports <xref:Microsoft.VisualStudio.Modeling.Diagrams.ExtensionEnablement.IGestureExtension?qualifyHint=False>. The methods you need to define are as follows:  
...
-   `DiagramDragEventArgs eventArgs`. This parameter carries the serialized form of the source object of a drag operation:  
    ...
    ```  
     ...
     If your source object is a UML element dragged from UML Model Explorer or from another UML diagram, refer to [Get UML model elements from IDataObject](../VS_IDE/Get-UML-model-elements-from-IDataObject.md).  
  
### Writing the code of the methods  
 For more information about writing the code to read and update the model, see [Programming with the UML API](../VS_IDE/Programming-with-the-UML-API.md).  
  
 For information about accessing model information in a drag operation, see [Get UML model elements from IDataObject](../VS_IDE/Get-UML-model-elements-from-IDataObject.md).  
  
 If you are dealing with a sequence diagram, see also [Edit UML sequence diagrams by using the UML API](../VS_IDE/Edit-UML-sequence-diagrams-by-using-the-UML-API.md).  
...
```  
 ...
 For more information, see [Navigate the UML model](../VS_IDE/Navigate-the-UML-model.md).  
...
##  <a name="DragExample"></a> Example  
 ...
 For more information about binding interactions to sequence diagrams, see [Edit UML sequence diagrams by using the UML API](../VS_IDE/Edit-UML-sequence-diagrams-by-using-the-UML-API.md).  
...
```  
 ...
 The code of `GetModelElementsFromDragEvent()` is described in [Get UML model elements from IDataObject](../VS_IDE/Get-UML-model-elements-from-IDataObject.md).  
