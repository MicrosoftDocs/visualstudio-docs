...
The **Performance Explorer** window in the Visual Studio integrated development environment (IDE) enables you to configure and start performance sessions by using the Visual Studio Profiling Tools.  
