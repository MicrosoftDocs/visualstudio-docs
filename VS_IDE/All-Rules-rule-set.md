...
1.  [Code Analysis for C/C++ Warnings](../VS_IDE/Code-Analysis-for-C-C---Warnings.md)  
  
2.  [Code Analysis for Managed Code Warnings](../VS_IDE/Code-Analysis-for-Managed-Code-Warnings.md)