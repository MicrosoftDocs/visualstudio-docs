...
---
# Content Model View
The Content Model View provides a graphic representation of local and global schema nodes and their components, including simple and complex types, elements, model groups, attributes, and attribute groups. XML comments and processing instructions cannot be viewed in the Content Model View. The Content Model View contains two panels: a **Workspace** panel that contains a list of the nodes in the [XML Schema Designer Workspace](../VS_IDE/XML-Schema-Designer-Workspace.md), and the design surface where you can see the content model of schema nodes that are selected in the **Workspace** panel. The Content Model View also includes the XML Schema Designer toolbar and the breadcrumb bar.  
 ...
 ![XML Schema Designer Content Model View](../VS_IDE/media/XSDDesigner_ContentModelView.gif "XSDDesigner_ContentModelView")  
...
## Workspace Panel  
 ...
 For information about adding nodes, see the "Adding Nodes to the Workspace" section in [XML Schema Designer Workspace](../VS_IDE/XML-Schema-Designer-Workspace.md).  
...
## XSD Designer Toolbar  
 ...
 ![XML Schema Designer Toolbar](../VS_IDE/media/XSDContentModelViewToolbar.gif "XSDContentModelViewToolbar")  
...
## XML Editor Integration  
 ...
 If you make changes to the schema set in the XML Editor the changes will be synchronized in the Content Model View. For more information, see [Integration with XML Editor](../VS_IDE/Integration-with-XML-Editor.md).  
