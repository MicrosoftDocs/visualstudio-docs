...
## Displaying the Values of Variables  
 To check the value of a variable `varA`, use the [Print Command](../VS_IDE/Print-Command.md):  
...
-   `var[1-3]+` and `oldpar` are parameters  
 ...
 The position of switches and parameters can be interchanged freely on the command line with the exception of the [Shell](../VS_IDE/Shell-Command.md) command, which requires its switches and parameters in a specific order.  
