...
## See Also  
 [How to: Instrument a Dynamically Compiled ASP.NET Application and Collect Detailed Timing Data](../VS_IDE/How-to--Instrument-a-Dynamically-Compiled-ASP.NET-Web-Application-and-Collect-Detailed-Timing-Data-with-the-Profiler-by-Using-the-Command-Line.md)   
 [How to: Instrument a Dynamically Compiled ASP.NET Application and Collect Memory Data](../VS_IDE/How-to--Instrument-a-Dynamically-Compiled-ASP.NET-Web-Application-and-Collect-Memory-Data-by-Using-the-Profiler-Command-Line.md)