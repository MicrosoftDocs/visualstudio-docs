...
```  
 ...
 The .runsettings file is also used to configure [Code Coverage](../VS_IDE/Customizing-Code-Coverage-Analysis.md).  
...
#### Code coverage adapter  
 The code coverage data collector creates a log of which parts of the application code have been exercised in the test. For more information about customizing the settings for code coverage, see [Customizing Code Coverage Analysis](../VS_IDE/Customizing-Code-Coverage-Analysis.md).  
...
#### Other diagnostic data adapters  
 ...
 To customize any other type of diagnostic data adapter, you must use a test settings file. For more information, see [Specifying Test Settings for Visual Studio Tests](../dv_TeamTestALM/Specifying-Test-Settings-for-Visual-Studio-Tests.md).  
