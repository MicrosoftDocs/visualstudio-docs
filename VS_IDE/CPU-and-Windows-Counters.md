...
### Command Line  
 Using the [VSPerfCmd](../VS_IDE/VSPerfCmd.md) command line tool, you can list the CPU counters that are available on a computer from the command line.  
