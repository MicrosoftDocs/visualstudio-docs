...
-   In the timeline graph, click the name or id of the resource.  
     ...
     The [Resource Details View](../VS_IDE/Resource-Details-View---Contention-Data.md) appears for the selected resource.  
  
#### To view the thread contention data in the Processes window  
  
-   In the timeline graph, click **Total**.  
  
     The [Process View](../VS_IDE/Process-View---Contention-Data.md) appears with the thread selected.