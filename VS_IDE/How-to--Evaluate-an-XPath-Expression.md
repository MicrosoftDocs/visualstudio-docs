...
> [!NOTE]
>  The following procedure uses the belowAvg.xsl and books.xml files from the [Walkthrough: Debug an XSLT Style Sheet](../VS_IDE/Walkthrough--Debug-an-XSLT-Style-Sheet.md) topic.  
