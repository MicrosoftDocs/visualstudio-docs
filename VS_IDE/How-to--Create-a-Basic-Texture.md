...
## Creating a basic texture  
 ...
 !["Bullseye" target with transparency shown in green](../VS_IDE/media/Digit-Bullseye-Texture-In-Editor.png "Digit-Bullseye-Texture-In-Editor")  
...
17. Draw another circle from pixel coordinate `(192, 192)` to pixel coordinate `(320, 320)`.  
 ...
 ![The complete "bullseye" target texture](../VS_IDE/media/gfx_image_demo_bullseye.png "gfx_image_demo_bullseye")  
  
 As a next step, you can generate MIP levels for this texture. For information, see [How to: Create and Modify MIP Levels](../VS_IDE/How-to--Create-and-Modify-MIP-Levels.md).  
