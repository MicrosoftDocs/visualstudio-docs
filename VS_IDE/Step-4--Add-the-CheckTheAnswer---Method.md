...
-   To go to the next tutorial step, see [Step 5: Add Enter Event Handlers for the NumericUpDown Controls](../VS_IDE/Step-5--Add-Enter-Event-Handlers-for-the-NumericUpDown-Controls.md).  
  
-   To return to the previous tutorial step, see [Step 3: Add a Countdown Timer](../VS_IDE/Step-3--Add-a-Countdown-Timer.md).