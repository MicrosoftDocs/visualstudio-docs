...
|---------------|-----------------|  
|`Code`|The code name of the included product, as specified by the `ProductCode` attribute of the `Product` element. For more information, see [<Product\> Element](../VS_IDE/-Product--Element--Bootstrapper-.md).|  
...
## See Also  
 [<Product\> Element](../VS_IDE/-Product--Element--Bootstrapper-.md)