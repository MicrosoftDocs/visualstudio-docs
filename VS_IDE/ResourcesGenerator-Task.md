...
The <xref:Microsoft.Build.Tasks.Windows.ResourcesGenerator?qualifyHint=False> task embeds one or more resources (.jpg, .ico, .bmp, XAML in binary format, and other extension types) into a .resources file.  
