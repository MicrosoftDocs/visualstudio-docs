...
> [!TIP]
>  For information about how to change the colors of the code editor, see [How to: Change Fonts and Colors in the Editor](../VS_IDE/How-to--Change-Fonts-and-Colors-in-the-Editor.md).  
