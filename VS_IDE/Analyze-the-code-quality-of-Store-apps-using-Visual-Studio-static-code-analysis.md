...
|||  
|-|-|  
|[Analyze Visual Basic and C# code quality](../VS_IDE/Analyze-Visual-Basic-and-C#-code-quality-in-Store-apps-using-Visual-Studio-static-code-analysis.md)|Use code analysis in Visual Basic and C# projects.|  
