...
1.  In Visual Studio, open a **Visual Shader Graph (.dgsl)** file.  
     ...
     If you don't have a **Visual Shader Graph (.dgsl)** file to open, create one as described in [How to: Create a Basic Color Shader](../VS_IDE/How-to--Create-a-Basic-Color-Shader.md).  
