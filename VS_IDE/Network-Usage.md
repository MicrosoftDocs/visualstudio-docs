...
4.  Choose **Stop** to close the app.  
 ...
 ![The Network window](../VS_IDE/media/NETWORK_FullWindow.png "NETWORK_FullWindow")  
...
## Analyzing data  
 ...
 ![Network tool details pane](../VS_IDE/media/NETWORK_DetailsViewPane.png "NETWORK_DetailsViewPane")  
