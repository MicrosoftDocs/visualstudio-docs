 ...
 **Audio control:** Actions on the HTML5 Audio control are correctly recorded and played back.  
 ...
 ![HTML5 Audio control](../VS_IDE/media/CodedUI_HTML5_Audio.png "CodedUI_HTML5_Audio")  
 ...
 **Video control:** Actions on the HTML5 Video control are correctly recorded and played back.  
 ...
 ![HTML5 Video control](../VS_IDE/media/CodedUI_HTML5_Video.png "CodedUI_HTML5_Video")  
 ...
 **Slider control:** Actions on the HTML5 Slider control are correctly recorded and played back.  
 ...
 ![HTML5 Slider control](../VS_IDE/media/CodedUI_HTML5_Slider.png "CodedUI_HTML5_Slider")  
 ...
 **ProgreesBar control:** The ProgressBar is a non-interactable control. You can add assertions on the `Value` and `Max` properties of this control.  
 ...
 ![HTML5 ProgressBar control](../VS_IDE/media/CodedUI_HTML5_ProgressBar.png "CodedUI_HTML5_ProgressBar")  
...
## See Also  
 ...
 [Customizing your coded UI test](../VS_IDE/Use-UI-Automation-To-Test-Your-Code.md#VerifyingCodeCUITModify)   
