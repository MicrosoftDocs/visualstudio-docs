...
-   Invalid [Edit and Continue](../VS_debugger/Edit-and-Continue.md) edits are purple.  
...
## Organize Usings  
 ...
 When selected, `System` using directives appear before other using directives. For more information, see [Sort Usings](../VS_not_in_toc/Sort-Usings.md).  
