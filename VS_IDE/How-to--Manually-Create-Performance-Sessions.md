...
You can manually create a performance session. You are not required to open a project in Visual Studio to do this. For more information, see [Configuring Performance Sessions](../VS_IDE/Configuring-Performance-Sessions.md).  
