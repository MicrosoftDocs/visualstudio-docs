...
### Description  
 Methods that implement the **Try<Something\>** pattern, such as <xref:System.Int32.TryParse?qualifyHint=True>, do not raise this violation. The following example shows a structure (value type) that implements the <xref:System.Int32.TryParse?qualifyHint=True> method.  
