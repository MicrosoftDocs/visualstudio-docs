...
-   [VSPackage](../Topic/VSPackages.md). If you are defining a VSPackage that contains other features in addition to the directive processor, there is a convenient method of registering the directive processor.  
...
>  This attribute is placed on the package class, not the directive processor class.  
 ...
 For more information, see [VSPackages](../Topic/VSPackages.md).  
