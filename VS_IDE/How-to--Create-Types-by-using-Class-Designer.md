...
To design new types for Visual C# .NET and Visual Basic .NET projects, create them on a class diagram. To see existing types, see [How to: View Existing Types (Class Designer)](../VS_IDE/How-to--View-Existing-Types--Class-Designer-.md).  
...
4.  Now add other items to define the type:  
    ...
    |Module|Methods, properties, fields, events, constructors (method), and constants that define the module|  
     ...
     See [Creating Members](../VS_IDE/Creating-and-Configuring-Type-Members--Class-Designer-.md#CreateMembers).  
