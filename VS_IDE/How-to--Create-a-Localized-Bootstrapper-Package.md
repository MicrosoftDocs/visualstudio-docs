...
3.  Create a package manifest named package.xml and put it in the new folder. For more information, see [How to: Create a Package Manifest](../VS_IDE/How-to--Create-a-Package-Manifest.md).  
