...
```  
 ...
 Because the type of this property depends on the type of host, it is only useful if you are writing a text template that works only with a specific host. It’s applicable to [design-time templates](../VS_IDE/Design-Time-Code-Generation-by-using-T4-Text-Templates.md), but not [run-time templates](../VS_IDE/Run-Time-Text-Generation-with-T4-Text-Templates.md).  
