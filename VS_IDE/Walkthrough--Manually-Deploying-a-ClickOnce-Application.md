...
-   Install Mage.exe and MageUI.exe.  
     ...
     Mage.exe and MageUI.exe are part of the Windows Software Development Kit (SDK). You must either have the Windows SDK installed or the version of the Windows SDK included with Visual Studio. For more information, see [Windows SDK](http://go.microsoft.com/fwlink/?LinkId=158044) on MSDN.  
...
-   Determine how the deployment will be distributed.  
     ...
     The distribution options include: Web, file share, or CD. For more information, see [ClickOnce Security and Deployment](../VS_IDE/ClickOnce-Security-and-Deployment.md).  
