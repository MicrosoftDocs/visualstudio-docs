...
## Properties  
 ...
 ![Properties on assocations](../VS_IDE/media/UML_ClassProp.png "UML_ClassProp")  
...
|**Work Items**|The number of work items linked to this association. To link work items, see [Link model elements and work items](../VS_IDE/Link-model-elements-and-work-items.md).|  
