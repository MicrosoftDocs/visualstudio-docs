...
## String Item Functions  
 You can use string methods and properties in the .NET Framework to operate on any item value. For <xref:System.String?qualifyHint=False> methods, specify the method name. For <xref:System.String?qualifyHint=False> properties, specify the property name after "get_".  
