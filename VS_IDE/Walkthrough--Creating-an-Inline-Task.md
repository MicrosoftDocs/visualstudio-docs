...
MSBuild tasks are typically created by compiling a class that implements the <xref:Microsoft.Build.Framework.ITask?qualifyHint=False> interface. Starting with the .NET Framework version 4, you can create tasks inline in the project file. You do not have to create a separate assembly to host the task. For more information, see [Inline Tasks](../VS_IDE/MSBuild-Inline-Tasks.md).  
...
## See Also  
 [Inline Tasks](../VS_IDE/MSBuild-Inline-Tasks.md)   
