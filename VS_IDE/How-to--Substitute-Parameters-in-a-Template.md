...
You may replace template parameters such as class names and namespaces when a file based on a template is created. For a complete list of template parameters, see [Template Parameters](../VS_IDE/Template-Parameters.md).  
...
## See Also  
 ...
 [ProjectItem Element (Visual Studio Item Templates)](../Topic/ProjectItem%20Element%20\(Visual%20Studio%20Item%20Templates\).md)