...
```  
 ...
 The type of `AnEditor` must be derived from the type specified in the second parameter. The second parameter should be either <xref:System.Drawing.Design.UITypeEditor?qualifyHint=False> or <xref:System.ComponentModel.ComponentEditor?qualifyHint=False>. For more information, see <xref:System.ComponentModel.EditorAttribute?qualifyHint=False>.  
  
 You can specify either your own editor, or an editor supplied in the .NET Framework, such as <xref:System.Windows.Forms.Design.FileNameEditor?qualifyHint=False> or <xref:System.Drawing.Design.ImageEditor?qualifyHint=False>. For example, use the following procedure to have a property in which the user can enter a file name.  
...
### Defining your own property editor  
 ...
 You define an editor by writing a class that is derived from <xref:System.Drawing.Design.UITypeEditor?qualifyHint=False>. Your class must override:  
  
-   <xref:System.Drawing.Design.UITypeEditor.EditValue?qualifyHint=False>, to interact with the user and update the property value.  
  
-   <xref:System.Drawing.Design.UITypeEditor.GetEditStyle?qualifyHint=False>, to specify whether your editor will open a dialog or provide a drop-down menu.  
  
 You can also provide a graphical representation of the property’s value that will be displayed in the property grid. To do this, override `GetPaintValueSupported`, and `PaintValue`.  For more information, see <xref:System.Drawing.Design.UITypeEditor?qualifyHint=False>.  
...
```  
 ...
 For more information, see <xref:System.Drawing.Design.UITypeEditor?qualifyHint=False>.  
...
```  
 ...
 Define a class that derives from <xref:System.ComponentModel.TypeConverter?qualifyHint=False>. Add the code in a separate file in the **Dsl** project. For example:  
