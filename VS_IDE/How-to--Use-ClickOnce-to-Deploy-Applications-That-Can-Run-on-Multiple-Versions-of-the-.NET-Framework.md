...
-   Update and re-sign the application and deployment manifests. For more information, see [How to: Re-sign Application and Deployment Manifests](../VS_IDE/How-to--Re-sign-Application-and-Deployment-Manifests.md).  
...
## See Also  
 ...
 [<dependency\> Element](../VS_IDE/-dependency--Element--ClickOnce-Application-.md)   
