...
|Domain-Specific Language Tools|[http://go.microsoft.com/fwlink/?LinkID=185581](http://go.microsoft.com/fwlink/?LinkID=185581)|  
...
2.  The system regenerates the code for the solution, and saves DslDefinition.dsl. For information about the XML format of definition files, see [The DslDefinition.dsl File](../VS_IDE/The-DslDefinition.dsl-File.md).  
...
## Next Steps  
 If you plan to use more than one tracking property, or implement tracking properties in more than one DSL, you can create a text template to generate the common code for supporting each tracking property. For more information about text templates, see [Code Generation and T4 Text Templates](../VS_IDE/Code-Generation-and-T4-Text-Templates.md).  
  
## See Also  
 <xref:Microsoft.VisualStudio.Modeling.Design.TrackingPropertyDescriptor?qualifyHint=False>   
 <xref:Microsoft.VisualStudio.Modeling.Design.ElementTypeDescriptor?qualifyHint=False>   
