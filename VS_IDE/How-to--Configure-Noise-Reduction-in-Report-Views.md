...
2.  To enable trimming, follow these steps:  
    ...
    1.  Select **Enable Trimming**. This is the default setting.  
        ...
        > [!NOTE]
        >  If noise reduction is enabled, an information bar will display in the report. For more information, see [Call Tree View](../VS_IDE/Call-Tree-View.md) and [Allocations View](../VS_IDE/.NET-Memory-Allocations-View.md).  
