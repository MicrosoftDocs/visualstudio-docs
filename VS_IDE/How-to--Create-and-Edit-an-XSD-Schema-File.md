...
2.  Copy the XML Schema sample code from [Purchase Order Schema](../VS_IDE/Sample-XSD-File--Simple-Schema.md) and paste it to replace the code that was added to the new XSD file by default.  
