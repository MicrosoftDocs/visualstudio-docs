...
1.  Create a new C# Windows Universal app project named **CpuUseDemo** using the **BlankApp** template.  
     ...
     ![Create the CpuUseDemoProject](../VS_IDE/media/CPU_USE_NewProject.png "CPU_USE_NewProject")  
...
##  <a name="BKMK_Collect_CPU_usage_data"></a> Collect CPU usage data  
 ![Run a release build of the app in the simulator](../VS_IDE/media/CPU_USE_WT_SetSimulatorAndRetail.png "CPU_USE_WT_SetSimulatorAndRetail")  
...
3.  In the Performance and Diagnostic hub, choose **CPU Usage** and then choose **Start**.  
     ...
     ![Start the CpuUsage diagnostic session](../VS_IDE/media/CPU_USE_WT_PerfDiagHub.png "CPU_USE_WT_PerfDiagHub")  
...
###  <a name="BKMK_CPU_utilization_timeline_graph"></a> CPU utilization timeline graph  
 ![CpuUtilization &#40;%&#41; timeline graph](../VS_IDE/media/CPU_USE_WT_TimelineGraph.png "CPU_USE_WT_TimelineGraph")  
...
####  <a name="BKMK_Select_timeline_segments_to_view_details"></a> Select timeline segments to view details  
 ...
 ![GetMaxNumberButton&#95;Click selected](../VS_IDE/media/CPU_USE_WT_GetMaxNumberReport.png "CPU_USE_WT_GetMaxNumberReport")  
