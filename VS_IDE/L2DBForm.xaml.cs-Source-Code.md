...
-   The second statement creates a new <xref:System.Xml.Linq.XElement?qualifyHint=False> from the string values the user entered in the **Add New Book** user interface (UI) section.  
...
### Comments  
 For the associated XAML source for these handlers, see [L2DBForm.xaml Source Code](../VS_IDE/L2DBForm.xaml-Source-Code.md).  
