...
You can navigate in Visual Studio 2013 more easily by using the shortcuts in this topic. For more general information, see [<PAVEOVER\> Keyboard Shortcuts in Visual Studio](assetId:///2e15e27f-296b-4e9c-91e6-d91ea0110a67). For information about how to optimize Visual Studio for accessibility, see [Accessibility Tips and Tricks](../VS_IDE/Accessibility-Tips-and-Tricks.md).  
  
-   [Window Management](../VS_IDE/Tips-and-Tricks-for-Visual-Studio.md#BKMK_WindowMgmt)  
  
-   [Window Shortcuts](../VS_IDE/Tips-and-Tricks-for-Visual-Studio.md#BKMK_WindowShortcuts)  
  
-   [Visual Studio Search](../VS_IDE/Tips-and-Tricks-for-Visual-Studio.md#BKMK_Search)  
  
-   [Editor Find](../VS_IDE/Tips-and-Tricks-for-Visual-Studio.md#BKMK_EditorFind)  
  
-   [Code Editor](../VS_IDE/Tips-and-Tricks-for-Visual-Studio.md#BKMK_CodeEditor)  
  
-   [Toolbars](../VS_IDE/Tips-and-Tricks-for-Visual-Studio.md#BKMK_Toolbars)  
  
-   [Debugging](../VS_IDE/Tips-and-Tricks-for-Visual-Studio.md#BKMK_Debugging)  
  
-   [Application Lifecycle Management](../VS_IDE/Tips-and-Tricks-for-Visual-Studio.md#BKMK_ALM)  
