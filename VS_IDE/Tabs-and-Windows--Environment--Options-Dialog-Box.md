...
Use this page to set options for how tabbed windows behave in the editor pane, and how tool windows behave. For more information, see [How to: Arrange and Dock Windows](../VS_not_in_toc/How-to--Arrange-and-Dock-Windows.md)  
