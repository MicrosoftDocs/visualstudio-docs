...
7.  Save your program, run it, and then choose the **Start** button on the form.  
     ...
     ![Math quiz in progress](../VS_IDE/media/Express_AddCountdown.png "Express_AddCountdown")  
Math quiz in progress  
  
### To continue or review  
  
-   To go to the next tutorial step, see [Step 4: Add the CheckTheAnswer() Method](../VS_IDE/Step-4--Add-the-CheckTheAnswer---Method.md).  
  
-   To return to the previous tutorial step, see [Step 2: Create a Random Addition Problem](../VS_IDE/Step-2--Create-a-Random-Addition-Problem.md).