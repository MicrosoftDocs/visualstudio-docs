...
## Example  
 The following example shows an assembly that has the <xref:System.Runtime.InteropServices.ComVisibleAttribute?qualifyHint=False> attribute applied to prevent it from being visible to COM clients.  
  
 [!CODE [FxCop.Design.AssembliesCom#1](../CodeSnippet/VS_Snippets_CodeAnalysis/FxCop.Design.AssembliesCom#1)]  
