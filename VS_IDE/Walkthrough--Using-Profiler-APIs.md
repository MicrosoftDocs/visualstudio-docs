...
The walkthrough uses a C# application to demonstrate how to use the Visual Studio Profiling Tools APIs. You will use the profiler APIs to limit the amount of data that is collected during instrumentation profiling.  
 ...
 However, a greater level of detail means that more data is collected. You might find that instrumentation profiling creates large data files. Also, instrumentation is more likely to impact the performance of the application. For more information, see [Understanding Instrumentation Data Values](../VS_IDE/Understanding-Instrumentation-Data-Values.md) and [Understanding Sampling Data Values](../VS_IDE/Understanding-Sampling-Data-Values.md)  
