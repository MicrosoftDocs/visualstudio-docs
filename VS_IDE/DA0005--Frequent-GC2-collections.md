...
## How to Investigate a Warning  
 Review the [.NET Memory Data Views](../VS_IDE/.NET-Memory-Data-Views.md) reports to understand the application’s pattern of memory allocation. Use the [Object Lifetime View](../VS_IDE/Object-Lifetime-View.md) to determine which of the program’s data objects are surviving into generation 2 and then being reclaimed from there. Use the [Allocations View](../VS_IDE/.NET-Memory-Allocations-View.md) to determine the execution path that resulted in these allocations.  
