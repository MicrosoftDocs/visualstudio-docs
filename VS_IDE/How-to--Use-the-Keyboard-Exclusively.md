...
Visual Studio provides many default shortcut key combinations to make it easy to navigate and code within the integrated development environment (IDE). For a full listing of shortcut keys used in Visual Studio, see [Default Keyboard Shortcuts](../VS_IDE/Default-Keyboard-Shortcuts-in-Visual-Studio.md). For information on keyboard shortcuts available for other Microsoft products, see [http://www.microsoft.com/enable/products/keyboard.aspx](http://go.microsoft.com/fwlink/?LinkID=40400).  
...
## See Also  
 [Identifying and Customizing Keyboard Shortcuts](../VS_IDE/Identifying-and-Customizing-Keyboard-Shortcuts-in-Visual-Studio.md)   
