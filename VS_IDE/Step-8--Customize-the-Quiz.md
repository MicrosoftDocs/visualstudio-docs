...
-   To go to the next tutorial, see [Tutorial 3: Create a Matching Game](../VS_IDE/Tutorial-3--Create-a-Matching-Game.md).  
  
-   To return to the previous tutorial step, see [Step 7: Add Multiplication and Division Problems](../VS_IDE/Step-7--Add-Multiplication-and-Division-Problems.md).