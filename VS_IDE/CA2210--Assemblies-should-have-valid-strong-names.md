...
-   For the .NET Framework v1.0 or v1.1, use either the <xref:System.Reflection.AssemblyKeyFileAttribute?qualifyHint=True> or <xref:System.Reflection.AssemblyKeyNameAttribute?qualifyHint=True> attribute.  
...
-   Use the strong name tool (Sn.exe) that is provided by the .NET Framework SDK. For more information, see [Sn.exe (Strong Name Tool)](../Topic/Sn.exe%20\(Strong%20Name%20Tool\).md).  
...
## See Also  
 <xref:System.Reflection.AssemblyKeyFileAttribute?qualifyHint=True>   
 <xref:System.Reflection.AssemblyKeyNameAttribute?qualifyHint=True>   
