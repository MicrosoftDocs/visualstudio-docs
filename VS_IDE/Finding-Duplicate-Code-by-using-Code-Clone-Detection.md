 ...
 **Visual Studio Enterprise** can help you find code clones so that you can refactor them.  
 ...
 ![Code clone analysis result with strong matches](../VS_IDE/media/CodeClone1.png "CodeClone1")  
...
-   Code generated from T4 templates.  
     ...
     For more information about T4, see [Code Generation and T4 Text Templates](../VS_IDE/Code-Generation-and-T4-Text-Templates.md).  
