...
XML and its related technologies play a large role in the way data is handled in Windows Server 2008 Visual Studio. Visual Studio includes tools and features that make it easier to work with XML, XSLT, and XML schemas.  
