...
||||  
|-|-|-|  
|[Assembly Element](../VS_IDE/Code-Snippets-Schema-Reference.md#assembly)|[HelpUrl Element](../VS_IDE/Code-Snippets-Schema-Reference.md#helpurl)|[References Element](../VS_IDE/Code-Snippets-Schema-Reference.md#references)|  
|[Author Element](../VS_IDE/Code-Snippets-Schema-Reference.md#author)|[ID Element](../VS_IDE/Code-Snippets-Schema-Reference.md#id)|[Shortcut Element](../VS_IDE/Code-Snippets-Schema-Reference.md#shortcut)|  
|[Code Element](../VS_IDE/Code-Snippets-Schema-Reference.md#code)|[Import Element](../VS_IDE/Code-Snippets-Schema-Reference.md#import)|[Snippet Element](../VS_IDE/Code-Snippets-Schema-Reference.md#snippet)|  
|[CodeSnippet Element](../VS_IDE/Code-Snippets-Schema-Reference.md#codesnippet)|[Imports Element](../VS_IDE/Code-Snippets-Schema-Reference.md#imports)|[SnippetType Element](../VS_IDE/Code-Snippets-Schema-Reference.md#snippettype)|  
|[CodeSnippets Element](../VS_IDE/Code-Snippets-Schema-Reference.md#codesnippets)|[Keyword Element](../VS_IDE/Code-Snippets-Schema-Reference.md#keyword)|[SnippetTypes Element](../VS_IDE/Code-Snippets-Schema-Reference.md#snippettypes)|  
|[Declarations Element](../VS_IDE/Code-Snippets-Schema-Reference.md#declarations)|[Keywords Element](../VS_IDE/Code-Snippets-Schema-Reference.md#keywords)|[Title Element](../VS_IDE/Code-Snippets-Schema-Reference.md#title)|  
|[Default Element](../VS_IDE/Code-Snippets-Schema-Reference.md#default)|[Literal Element](../VS_IDE/Code-Snippets-Schema-Reference.md#literal)|[ToolTip Element](../VS_IDE/Code-Snippets-Schema-Reference.md#tooltip)|  
|[Description Element](../VS_IDE/Code-Snippets-Schema-Reference.md#description)|[Namespace Element](../VS_IDE/Code-Snippets-Schema-Reference.md#namespace)|[Type Element](../VS_IDE/Code-Snippets-Schema-Reference.md#type)|  
|[Function Element](../VS_IDE/Code-Snippets-Schema-Reference.md#function)|[Object Element](../VS_IDE/Code-Snippets-Schema-Reference.md#object)|[Url Element](../VS_IDE/Code-Snippets-Schema-Reference.md#url)|  
|[Header Element](../VS_IDE/Code-Snippets-Schema-Reference.md#header)|[Reference Element](../VS_IDE/Code-Snippets-Schema-Reference.md#reference)||  
...
|--------------------|-----------------|  
|[Reference Element](../VS_IDE/Code-Snippets-Schema-Reference.md#reference)|Contains information about assembly references required by the code snippet.|  
...
|Parent Element|Description|  
|--------------------|-----------------|  
|[Header Element](../VS_IDE/Code-Snippets-Schema-Reference.md#header)|Contains general information about the code snippet.|  
...
|Parent Element|Description|  
|--------------------|-----------------|  
|[Snippet Element](../VS_IDE/Code-Snippets-Schema-Reference.md#snippet)|Contains the references, imports, declarations, and code for the code snippet.|  
...
|-------------------|-----------------|  
|[Header Element](../VS_IDE/Code-Snippets-Schema-Reference.md#header)|Required element. Contains general information about the code snippet. There must be exactly one `Header` element in a code snippet.|  
|[Snippet Element](../VS_IDE/Code-Snippets-Schema-Reference.md#snippet)|Required element. Contains the code that will be inserted by Visual Studio. There must be exactly one `Snippet` element in a code snippet.|  
  
|Parent Element|Description|  
|--------------------|-----------------|  
|[CodeSnippets Element](../VS_IDE/Code-Snippets-Schema-Reference.md#codesnippets)|Root element of the code snippet XML schema.|  
  
##  <a name="codesnippets"></a> CodeSnippets Element  
 Groups [CodeSnippet Element](../VS_IDE/Code-Snippets-Schema-Reference.md#codesnippet)elements. The `CodeSnippets` element is the root element of the code snippet XML schema.  
...
|Child Element|Description|  
|-------------------|-----------------|  
|[CodeSnippet Element](../VS_IDE/Code-Snippets-Schema-Reference.md#codesnippet)|Optional element. Parent element for all code snippet data. There may be zero or more `CodeSnippet` elements in a `CodeSnippets` element.|  
...
|Child Element|Description|  
|-------------------|-----------------|  
|[Literal Element](../VS_IDE/Code-Snippets-Schema-Reference.md#literal)|Optional element. Defines the literals of the code snippet that you can edit. There may be zero or more `Literal` elements in a `Declarations` element.|  
|[Object Element](../VS_IDE/Code-Snippets-Schema-Reference.md#object)|Optional element. Defines the objects of the code snippet that you can edit. There may be zero or more `Object` elements in a `Declarations` element.|  
...
|Parent Element|Description|  
|--------------------|-----------------|  
|[Literal Element](../VS_IDE/Code-Snippets-Schema-Reference.md#literal)|Defines the literal fields of the code snippet that you can edit.|  
|[Object Element](../VS_IDE/Code-Snippets-Schema-Reference.md#object)|Defines the object fields of the code snippet that you can edit.|  
...
|Child Element|Description|  
|-------------------|-----------------|  
|[Author Element](../VS_IDE/Code-Snippets-Schema-Reference.md#author)|Optional element. The name of the person or company that authored the code snippet. There may be zero or one `Author` elements in a `Header` element.|  
|[Description Element](../VS_IDE/Code-Snippets-Schema-Reference.md#description)|Optional element. A description of the code snippet. There may be zero or one `Description` elements in a `Header` element.|  
|[HelpUrl Element](../VS_IDE/Code-Snippets-Schema-Reference.md#helpurl)|Optional element. A URL that contains more information about the code snippet. There may be zero or one `HelpURL` elements in a Header element. **Note:**  Visual Studio does not use the `HelpUrl` element. The element is part of the IntelliSense Code Snippet XML schema and any code snippet containing the element will validate, but the value of the element is never used.|  
|[Keywords Element](../VS_IDE/Code-Snippets-Schema-Reference.md#keywords)|Optional element. Groups `Keyword` elements. There may be zero or one `Keywords` elements in a `Header` element.|  
|[Shortcut Element](../VS_IDE/Code-Snippets-Schema-Reference.md#shortcut)|Optional element. Specifies the shortcut text that can be used to insert the snippet. There may be zero or one `Shortcut` elements in a `Header` element.|  
|[SnippetTypes Element](../VS_IDE/Code-Snippets-Schema-Reference.md#snippettypes)|Optional element. Groups `SnippetType` elements. There may be zero or one `SnippetTypes` elements in a `Header` element. If there are no `SnippetTypes` elements, the code snippet is always valid.|  
|[Title Element](../VS_IDE/Code-Snippets-Schema-Reference.md#title)|Required element. The friendly name of the code snippet. There must be exactly one `Title` element in a `Header` element.|  
  
|Parent Element|Description|  
|--------------------|-----------------|  
|[CodeSnippet Element](../VS_IDE/Code-Snippets-Schema-Reference.md#codesnippet)|Parent element for all code snippet data.|  
...
|Child Element|Description|  
|-------------------|-----------------|  
|[Namespace Element](../VS_IDE/Code-Snippets-Schema-Reference.md#namespace)|Required element. Specifies the namespace used by the code snippet. There must be exactly one `Namespace` element in an `Import` element.|  
  
|Parent Element|Description|  
|--------------------|-----------------|  
|[Imports Element](../VS_IDE/Code-Snippets-Schema-Reference.md#imports)|Grouping element for **Import** elements.|  
...
|Child Element|Description|  
|-------------------|-----------------|  
|[Import Element](../VS_IDE/Code-Snippets-Schema-Reference.md#import)|Optional element. Contains the imported namespaces for the code snippet. There may be zero or more **Import** elements in an `Imports` element.|  
...
|Parent Element|Description|  
|--------------------|-----------------|  
|[Keywords Element](../VS_IDE/Code-Snippets-Schema-Reference.md#keywords)|Groups individual `Keyword` elements.|  
...
|Child Element|Description|  
|-------------------|-----------------|  
|[Keyword Element](../VS_IDE/Code-Snippets-Schema-Reference.md#keyword)|Optional element. Contains individual keywords for the code snippet. There may be zero or more `Keyword` elements in a `Keywords` element.|  
...
|Child Element|Description|  
|-------------------|-----------------|  
|[Default Element](../VS_IDE/Code-Snippets-Schema-Reference.md#default)|Required element. Specifies the literal's default value when you insert the code snippet. There must be exactly one `Default` element in a `Literal` element.|  
|[Function Element](../VS_IDE/Code-Snippets-Schema-Reference.md#function)|Optional element. Specifies a function to execute when the literal receives focus in Visual Studio. There may be zero or one `Function` elements in a `Literal` element.|  
|[ID Element](../VS_IDE/Code-Snippets-Schema-Reference.md#id)|Required element. Specifies a unique identifier for the literal. There must be exactly one `ID` element in a `Literal` element.|  
|[ToolTip Element](../VS_IDE/Code-Snippets-Schema-Reference.md#tooltip)|Optional element. Describes the expected value and usage of the literal. There may be zero or one **Tooltip** elements in a `Literal` element.|  
  
|Parent Element|Description|  
|--------------------|-----------------|  
|[Declarations Element](../VS_IDE/Code-Snippets-Schema-Reference.md#declarations)|Contains the literals and objects of a code snippet that you can edit.|  
...
|Parent Element|Description|  
|--------------------|-----------------|  
|[Import Element](../VS_IDE/Code-Snippets-Schema-Reference.md#import)|Imports the specified namespace.|  
...
|[ID Element](../VS_IDE/Code-Snippets-Schema-Reference.md#id)|Required element. Specifies a unique identifier for the literal. There must be exactly one `ID` element in a `Literal` element.|  
|[ToolTip Element](../VS_IDE/Code-Snippets-Schema-Reference.md#tooltip)|Optional element. Describes the expected value and usage of the literal. There may be zero or one **Tooltip** elements in a `Literal` element.|  
|[Type Element](../VS_IDE/Code-Snippets-Schema-Reference.md#type)|Required element. Specifies the type of the object. There must be exactly one `Type` element in an `Object` element.|  
...
|Child Element|Description|  
|-------------------|-----------------|  
|[Assembly Element](../VS_IDE/Code-Snippets-Schema-Reference.md#assembly)|Required element. Contains the name of the assembly referenced by the code snippet. There must be exactly one `Assembly` element in a `Reference` element.|  
|[Url Element](../VS_IDE/Code-Snippets-Schema-Reference.md#url)|Optional element. Contains a URL that provides more information about the referenced assembly. There may be zero or one `Url` elements in a `Reference` element.|  
  
|Parent Element|Description|  
|--------------------|-----------------|  
|[References Element](../VS_IDE/Code-Snippets-Schema-Reference.md#references)|Grouping element for `Reference` elements.|  
...
|Child Element|Description|  
|-------------------|-----------------|  
|[Reference Element](../VS_IDE/Code-Snippets-Schema-Reference.md#reference)|Optional element. Contains information about assembly references for the code snippet. There may be zero or more `Reference` elements in a `References` element.|  
...
|Child Element|Description|  
|-------------------|-----------------|  
|[Code Element](../VS_IDE/Code-Snippets-Schema-Reference.md#code)|Required element. Specifies the code that you want to insert into a documentation file. There must be exactly one `Code` element in a `Snippet` element.|  
|[Declarations Element](../VS_IDE/Code-Snippets-Schema-Reference.md#declarations)|Optional element. Specifies the literals and objects that make up the parts of a code snippet that you can edit. There may be zero or one `Declarations` elements in a `Snippet` element.|  
|[Imports Element](../VS_IDE/Code-Snippets-Schema-Reference.md#imports)|Optional element. Groups individual `Import` elements. There may be zero or one `Imports` elements in a `Snippet` element.|  
||Optional element. Groups individual `Reference` elements. There may be zero or one `References` elements in a `Snippet` element.|  
  
|Parent Element|Description|  
|--------------------|-----------------|  
|[CodeSnippet Element](../VS_IDE/Code-Snippets-Schema-Reference.md#codesnippet)|Allows you to specify a heading and multiple IntelliSense Code Snippets, which you can insert into Visual Studio code files.|  
...
|Parent Element|Description|  
|--------------------|-----------------|  
|[SnippetTypes Element](../VS_IDE/Code-Snippets-Schema-Reference.md#snippettypes)|Groups `SnippetType` elements.|  
...
|Child Element|Description|  
|-------------------|-----------------|  
|[SnippetType Element](../VS_IDE/Code-Snippets-Schema-Reference.md#snippettype)|Optional element. Specifies how Visual Studio inserts the code snippet into the code. There may be zero or more `SnippetType` elements in a `SnippetTypes` element.|  
  
|Parent Element|Description|  
|--------------------|-----------------|  
|[Header Element](../VS_IDE/Code-Snippets-Schema-Reference.md#header)|Specifies general information about the code snippet.|  
...
|Parent Element|Description|  
|--------------------|-----------------|  
|[Reference Element](../VS_IDE/Code-Snippets-Schema-Reference.md#reference)|Specifies the assembly references required by the code snippet.|  
