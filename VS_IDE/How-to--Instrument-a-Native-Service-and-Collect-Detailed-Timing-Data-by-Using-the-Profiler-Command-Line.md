...
## Ending the Profiling Session  
 To end a profiling session, stop the service that is running the instrumented component, and then call the **VSPerfCmd**[/shutdown](../VS_IDE/Shutdown.md) option to turn the profiler off and close the profiling data file.  
