...
## Why should I do this?  
 ...
 ![UI Test Edito](../VS_IDE/media/UITestEditor.png "UITestEditor")  
  
1.  [Find](../VS_IDE/Finding-and-Replacing-Text.md) helps you locate UI actions and controls.  
...
## Open a coded UI test  
 ...
 ![Context menu Edit With Coded UI Test Builder](../VS_IDE/media/EditCodedUITest.png "EditCodedUITest")  
...
##  <a name="CodedUITestEditor_EditActionAndControlProperties"></a> Modify UI action properties and their corresponding control properties  
 ...
 ![UI action properties](../VS_IDE/media/CodedUIEditUIAction.png "CodedUIEditUIAction")  
Edit UI action properties  
 ...
 ![Control properties](../VS_IDE/media/CodedUITestControlProp.png "CodedUITestControlProp")  
...
##  <a name="CodedUITestEditor_DeleteUIActions"></a> Delete unwanted UI actions  
 ...
 ![Delete UI action](../VS_IDE/media/CodedUIDeleteUIAction.png "CodedUIDeleteUIAction")  
...
##  <a name="CodedUITestEditor_SplitMethods"></a> Split a test method into two separate methods  
 ...
 ![Splt a test method](../VS_IDE/media/CodedUITestSplitMethod1.png "CodedUITestSplitMethod1")  
  
 ![Two test methods](../VS_IDE/media/CodedUITestSplitMethod2.png "CodedUITestSplitMethod2")  
...
-   ![Tip](../dv_TeamTestALM/media/Tip.png "Tip") To undo the split, choose **Undo** from the **Edit** menu, or press Ctrl+Z.  
  
-   ![Tip](../dv_TeamTestALM/media/Tip.png "Tip") You can rename the new method. Select it in the UI Actions pane and choose the **Rename** button in the Coded UI Test Editor toolbar.  
...
-   ![Tip](../dv_TeamTestALM/media/Tip.png "Tip") To undo the move, select **Undo** from the **Edit** menu, or press Ctrl+Z. However, you must then manually remove the code from the UIMap.cs or UIMap.vb file.  
...
##  <a name="CodedUITestEditor_LocateUIControl"></a> Locating a UI Control in the application under test  
 ...
 ![Locate UI control](../VS_IDE/media/CodedUILocateControl.png "CodedUILocateControl")  
  
 ![Control located in application under test](../VS_IDE/media/CodedUILocateControl2.png "CodedUILocateControl2")  
...
-   ![Tip](../dv_TeamTestALM/media/Tip.png "Tip") Alternatively, you can use the **Locate All** option to verify that all the controls under a container can be correctly located. This option is described in the next section.  
...
##  <a name="CodedUITestEditor_LocateDecendants"></a> Locating a control and its descendants  
 ...
 ![Locate all descendant controls](../VS_IDE/media/CodedUILocateAll.png "CodedUILocateAll")  
  
 ![All controls located](../VS_IDE/media/CodedUILocateAll2.png "CodedUILocateAll2")  
...
##  <a name="CodedUITestEditor_InsertDelay"></a> Inserting a delay before a UI action  
 ...
 ![Insert delay before a UI action](../VS_IDE/media/CodedUIDelay.png "CodedUIDelay")  
  
 ![Delay added with 5 seconds](../VS_IDE/media/CodedUIDealy2.png "CodedUIDealy2")  
