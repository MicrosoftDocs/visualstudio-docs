...
1.  On the **Manage Content** tab, choose the **Disk** option button.  
    ...
    > [!NOTE]
    >  The **Disk** option won't be available if your administrator has prevented you from modifying the content installation source. For more information, see the [Help Viewer Administrator Guide](../VS_IDE/Help-Viewer-Administrator-Guide.md).  
