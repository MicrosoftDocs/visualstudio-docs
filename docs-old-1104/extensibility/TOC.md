...
# [Visual Studio User Experience Guidelines](~/extensibility/ux-guidelines)
...
# [Inside the Visual Studio SDK](~/extensibility/internals)
...
# [Visual Studio SDK Reference](~/extensibility/reference)
