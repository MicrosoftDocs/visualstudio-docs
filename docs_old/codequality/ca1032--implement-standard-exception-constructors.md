...
## Example  
 ...
 [!code[FxCop.Design.ExceptionMultipleCtors#1](../codequality/codesnippet/CSharp/ca1032--implement-standard-exception-constructors_1.cs)]