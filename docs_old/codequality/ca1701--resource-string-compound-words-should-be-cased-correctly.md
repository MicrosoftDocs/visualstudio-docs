...
## When to Suppress Warnings  
 ...
 You can also add compound words to a custom dictionary for the spelling checker. Words in the custom dictionary do not cause violations. For more information, see [How to: Customize the Code Analysis Dictionary](../codequality/how-to--customize-the-code-analysis-dictionary.md).  
