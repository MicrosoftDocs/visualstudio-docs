...
The rule '*RuleId*' referenced in rule set '*RuleSetName*' could not be found.  
 ...
 This error usually occurs because a ruleset file was edited by hand. To avoid this error, use the [!INCLUDE[vsprvs](../codequality/includes/vsprvs_md.md)] rule set editor to specify rules. For more information, see [Creating Custom Rule Sets](../codequality/creating-custom-code-analysis-rule-sets.md).  
