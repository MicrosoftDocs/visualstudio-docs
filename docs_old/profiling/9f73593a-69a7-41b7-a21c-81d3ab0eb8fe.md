...
This topic describes how to use [!INCLUDE[vsPreShort](../codequality/includes/vspreshort_md.md)] Profiling Tools command-line tools to instrument a [!INCLUDE[dnprdnshort](../codequality/includes/dnprdnshort_md.md)] service and collect detailed timing data.  
...
4.  Initialize the [!INCLUDE[dnprdnshort](../codequality/includes/dnprdnshort_md.md)] profiling environment variables. Type:  
