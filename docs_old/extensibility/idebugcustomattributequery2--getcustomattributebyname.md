...
## Remarks  
 ...
 If the `ppBlob` and `pdwLen` parameters are set to a null value, this method can be used to determine if the custom attribute merely exists. An easier alternative, however, is to call the [IsCustomAttributeDefined](../extensibility/idebugcustomattributequery2--iscustomattributedefined.md) method.  
  
## See Also  
 [IDebugCustomAttributeQuery2](../extensibility/idebugcustomattributequery2.md)   
 [IsCustomAttributeDefined](../extensibility/idebugcustomattributequery2--iscustomattributedefined.md)