...
>  Binding is case-insensitive.  
 ...
 ![Multiple Configurations](../extensibility/media/vsmultiplecfgs.gif "vsMultipleCfgs")  
Multiple configurations  
 ...
 See [Solution Configuration](../extensibility/solution-configuration.md) for information relating to adding and renaming configurations for solutions and projects.  
 ...
 ![Project Dependencies](../extensibility/media/vsprojdependencies.gif "vsProjDependencies")  
