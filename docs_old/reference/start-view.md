...
The Start View is the launching point for the XML Schema (XSD) Designer. When you create a new XSD file, you will initially see the Start View.  
 ...
 ![XML Schema Designer Start View](../reference/media/xsddesigner_startview.gif "XSDDesigner_StartView")  
...
## Toolbar  
 You can navigate between the Start View, the [Content Model View](../reference/content-model-view.md) and the [Graph View](../reference/graph-view.md) from the XML Schema Designer toolbar.  
  
 ![XML Schema Designer Toolbar](../reference/media/xsdstartviewtoolbar.gif "XSDStartViewToolbar")  
