...
1. Download the [VS Connected Environment extension](https://aka.ms/get-vsce-code). (If your browser saves the extension as a .zip file, change the file extension to .vsix.)
