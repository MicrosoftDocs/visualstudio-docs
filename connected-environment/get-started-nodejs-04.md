...
In this configuration, the container is configured to start *nodemon* - now, when server code edits are made, *nodemon* automatically restarts the Node process, just like it does when you develop locally. 
1. Edit the hello message again in `server.js`, and save the file.
1. Just refresh the browser, or click the *Say It Again* button, to see your changes take effect!
