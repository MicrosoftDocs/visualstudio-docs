...
-   Intra-continental WAN 1.5 Mbps  
 ...
 For more information, see [About the Mix Control](../dv_TeamTestALM/Specifying-Virtual-Network-Types-in-a-Load-Test-Scenario.md#SpecifyingVirtualNetworkTypesAboutMixControl).  
...
-   [True Network Emulation](../dv_TeamTestALM/Specifying-Virtual-Network-Types-in-a-Load-Test-Scenario.md#SpecifyingVirtualNetworkTypesLoadTestScenarios_TrueNetworkEmulation)  
  
-   [Adding New Networks to a Scenario](../dv_TeamTestALM/Specifying-Virtual-Network-Types-in-a-Load-Test-Scenario.md#SpecifyingVirtualNetworkTypesAddingNetworks)  
  
-   [Removing Networks from a Scenario](../dv_TeamTestALM/Specifying-Virtual-Network-Types-in-a-Load-Test-Scenario.md#SpecifyingVirtualNetworkTypesRemovingNetworks)  
  
-   [About the Mix Control](../dv_TeamTestALM/Specifying-Virtual-Network-Types-in-a-Load-Test-Scenario.md#SpecifyingVirtualNetworkTypesAboutMixControl)  
...
3.  (Optional) Adjust the mix control to specify the test distribution. For more information, see [About the Mix Control](../dv_TeamTestALM/Specifying-Virtual-Network-Types-in-a-Load-Test-Scenario.md#SpecifyingVirtualNetworkTypesAboutMixControl).  
...
4.  (Optional) Adjust the mix control to specify the test distribution. For more information, see [About the Mix Control](../dv_TeamTestALM/Specifying-Virtual-Network-Types-in-a-Load-Test-Scenario.md#SpecifyingVirtualNetworkTypesAboutMixControl).  
...
## See Also  
 ...
 [Troubleshooting Network Emulation in Load Tests](../Topic/Troubleshooting%20Network%20Emulation%20in%20Load%20Tests.md)   
 [Step 2.4 - Specifying Network Mix in the New Load Test Wizard](../Topic/Creating%20load%20tests.md#CreatingLoadTestsUsingWizardStep2_4)