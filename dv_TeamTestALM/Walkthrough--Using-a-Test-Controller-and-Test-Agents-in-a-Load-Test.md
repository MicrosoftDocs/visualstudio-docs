...
## Install a Test Controller  
 To install a test controller, you must be a member of the **Administrators** security group on the machines. For more information about installing test controllers, see [Install and configure test agents](../dv_TeamTestALM/Install-and-configure-test-agents.md).  
...
10. Type your SQL Server instance in **Create load test results database in the following SQL Server instance**.  
    ...
    > [!NOTE]
    >  If you do not have SQL Server installed, you can use SQL Express included with Visual Studio. See [How to: Create a Load Test Results Repository Using SQL](../dv_TeamTestALM/How-to--Create-a-Load-Test-Results-Repository-Using-SQL.md). For more information about sizing considerations, see [Using Test Controllers and Test Agents with Load Tests](../dv_TeamTestALM/Using-Test-Controllers-and-Test-Agents-with-Load-Tests.md).  
...
>   
>  For more information about installing test agents, see [Install and configure test agents](../dv_TeamTestALM/Install-and-configure-test-agents.md).  
...
15. Under **Data and Diagnostic for select role**, select the **IntelliTrace** and **System Information** adapters.  
     ...
     For information about these adapters and other adapters you can use in a distributed load test, see [How to: Create a Test Setting for a Distributed Load Test](../dv_TeamTestALM/How-to--Create-a-Test-Setting-for-a-Distributed-Load-Test.md).  
