...
For more information about using the command-line arguments dropdown, see [Pass command line arguments when debugging](/visualstudio/debugger/getting-started-with-the-debugger-cpp.md#pass-command-line-arguments-when-debugging).
