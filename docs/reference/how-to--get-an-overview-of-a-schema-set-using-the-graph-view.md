...
This topic describes how to use the [Graph View](../reference/graph-view.md) to see a high-level view of the nodes in a schema set and the relationships between the nodes.  
...
3.  Copy the XML Schema sample code from [Sample XML Schema: Relationships](../reference/sample-xsd-file--relationships.md) and paste it to replace the code that was added to the new XSD file by default.  
...
6.  Select **Schema Set** node in the XML Schema Explorer and drag the node to design suface of the Graph View. You should see all the global nodes, and arrows connecting the nodes that have relationships.  
     ...
     ![Graph View](../reference/media/relationshipingraphview.gif "RelationshipInGraphView")  
