...
## Remarks  
 ...
 For information about how to use the `GenerateDeploymentManifest` task, see [GenerateApplicationManifest Task](../reference/generateapplicationmanifest-task.md).  
