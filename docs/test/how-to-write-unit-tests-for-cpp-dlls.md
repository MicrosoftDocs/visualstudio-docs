...
This walkthrough describes how to develop a native C++ DLL using test-first methodology. The principal steps are as follows:  
  
1.  [Create a Native Test Project](#unitTestProject). The test project is located in the same solution as the DLL project.  
...
1.  On the **File** menu, choose **New | Project**.  
     ...
     Choose the **Native Unit Test Project** template. 
> [!NOTE] 
> You can also use **Google Test** if you have that installed, or any other supported test framework. The basic principles are the same although some details will differ from what is described in the following steps.
