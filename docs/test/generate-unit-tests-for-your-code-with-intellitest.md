...
description: Review how IntelliTest explores your .NET code to generate smart fuzz tests for all logic branches and use the tool to identify and fix failing tests.
ms.date: 04/21/2023
ms.topic: conceptual
f1_keywords:
