...
If you are interested in reading more on how the *.testsettings* options convert to *runsettings* you can find more implementation details in the [open source test platform repository](https://github.com/microsoft/vstest-docs/blob/master/RFCs/0023-TestSettings-Deprecation.md#roadmap) on GitHub.
