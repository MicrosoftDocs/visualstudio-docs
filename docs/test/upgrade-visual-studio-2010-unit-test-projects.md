...
> [!NOTE]
>  You can run the new unit tests using vstest.console.exe from the command line. For more information about using vstest.console.exe, see [VSTest.Console.exe command-line options](../Topic/VSTest.Console.exe%20command-line%20options.md), or run the command by using the help switch: **vstest.console.exe /?**. You can continue to run your existing unit tests using MStest.exe. For more information, see [Run automated tests from the command line using MSTest](../Topic/Run%20automated%20tests%20from%20the%20command%20line%20using%20MSTest.md) and [MSTest.exe command-line options](../Topic/MSTest.exe%20command-line%20options.md).  
