...
When you build the test project, the tests appear in Test Explorer. If Test Explorer is not visible, choose **Test** on the Visual Studio menu, choose **Test**, and then choose **Test Explorer** (or press **Ctrl** + **E**, **T**).
