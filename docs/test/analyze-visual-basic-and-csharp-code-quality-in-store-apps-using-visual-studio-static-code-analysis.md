---
title: "Analyze Visual Basic and C# code quality in UWP apps using Visual Studio static code analysis | Microsoft Docs"
ms.custom: ""
ms.date: "11/04/2016"
ms.reviewer: ""
ms.suite: ""
...
manager: "douge"
---
# Analyze Visual Basic and C# code quality in UWP apps using Visual Studio static code analysis
...
2.  In the project property page, choose **Code Analysis** and then choose **Enable Code Analysis on Build (defines CODEANALYSIS constant)**.  
 ...
 ![Code Analysis window](../test/media/ca_managed_collapsed.png "CA_Managed_Collapsed")  
...
##  <a name="BKMK_Analyze"></a> Analyzing and resolving code analysis warnings  
 ...
 ![Expanded code analysis warning](../test/media/ca_managed_callouts.png "CA_Managed_Callouts")  
  
 When you expand a warning, the line of code that caused the warning is highlighted in the Visual Studio code editor.  
  
 ![Code analysis text highlighting](../test/media/ca_managed_sourceline.png "CA_Managed_SourceLine")  
