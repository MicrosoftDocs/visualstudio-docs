...
|**Set quality gates:** You can create quality gates to enforce that tests are run before code is checked in, to help ensure the quality of the code.|-   [Check-in policies (Azure Test Plans)](/vsts/tfvc/add-check-policies)|
