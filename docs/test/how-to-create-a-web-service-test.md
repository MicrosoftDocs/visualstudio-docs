...
description: Learn how to use a web performance test to test web services and can customize requests in the Web Performance Test Editor to locate web service pages.
