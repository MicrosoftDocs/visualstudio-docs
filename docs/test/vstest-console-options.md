...
> [!NOTE]
> The TfsPublisher logger is deprecated in Visual Studio 2017 and is not supported in later versions of Visual Studio. This logger switches the logger to legacy mode.|
