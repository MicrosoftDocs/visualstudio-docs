---
title: "Unit testing a Visual C++ DLL for UWP apps | Microsoft Docs"
ms.custom: ""
ms.date: "11/04/2016"
ms.reviewer: ""
ms.suite: ""
...
manager: "douge"
---
# Unit testing a Visual C++ DLL for UWP apps
...
2.  On the New Project dialog, expand **Installed**, then expand **Visual C++** and choose **Windows Universal**. Then choose **Unit Test Library (Universal Windows)** from the list of project templates.  
