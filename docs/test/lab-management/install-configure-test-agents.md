...
| --- | --- |
| Build-Deploy-Test workflow in Visual Studio | Users can use a [build definition](/azure/devops/build-release/) (not a XAML build) for build, deploy, and test scenarios in TFS. |
