...
You can perform automated testing and build-deploy-test automation using the [Build and Release](/azure/devops/pipelines/index) features in Team Foundation Server (TFS) and Azure Test Plans. Some of the benefits are:
