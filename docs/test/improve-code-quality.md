...
|[Unit Test with Live Unit Testing](../test/live-unit-testing.md)|Visual Studio 2017 Enterprise Edition includes Live Unit Testing, which automatically runs unit tests in the background and displays the results in real time in the Visual Studio code editor window.|  
