...
* [Continuous testing (Azure Test Plans)](/vsts/build-release/test/index)
* [DevOps overview for Team Services and TFS (Azure Test Plans)](/vsts/user-guide/devops-alm-overview)
