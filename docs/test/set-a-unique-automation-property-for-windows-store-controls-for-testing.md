...
description: Learn how to assign a unique automation property based on the type of XAML control in your XAML-based UWP application to run coded UI test.
