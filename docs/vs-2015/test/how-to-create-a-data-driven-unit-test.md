...
The latest version of this topic can be found at [How To: Create a Data-Driven Unit Test](https://docs.microsoft.com/visualstudio/test/how-to-create-a-data-driven-unit-test).  
