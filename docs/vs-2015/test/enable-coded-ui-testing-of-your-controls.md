...
The latest version of this topic can be found at [Enable Coded UI Testing of Your Controls](https://docs.microsoft.com/visualstudio/test/enable-coded-ui-testing-of-your-controls).  
