...
### [How to: Target an Earlier Version of .NET](how-to-configure-unit-tests-to-target-an-earlier-version-of-the-dotnet-framework.md)
...
### [Adding unit tests to existing C++ applications](unit-testing-existing-cpp-applications-with-test-explorer.md)
...
## [Using emulators to isolate Sharepoint 2010 unit tests](using-emulators-to-isolate-unit-tests-for-sharepoint-2010-applications.md)
...
#### [ExtensionPackage Class](sample-excel-extension-extensionpackage-class.md)
#### [TechnologyManager Class](sample-excel-extension-technologymanager-class.md)
#### [PropertyProvider Class](sample-excel-extension-propertyprovider-class.md)
#### [Element Classes](sample-excel-extension-element-classes.md)
#### [ActionFilter Class](sample-excel-extension-actionfilter-class.md)
...
## [Create and run unit tests](create-and-run-unit-tests-for-a-store-app-in-visual-studio.md)
### [Unit testing a C++ DLL](unit-testing-a-visual-cpp-dll-for-store-apps.md)
### [Unit test C# code](unit-testing-visual-csharp-code-in-a-store-app.md)
