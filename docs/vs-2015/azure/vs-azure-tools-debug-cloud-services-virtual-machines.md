...
3. Select the various settings for the virtual machine and then select **OK**. See [Virtual Machines](/previous-versions/azure/jj156003(v=azure.100)) for more information.
