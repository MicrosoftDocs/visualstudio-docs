...
To learn more about how to use Azure storage services, see [Introduction to Azure Storage](https://docs.microsoft.com/azure/storage/common/storage-introduction).
