...
- To install the SDK, use the [Python Package Index](https://pypi.python.org/pypi/azure) or follow [Install Python and the SDK](/azure/python/python-sdk-azure-install) in the Azure documentation. 
