...
The latest version of this topic can be found at [Inspect Variables in the Debugger in Visual Studio](https://docs.microsoft.com/visualstudio/debugger/autos-and-locals-windows).  
