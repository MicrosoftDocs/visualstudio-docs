...
The latest version of this topic can be found at [Error: RPC Requires Authentication](https://docs.microsoft.com/visualstudio/debugger/error-rpc-requires-authentication).  
