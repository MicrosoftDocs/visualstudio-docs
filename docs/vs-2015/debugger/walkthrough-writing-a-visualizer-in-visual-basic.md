...
The latest version of this topic can be found at [Walkthrough: Writing a Visualizer in Visual Basic](https://docs.microsoft.com/visualstudio/debugger/walkthrough-writing-a-visualizer-in-visual-basic).  
