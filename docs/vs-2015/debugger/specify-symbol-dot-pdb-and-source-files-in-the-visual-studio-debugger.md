...
The latest version of this topic can be found at [Specify symbol (.pdb) and source files in the debugger](https://docs.microsoft.com/visualstudio/debugger/specify-symbol-dot-pdb-and-source-files-in-the-visual-studio-debugger).  
 ...
 **C++ options**  
 ...
 In [!INCLUDE[vcprvc](../includes/vcprvc-md.md)], the [/Fd](../Topic/-Fd%20\(Program%20Database%20File%20Name\).md) option names the .pdb file created by the compiler. When you create a project in [!INCLUDE[vsprvs](../includes/vsprvs-md.md)] using wizards, the **/Fd** option is set to create a .pdb file named *project*.pdb.  
