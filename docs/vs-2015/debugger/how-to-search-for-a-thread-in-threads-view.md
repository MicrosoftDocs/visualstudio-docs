...
The latest version of this topic can be found at [How to: Search for a Thread in Threads View](https://docs.microsoft.com/visualstudio/debugger/how-to-search-for-a-thread-in-threads-view).  
