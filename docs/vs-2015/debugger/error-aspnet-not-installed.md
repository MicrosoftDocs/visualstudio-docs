...
The latest version of this topic can be found at [Error: ASP.NET Not Installed](https://docs.microsoft.com/visualstudio/debugger/error-aspnet-not-installed).  
