...
3. Choose **Debug** > **Start Debugging**, or press F5.  
     ...
     ![Using break mode with the JavaScript Console](../debugger/media/js-breakmode.png "JS_BreakMode")  
