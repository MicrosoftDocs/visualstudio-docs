...
The latest version of this topic can be found at [Debugging Preparation: Windows Services](https://docs.microsoft.com/visualstudio/debugger/debugging-preparation-windows-services).  
