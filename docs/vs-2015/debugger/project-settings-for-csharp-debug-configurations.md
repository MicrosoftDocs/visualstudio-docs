...
The latest version of this topic can be found at [Project Settings for  C# Debug Configurations](https://docs.microsoft.com/visualstudio/debugger/project-settings-for-csharp-debug-configurations).  
