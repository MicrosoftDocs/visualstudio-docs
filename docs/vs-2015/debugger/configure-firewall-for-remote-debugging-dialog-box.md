...
The latest version of this topic can be found at [Configure Firewall for Remote Debugging Dialog Box](https://docs.microsoft.com/visualstudio/debugger/configure-firewall-for-remote-debugging-dialog-box).  
