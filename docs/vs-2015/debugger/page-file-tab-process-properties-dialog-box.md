...
The latest version of this topic can be found at [Page File Tab, Process Properties Dialog Box](https://docs.microsoft.com/visualstudio/debugger/page-file-tab-process-properties-dialog-box).  
