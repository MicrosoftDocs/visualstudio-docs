...
The latest version of this topic can be found at [How to: Get Back to the Function that Called MFC If Halted](https://docs.microsoft.com/visualstudio/debugger/how-to-get-back-to-the-function-that-called-mfc-if-halted).  
