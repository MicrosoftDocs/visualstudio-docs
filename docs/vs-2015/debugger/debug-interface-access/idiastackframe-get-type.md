...
The latest version of this topic can be found at [IDiaStackFrame::get_type](https://docs.microsoft.com/visualstudio/debugger/debug-interface-access/idiastackframe-get-type).  
