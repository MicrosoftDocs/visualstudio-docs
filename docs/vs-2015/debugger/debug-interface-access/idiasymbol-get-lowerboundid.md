...
The latest version of this topic can be found at [IDiaSymbol::get_lowerBoundId](https://docs.microsoft.com/visualstudio/debugger/debug-interface-access/idiasymbol-get-lowerboundid).  
