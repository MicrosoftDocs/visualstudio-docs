...
The latest version of this topic can be found at [IDiaDataSource::openSession](https://docs.microsoft.com/visualstudio/debugger/debug-interface-access/idiadatasource-opensession).  
