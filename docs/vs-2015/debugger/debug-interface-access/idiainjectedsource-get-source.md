...
The latest version of this topic can be found at [IDiaInjectedSource::get_source](https://docs.microsoft.com/visualstudio/debugger/debug-interface-access/idiainjectedsource-get-source).  
