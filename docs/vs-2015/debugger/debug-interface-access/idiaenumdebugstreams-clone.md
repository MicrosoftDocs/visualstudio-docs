...
The latest version of this topic can be found at [IDiaEnumDebugStreams::Clone](https://docs.microsoft.com/visualstudio/debugger/debug-interface-access/idiaenumdebugstreams-clone).  
