...
The latest version of this topic can be found at [IDiaSymbol::get_addressOffset](https://docs.microsoft.com/visualstudio/debugger/debug-interface-access/idiasymbol-get-addressoffset).  
