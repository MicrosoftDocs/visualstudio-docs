...
The latest version of this topic can be found at [IDiaEnumSourceFiles::Next](https://docs.microsoft.com/visualstudio/debugger/debug-interface-access/idiaenumsourcefiles-next).  
