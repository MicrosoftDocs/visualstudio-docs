...
The latest version of this topic can be found at [IDiaSymbol::findInlineeLinesByVA](https://docs.microsoft.com/visualstudio/debugger/debug-interface-access/idiasymbol-findinlineelinesbyva).  
