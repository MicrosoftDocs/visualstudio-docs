...
The latest version of this topic can be found at [Querying the .Pdb File](https://docs.microsoft.com/visualstudio/debugger/debug-interface-access/querying-the-dot-pdb-file).  
