...
The latest version of this topic can be found at [IDiaEnumDebugStreamData::Reset](https://docs.microsoft.com/visualstudio/debugger/debug-interface-access/idiaenumdebugstreamdata-reset).  
