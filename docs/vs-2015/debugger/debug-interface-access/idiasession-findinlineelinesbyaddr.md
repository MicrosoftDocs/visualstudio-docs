...
The latest version of this topic can be found at [IDiaSession::findInlineeLinesByAddr](https://docs.microsoft.com/visualstudio/debugger/debug-interface-access/idiasession-findinlineelinesbyaddr).  
