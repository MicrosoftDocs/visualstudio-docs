...
The latest version of this topic can be found at [IDiaStackWalkHelper::searchForReturnAddress](https://docs.microsoft.com/visualstudio/debugger/debug-interface-access/idiastackwalkhelper-searchforreturnaddress).  
