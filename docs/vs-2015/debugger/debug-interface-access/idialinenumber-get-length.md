...
The latest version of this topic can be found at [IDiaLineNumber::get_length](https://docs.microsoft.com/visualstudio/debugger/debug-interface-access/idialinenumber-get-length).  
