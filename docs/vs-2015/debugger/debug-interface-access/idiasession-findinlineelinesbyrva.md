...
The latest version of this topic can be found at [IDiaSession::findInlineeLinesByRVA](https://docs.microsoft.com/visualstudio/debugger/debug-interface-access/idiasession-findinlineelinesbyrva).  
