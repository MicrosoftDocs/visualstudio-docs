...
The latest version of this topic can be found at [General Tab, Window Properties Dialog Box](https://docs.microsoft.com/visualstudio/debugger/general-tab-window-properties-dialog-box).  
