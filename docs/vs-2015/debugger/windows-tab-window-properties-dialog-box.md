...
The latest version of this topic can be found at [Windows Tab, Window Properties Dialog Box](https://docs.microsoft.com/visualstudio/debugger/windows-tab-window-properties-dialog-box).  
