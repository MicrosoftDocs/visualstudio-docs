...
The latest version of this topic can be found at [Class Tab, Window Properties Dialog Box](https://docs.microsoft.com/visualstudio/debugger/class-tab-window-properties-dialog-box).  
