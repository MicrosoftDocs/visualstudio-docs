...
The latest version of this topic can be found at [Mixed Mode Debugging Is Only Supported when Using Microsoft .NET Framework 2.0 or 3.0](https://docs.microsoft.com/visualstudio/debugger/mixed-mode-debugging-is-only-supported-when-using-microsoft-dotnet-framework-2-0-or-3-0).  
