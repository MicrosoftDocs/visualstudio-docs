...
The latest version of this topic can be found at [How to: Debug Optimized Code](https://docs.microsoft.com/visualstudio/debugger/how-to-debug-optimized-code).  
