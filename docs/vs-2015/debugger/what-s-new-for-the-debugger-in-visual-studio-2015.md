...
The latest version of this topic can be found at [What's New for the Debugger](https://docs.microsoft.com/visualstudio/debugger/what-s-new-for-the-debugger-in-visual-studio).  
