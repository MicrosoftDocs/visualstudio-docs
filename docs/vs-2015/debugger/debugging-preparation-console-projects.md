...
The latest version of this topic can be found at [Debugging Preparation: Console Projects](https://docs.microsoft.com/visualstudio/debugger/debugging-preparation-console-projects).  
