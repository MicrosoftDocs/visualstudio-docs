...
The Graphics Object Table in Visual Studio Graphics Analysis helps you understand the Direct3D objects that support a frame of your game or app.  
 ...
 ![Direct3D objects that have been created by an app.](../debugger/media/gfx-diag-demo-object-table-orientation.png "gfx_diag_demo_object_table_orientation")  
...
## Graphics object viewers  
 ...
 ![The texture preview displaying the output merger](../debugger/media/gfx-diag-texture-preview.png "gfx_diag_texture_preview")  
