...
2.  Upload the .vsix file to a network or to a Web site.  
     ...
     If you upload the file to the [Visual Studio Gallery](https://marketplace.visualstudio.com/) Web site, other users can use **Extension Manager** in Visual Studio to find the control and install it.  
