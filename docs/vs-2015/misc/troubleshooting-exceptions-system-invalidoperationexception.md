...
```  
 ...
 ![Back to top](../debugger/media/pcs-backtotop.png "PCS_BackToTop") [In this article](#BKMK_In_this_article) ![In this section](../misc/media/pcs-backtotopmid.png "PCS_BackToTopMid") [A method running on a non-UI thread updates the UI](#BKMK_A_method_running_on_a_non_UI_thread_updates_the_UI)  
...
```  
 ...
 ![Back to top](../debugger/media/pcs-backtotop.png "PCS_BackToTop") [In this article](#BKMK_In_this_article) ![In this section](../misc/media/pcs-backtotopmid.png "PCS_BackToTopMid") [A Nullable&lt;T&gt; that is null is cast to T](#BKMK_A_Nullable_T_that_is_null_is_cast_to_T)  
...
```  
 ...
 ![Back to top](../debugger/media/pcs-backtotop.png "PCS_BackToTop") [In this article](#BKMK_In_this_article) ![In this section](../misc/media/pcs-backtotopmid.png "PCS_BackToTopMid") [A System.Linq.Enumerable method is called on an empty collection](#BKMK_A_System_Linq_Enumerable_method_is_called_on_an_empty_collection)  
...
##  <a name="BKMK_Related_articles"></a> Related articles  
 ...
 ![Back to top](../debugger/media/pcs-backtotop.png "PCS_BackToTop") [In this article](#BKMK_In_this_article)