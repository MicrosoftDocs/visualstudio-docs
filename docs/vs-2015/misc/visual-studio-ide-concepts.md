...
The topics in this section describe the overall structure of [!INCLUDE[vsprvs](../includes/vsprvs-md.md)] and the integrated development environment (IDE). Other topics explain VSPackages and services, and how to create and use them.  
