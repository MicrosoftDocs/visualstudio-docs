...
The latest version of this topic can be found at [How to: Collect Event Tracing for Windows (ETW) Data](https://docs.microsoft.com/visualstudio/profiling/how-to-collect-event-tracing-for-windows-etw-data).  
