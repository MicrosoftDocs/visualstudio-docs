...
|MajorVersion|Specifies the major version of the config file.|Must be 1 for [!INCLUDE[vs_dev11_long](../includes/vs-dev11-long-md.md)] projects. If not 1, the utility will not work.|  
