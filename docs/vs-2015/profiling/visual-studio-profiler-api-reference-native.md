...
The latest version of this topic can be found at [Visual Studio Profiler API Reference (Native)](https://docs.microsoft.com/visualstudio/profiling/visual-studio-profiler-api-reference-native).  
