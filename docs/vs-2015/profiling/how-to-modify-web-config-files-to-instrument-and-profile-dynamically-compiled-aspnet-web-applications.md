...
## Example  
 The following is a complete web.config file that enables the instrumentation and profiling of dynamically compiled [!INCLUDE[vstecasp](../includes/vstecasp-md.md)] Web applications. This example assumes that there were no other settings in the file before modification.  
