...
The latest version of this topic can be found at [How to: Relocate Instrumented Binaries](https://docs.microsoft.com/visualstudio/profiling/how-to-relocate-instrumented-binaries).  
