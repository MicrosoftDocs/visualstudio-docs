...
The latest version of this topic can be found at [Visualizing EventSource Events as Markers](https://docs.microsoft.com/visualstudio/profiling/visualizing-eventsource-events-as-markers).  
