...
The latest version of this topic can be found at [Concurrency Visualizer Markers](https://docs.microsoft.com/visualstudio/profiling/concurrency-visualizer-markers).  
