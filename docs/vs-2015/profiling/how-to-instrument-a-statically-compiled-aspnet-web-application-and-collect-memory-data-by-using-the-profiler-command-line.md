...
The latest version of this topic can be found at [How to: Instrument a Statically Compiled ASP.NET Web Application and Collect Memory Data by Using the Profiler Command Line](https://docs.microsoft.com/visualstudio/profiling/how-to-instrument-a-statically-compiled-aspnet-web-application-and-collect-memory-data-by-using-the-profiler-command-line).  
  
This topic describes how to use [!INCLUDE[vsprvs](../includes/vsprvs-md.md)] Profiling Tools command-line tools to instrument a pre-compiled [!INCLUDE[vstecasp](../includes/vstecasp-md.md)] Web component or Web site and collect .NET memory allocation, object lifetime, and detailed timing data.  
