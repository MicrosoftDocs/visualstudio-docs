...
The latest version of this topic can be found at [How to: Choose Sampling Events](https://docs.microsoft.com/visualstudio/profiling/how-to-choose-sampling-events).  
