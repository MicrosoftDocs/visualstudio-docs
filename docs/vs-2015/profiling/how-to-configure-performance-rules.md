...
The latest version of this topic can be found at [How to: Configure Performance Rules](https://docs.microsoft.com/visualstudio/profiling/how-to-configure-performance-rules).  
