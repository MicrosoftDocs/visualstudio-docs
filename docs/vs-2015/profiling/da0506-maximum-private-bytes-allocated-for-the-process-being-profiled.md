...
## Rule Description  
 ...
 For 32-bit processes running on a 32-bit machine, the upper limit of the private portion of the process address space is 2 GB. Using the [/3 GB](https://msdn.microsoft.com/library/ff556232.aspx) Boot.ini switch, 32-bit processes can acquire up to 3 GB of virtual memory. A 32-bit process that is running on a 64-bit machine can acquire up to 4 GB of private virtual memory.  
 ...
 For more information about process address spaces, see [Virtual Address Space](https://msdn.microsoft.com/library/aa366912.aspx) in the Windows Memory Management documentation.  
