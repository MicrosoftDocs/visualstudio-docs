...
##### [Sampling Method Data Views](profiler-sampling-method-data-views.md)
###### [Summary View](summary-view-sampling-data.md)
###### [Call Tree View](call-tree-view-sampling-data.md)
###### [Modules View](modules-view-sampling-data.md)
###### [Caller / Callee View](caller-callee-view-sampling-data.md)
###### [Functions View](functions-view-sampling-data.md)
###### [Lines View](lines-view-sampling-data.md)
###### [Instruction Pointers (IPs) View](instruction-pointers-ips-view-sampling-data.md)
##### [Instrumentation Method Data Views](instrumentation-method-data-views.md)
###### [Summary View](summary-view-instrumentation-data.md)
###### [Call Tree View](call-tree-view-instrumentation-data.md)
###### [Modules View](modules-view-instrumentation-data.md)
###### [Caller / Callee View](caller-callee-view-instrumentation-data.md)
###### [Functions View](functions-view-instrumentation-data.md)
##### [.NET Memory Data Views](dotnet-memory-data-views.md)
###### [Summary View](summary-view-dotnet-memory-data.md)
###### [Allocations View](dotnet-memory-allocations-view.md)
###### [Object Lifetime View](object-lifetime-view.md)
###### [Call Tree View - Sampling](call-tree-view-dotnet-memory-sampling-data.md)
###### [Modules View - Sampling](modules-view-dotnet-memory-sampling-data.md)
###### [Caller / Callee View - Sampling](caller-callee-view-dotnet-memory-sampling-data.md)
###### [Functions View - Sampling](functions-view-dotnet-memory-sampling-data.md)
###### [Lines View - Sampling](lines-view-dotnet-memory-sampling-data.md)
###### [Instruction Pointers (IPs) View - Sampling](instruction-pointers-ips-view-dotnet-memory-sampling-data.md)
###### [Call Tree View - Instrumentation](call-tree-view-dotnet-memory-instrumentation-data.md)
###### [Modules View - Instrumentation](modules-view-dotnet-memory-instrumentation-data.md)
###### [Caller / Callee View - Instrumentation](caller-callee-view-net-memory-instrumentation-data.md)
###### [Functions View - Instrumentation](functions-view-dotnet-memory-instrumentation-data.md)
##### [Resource Contention Data Views](resource-contention-data-views.md)
###### [Summary View](summary-view-resource-contention-view.md)
###### [Call Tree View](call-tree-view-contention-data.md)
###### [Modules View](modules-view-contention-data.md)
###### [Caller / Callee View](caller-callee-view-contention-data.md)
###### [Functions View](functions-view-contention-data.md)
###### [Resource Details View](resource-details-view-contention-data.md)
...
###### [How to: Launch a Stand-Alone Application and Collect Application Statistics](how-to-launch-a-stand-alone-application-with-the-profiler-and-collect-application-statistics-by-using-the-command-line.md)
...
###### [How to: Attach the Profiler to a .NET Service to Collect Application Statistics](how-to-attach-the-profiler-to-a-dotnet-service-to-collect-application-statistics-by-using-the-command-line.md)
...
#### [No Thread Activity to Show](no-thread-activity-to-show-threads-view.md)
