...
The latest version of this topic can be found at [How to: Collect Windows Counter Data](https://docs.microsoft.com/visualstudio/profiling/how-to-collect-windows-counter-data).  
