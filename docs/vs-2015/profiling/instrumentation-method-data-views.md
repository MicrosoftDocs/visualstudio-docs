...
The latest version of this topic can be found at [Instrumentation Method Data Views](https://docs.microsoft.com/visualstudio/profiling/instrumentation-method-data-views).  
