...
## Rule Description  
 ...
 This rule fires when proportionally too many generation 1 garbage collections have occurred. If too many fairly short-lived objects survive generation 0 collection but are then able to be collected in a generation 1 collection, the cost of memory management can become excessive. For more information, see the [Mid-life crisis](https://docs.microsoft.com/archive/blogs/ricom/mid-life-crisis) post on the Rico Mariani's Performance Tidbits on the MSDN Web site.  
