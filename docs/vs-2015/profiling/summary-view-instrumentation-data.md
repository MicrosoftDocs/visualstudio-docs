...
The latest version of this topic can be found at [Summary View - Instrumentation Data](https://docs.microsoft.com/visualstudio/profiling/summary-view-instrumentation-data).  
