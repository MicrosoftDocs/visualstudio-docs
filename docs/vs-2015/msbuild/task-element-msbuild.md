...
## Remarks  
 A `Task` element in an [!INCLUDE[vstecmsbuild](../includes/vstecmsbuild-md.md)] project file creates an instance of a task, sets properties on it, and executes it. The `Output` element stores output parameters in properties or items to be used elsewhere in the project file.  
