...
The latest version of this topic can be found at [Using Multiple Processors to Build Projects](https://docs.microsoft.com/visualstudio/msbuild/using-multiple-processors-to-build-projects).  
