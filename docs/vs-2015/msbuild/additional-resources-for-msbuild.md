...
The latest version of this topic can be found at [Additional Resources for MSBuild](https://docs.microsoft.com/visualstudio/msbuild/additional-resources-for-msbuild).  
