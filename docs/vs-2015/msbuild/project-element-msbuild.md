...
|        `Xmlns`         |                                                                                                                                                                                                                                                                                                                                                                                                                                                                                 Required attribute (in MSBuild 15.x and earlier).<br /><br /> The `xmlns` attribute must have the value of `http://schemas.microsoft.com/developer/msbuild/2003`.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                  |
