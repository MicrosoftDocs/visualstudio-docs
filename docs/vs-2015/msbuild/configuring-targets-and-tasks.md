...
## Installation  
 ...
 If you want to install MSBuild separately from Visual Studio, you can download the installation package from [MSBuild Download](https://www.microsoft.com/download/details.aspx?id=40760). You must also install the .NET Framework versions you wish to use also.  
