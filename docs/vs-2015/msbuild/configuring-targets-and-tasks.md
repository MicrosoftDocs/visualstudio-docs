...
The latest version of this topic can be found at [Configuring Targets and Tasks](https://docs.microsoft.com/visualstudio/msbuild/configuring-targets-and-tasks).  
