...
The latest version of this topic can be found at [UpdateManifestForBrowserApplication Task](https://docs.microsoft.com/visualstudio/msbuild/updatemanifestforbrowserapplication-task).  
