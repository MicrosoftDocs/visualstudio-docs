...
The latest version of this topic can be found at [How to: Configure Targets and Tasks](https://docs.microsoft.com/visualstudio/msbuild/how-to-configure-targets-and-tasks).  
