...
The latest version of this topic can be found at [MSBuild Target Framework and Target Platform](https://docs.microsoft.com/visualstudio/msbuild/msbuild-target-framework-and-target-platform).  
