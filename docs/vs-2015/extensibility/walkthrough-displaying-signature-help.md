...
The latest version of this topic can be found at [Walkthrough: Displaying Signature Help](https://docs.microsoft.com/visualstudio/extensibility/walkthrough-displaying-signature-help).  
