...
# [Visual Studio User Experience Guidelines](ux-guidelines/visual-studio-user-experience-guidelines.md)
...
# [Inside the Visual Studio SDK](internals/inside-the-visual-studio-sdk.md)
...
#### [.Vsct Files](modifying-the-isolated-shell-by-using-the-dot-vsct-file.md)
...
## [How to: Update an Extension](how-to-update-a-visual-studio-extension.md)
...
### [Conditional Attributes](vsct-xml-schema-conditional-attributes.md)
## [GUIDs and Constants](guids-and-constants-in-the-visual-studio-sdk.md)
...
#### [Command Code](command-code-enumerator.md)
#### [Message](message-enumerator.md)
#### [File Status Code](file-status-code-enumerator.md)
#### [Directory Status Code](directory-status-code-enumerator.md)
...
### [Glossary](source-control-plug-in-glossary.md)
...
## [Command-Line Switches](command-line-switches-visual-studio-sdk.md)
...
## [Glossary](visual-studio-sdk-glossary.md)
...
## [Real World Roslyn Analyzer](roslyn-analyzers-and-code-aware-library-for-immutablearrays.md)
