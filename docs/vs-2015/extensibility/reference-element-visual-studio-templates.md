...
The latest version of this topic can be found at [Reference Element (Visual Studio Templates)](https://docs.microsoft.com/visualstudio/extensibility/reference-element-visual-studio-templates).  
