...
The latest version of this topic can be found at [Walkthrough: Displaying Matching Braces](https://docs.microsoft.com/visualstudio/extensibility/walkthrough-displaying-matching-braces).  
