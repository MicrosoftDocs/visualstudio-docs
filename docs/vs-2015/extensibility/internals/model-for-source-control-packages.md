...
The latest version of this topic can be found at [Model for Source Control Packages](https://docs.microsoft.com/visualstudio/extensibility/internals/model-for-source-control-packages).  
