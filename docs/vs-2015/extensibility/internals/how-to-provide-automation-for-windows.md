...
The latest version of this topic can be found at [How to: Provide Automation for Windows](https://docs.microsoft.com/visualstudio/extensibility/internals/how-to-provide-automation-for-windows).  
