...
## In This Section  
 ...
 Presents the important elements [!INCLUDE[vsprvs](../../includes/vsprvs-md.md)] Web projects.  
  
 [Web Site Support](../../extensibility/internals/web-site-support.md)  
 Presents an overview of [!INCLUDE[vsprvs](../../includes/vsprvs-md.md)] Web site projects. A Web site project generates one executable file for each smart Web page. Additional executable files are generated from the source code files in the /App_Code folder.  
