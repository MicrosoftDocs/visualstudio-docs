...
The latest version of this topic can be found at [Exposing Types to Visual Designers](https://docs.microsoft.com/visualstudio/extensibility/internals/exposing-types-to-visual-designers).  
