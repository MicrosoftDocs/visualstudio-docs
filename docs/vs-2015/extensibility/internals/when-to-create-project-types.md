...
The latest version of this topic can be found at [When to Create Project Types](https://docs.microsoft.com/visualstudio/extensibility/internals/when-to-create-project-types).  
