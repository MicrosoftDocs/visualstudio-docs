...
The latest version of this topic can be found at [Command Contracts in Interop Assemblies](https://docs.microsoft.com/visualstudio/extensibility/internals/command-contracts-in-interop-assemblies).  
