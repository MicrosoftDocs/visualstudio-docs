...
The latest version of this topic can be found at [Managing Configuration Options](https://docs.microsoft.com/visualstudio/extensibility/internals/managing-configuration-options).  
...
## In This Section  
 ...
 Describes how projects in [!INCLUDE[vsprvs](../../includes/vsprvs-md.md)] can support multiple configurations.  
 ...
 Defines the act of deployment and the two ways [!INCLUDE[vsprvs](../../includes/vsprvs-md.md)] supports projects that support deployment.  
