...
The latest version of this topic can be found at [RDT_ReadLock Usage](https://docs.microsoft.com/visualstudio/extensibility/internals/rdt-readlock-usage).  
