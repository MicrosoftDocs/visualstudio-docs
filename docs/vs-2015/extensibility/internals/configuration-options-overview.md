...
The latest version of this topic can be found at [Configuration Options Overview](https://docs.microsoft.com/visualstudio/extensibility/internals/configuration-options-overview).  
