...
The latest version of this topic can be found at [Query Edit Query Save (Source Control VSPackage)](https://docs.microsoft.com/visualstudio/extensibility/internals/query-edit-query-save-source-control-vspackage).  
