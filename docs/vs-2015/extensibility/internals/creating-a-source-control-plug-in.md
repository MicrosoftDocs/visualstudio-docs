...
The latest version of this topic can be found at [Creating a Source Control Plug-in](https://docs.microsoft.com/visualstudio/extensibility/internals/creating-a-source-control-plug-in).  
