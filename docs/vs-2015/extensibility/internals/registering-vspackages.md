...
The latest version of this topic can be found at [Registering VSPackages](https://docs.microsoft.com/visualstudio/extensibility/internals/registering-vspackages).  
