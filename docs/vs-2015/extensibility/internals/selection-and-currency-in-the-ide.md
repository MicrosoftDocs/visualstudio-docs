...
The latest version of this topic can be found at [Selection and Currency in the IDE](https://docs.microsoft.com/visualstudio/extensibility/internals/selection-and-currency-in-the-ide).  
