...
> [!NOTE]
>  This template architecture is not supported for [!INCLUDE[vcprvc](../../includes/vcprvc-md.md)] projects. For information about how to create [!INCLUDE[vcprvc](../../includes/vcprvc-md.md)] project templates, see [Designing a Wizard](../Topic/Designing%20a%20Wizard.md).  
