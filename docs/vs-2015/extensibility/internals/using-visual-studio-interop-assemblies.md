...
The latest version of this topic can be found at [Using Visual Studio Interop Assemblies](https://docs.microsoft.com/visualstudio/extensibility/internals/using-visual-studio-interop-assemblies).  
