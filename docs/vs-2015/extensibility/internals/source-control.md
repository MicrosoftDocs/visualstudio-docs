...
The latest version of this topic can be found at [Source Control](https://docs.microsoft.com/visualstudio/extensibility/internals/source-control).  
...
## In This Section  
 ...
 Discusses how to create a source control plug-in that supplies source control functionality through the [!INCLUDE[vsprvs](../../includes/vsprvs-md.md)] source control user interface (UI).  
