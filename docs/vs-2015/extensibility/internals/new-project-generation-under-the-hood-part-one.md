...
##### DeveloperActivity  
 ...
 indicates that Visual C# will be a root node if Visual Studio is set for [!INCLUDE[vcprvc](../../includes/vcprvc-md.md)] development. Otherwise, it will be a child node of **Other Languages**.  
