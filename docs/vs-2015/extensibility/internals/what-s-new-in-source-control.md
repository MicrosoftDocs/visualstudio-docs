...
The latest version of this topic can be found at [What&#39;s New in Source Control](https://docs.microsoft.com/visualstudio/extensibility/internals/what-s-new-in-source-control).  
