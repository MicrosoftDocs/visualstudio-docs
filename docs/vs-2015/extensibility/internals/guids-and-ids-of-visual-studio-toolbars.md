...
The latest version of this topic can be found at [GUIDs and IDs of Visual Studio Toolbars](https://docs.microsoft.com/visualstudio/extensibility/internals/guids-and-ids-of-visual-studio-toolbars).  
