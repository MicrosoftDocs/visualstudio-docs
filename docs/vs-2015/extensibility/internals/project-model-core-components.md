...
The latest version of this topic can be found at [Project Model Core Components](https://docs.microsoft.com/visualstudio/extensibility/internals/project-model-core-components).  
