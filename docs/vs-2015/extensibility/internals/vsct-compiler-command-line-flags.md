...
## Command Line Parameters  
 To view basic VSCT help from a [!INCLUDE[vsprvs](../../includes/vsprvs-md.md)] **Command** window, navigate to the *Visual Studio SDK installation path*\VisualStudioIntegration\Tools\Bin\ folder and type:  
