...
The latest version of this topic can be found at [Creating a Windows Forms Toolbox Control](https://docs.microsoft.com/visualstudio/extensibility/creating-a-windows-forms-toolbox-control).  
