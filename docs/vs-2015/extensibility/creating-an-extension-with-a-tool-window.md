...
The latest version of this topic can be found at [Creating an Extension with a Tool Window](https://docs.microsoft.com/visualstudio/extensibility/creating-an-extension-with-a-tool-window).  
