...
The latest version of this topic can be found at [How to: Implement the Find and Replace Mechanism](https://docs.microsoft.com/visualstudio/extensibility/how-to-implement-the-find-and-replace-mechanism).  
