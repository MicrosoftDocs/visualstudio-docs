...
2.  In a web browser, open the [Visual Studio Marketplace](http://go.microsoft.com/fwlink/?LinkId=194329) website.
...
1.  Open the [Visual Studio Marketplace](http://go.microsoft.com/fwlink/?LinkId=194329) website.
