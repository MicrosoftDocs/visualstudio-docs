...
2.  In a web browser, open the [Visual Studio Marketplace](https://markeplace.visualstudio.com/) website.
...
1.  Open the [Visual Studio Marketplace](https://markeplace.visualstudio.com/) website.
