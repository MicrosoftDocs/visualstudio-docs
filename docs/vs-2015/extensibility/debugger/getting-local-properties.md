...
The latest version of this topic can be found at [Getting Local Properties](https://docs.microsoft.com/visualstudio/extensibility/debugger/getting-local-properties).  
