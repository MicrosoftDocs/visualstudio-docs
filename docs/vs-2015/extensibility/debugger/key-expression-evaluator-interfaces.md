...
The latest version of this topic can be found at [Key Expression Evaluator Interfaces](https://docs.microsoft.com/visualstudio/extensibility/debugger/key-expression-evaluator-interfaces).  
