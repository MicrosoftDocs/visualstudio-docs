...
The latest version of this topic can be found at [Task Class - Internal Members](https://docs.microsoft.com/visualstudio/extensibility/debugger/task-class-internal-members).  
