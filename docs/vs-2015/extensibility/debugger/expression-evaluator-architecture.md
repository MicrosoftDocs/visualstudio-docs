...
The latest version of this topic can be found at [Expression Evaluator Architecture](https://docs.microsoft.com/visualstudio/extensibility/debugger/expression-evaluator-architecture).  
