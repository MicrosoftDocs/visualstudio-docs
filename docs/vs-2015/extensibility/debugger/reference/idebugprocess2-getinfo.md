...
The latest version of this topic can be found at [IDebugProcess2::GetInfo](https://docs.microsoft.com/visualstudio/extensibility/debugger/reference/idebugprocess2-getinfo).  
