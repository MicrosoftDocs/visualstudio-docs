...
The latest version of this topic can be found at [IDebugModuleLoadEvent2](https://docs.microsoft.com/visualstudio/extensibility/debugger/reference/idebugmoduleloadevent2).  
