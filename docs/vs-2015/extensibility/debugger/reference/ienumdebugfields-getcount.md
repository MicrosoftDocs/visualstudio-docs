...
The latest version of this topic can be found at [IEnumDebugFields::GetCount](https://docs.microsoft.com/visualstudio/extensibility/debugger/reference/ienumdebugfields-getcount).  
