...
The latest version of this topic can be found at [BP_LOCATION_CODE_STRING](https://docs.microsoft.com/visualstudio/extensibility/debugger/reference/bp-location-code-string).  
