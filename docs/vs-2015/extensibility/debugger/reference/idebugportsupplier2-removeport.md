...
The latest version of this topic can be found at [IDebugPortSupplier2::RemovePort](https://docs.microsoft.com/visualstudio/extensibility/debugger/reference/idebugportsupplier2-removeport).  
