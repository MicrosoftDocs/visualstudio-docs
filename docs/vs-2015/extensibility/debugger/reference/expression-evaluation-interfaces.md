...
The latest version of this topic can be found at [Expression Evaluation Interfaces](https://docs.microsoft.com/visualstudio/extensibility/debugger/reference/expression-evaluation-interfaces).  
