...
The latest version of this topic can be found at [IDebugDisassemblyStream2::GetSize](https://docs.microsoft.com/visualstudio/extensibility/debugger/reference/idebugdisassemblystream2-getsize).  
