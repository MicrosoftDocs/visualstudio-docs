...
The latest version of this topic can be found at [IEnumDebugModules2::Reset](https://docs.microsoft.com/visualstudio/extensibility/debugger/reference/ienumdebugmodules2-reset).  
