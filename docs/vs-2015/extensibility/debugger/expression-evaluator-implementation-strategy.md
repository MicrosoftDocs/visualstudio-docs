...
The latest version of this topic can be found at [Expression Evaluator Implementation Strategy](https://docs.microsoft.com/visualstudio/extensibility/debugger/expression-evaluator-implementation-strategy).  
