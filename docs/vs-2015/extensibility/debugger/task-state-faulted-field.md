...
The latest version of this topic can be found at [TASK_STATE_FAULTED Field](https://docs.microsoft.com/visualstudio/extensibility/debugger/task-state-faulted-field).  
