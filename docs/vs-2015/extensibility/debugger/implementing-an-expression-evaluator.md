...
The latest version of this topic can be found at [Implementing an Expression Evaluator](https://docs.microsoft.com/visualstudio/extensibility/debugger/implementing-an-expression-evaluator).  
