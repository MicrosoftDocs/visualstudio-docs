...
The latest version of this topic can be found at [Sample Implementation of Locals](https://docs.microsoft.com/visualstudio/extensibility/debugger/sample-implementation-of-locals).  
