...
The latest version of this topic can be found at [Getting Local Values](https://docs.microsoft.com/visualstudio/extensibility/debugger/getting-local-values).  
