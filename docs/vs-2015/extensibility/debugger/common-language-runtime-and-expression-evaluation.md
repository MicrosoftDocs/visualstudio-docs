...
The latest version of this topic can be found at [Common Language Runtime and Expression Evaluation](https://docs.microsoft.com/visualstudio/extensibility/debugger/common-language-runtime-and-expression-evaluation).  
