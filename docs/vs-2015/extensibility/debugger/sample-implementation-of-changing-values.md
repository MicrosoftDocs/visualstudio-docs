...
The latest version of this topic can be found at [Sample Implementation of Changing Values](https://docs.microsoft.com/visualstudio/extensibility/debugger/sample-implementation-of-changing-values).  
