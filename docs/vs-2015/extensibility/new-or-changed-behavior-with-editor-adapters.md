...
The latest version of this topic can be found at [New or Changed Behavior with Editor Adapters](https://docs.microsoft.com/visualstudio/extensibility/new-or-changed-behavior-with-editor-adapters).  
