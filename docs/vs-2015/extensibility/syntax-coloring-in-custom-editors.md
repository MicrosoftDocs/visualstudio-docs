...
The latest version of this topic can be found at [Syntax Coloring in Custom Editors](https://docs.microsoft.com/visualstudio/extensibility/syntax-coloring-in-custom-editors).  
