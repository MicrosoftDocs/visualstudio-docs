...
The latest version of this topic can be found at [How to: Use Linked Undo Management](https://docs.microsoft.com/visualstudio/extensibility/how-to-use-linked-undo-management).  
