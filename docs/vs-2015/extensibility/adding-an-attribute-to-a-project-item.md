...
The latest version of this topic can be found at [Adding an Attribute to a Project Item](https://docs.microsoft.com/visualstudio/extensibility/adding-an-attribute-to-a-project-item).  
