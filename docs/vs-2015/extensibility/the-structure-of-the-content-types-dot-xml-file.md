...
The latest version of this topic can be found at [The Structure of the [Content_types].xml File](https://docs.microsoft.com/visualstudio/extensibility/the-structure-of-the-content-types-dot-xml-file).  
