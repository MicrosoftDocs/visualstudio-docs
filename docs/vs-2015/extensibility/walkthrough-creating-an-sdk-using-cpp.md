...
5.  Use the following XML to replace the existing XML.  
    ...
    [!code-xml[CreatingAnSDKUsingCpp#6](../../docs/extensibility/codesnippet/XML/walkthrough-creating-an-sdk-using-cpp_6.xml)]
...
12. In the \DesignTime\Debug\x86\ folder, create a text file that’s named NativeMathSDK.props, and then paste the following contents in it:  
    ...
    [!code-xml[CreatingAnSDKUsingCpp#7](../../docs/extensibility/codesnippet/XML/walkthrough-creating-an-sdk-using-cpp_7.xml)]  
