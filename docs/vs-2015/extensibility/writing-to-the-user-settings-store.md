...
The latest version of this topic can be found at [Writing to the User Settings Store](https://docs.microsoft.com/visualstudio/extensibility/writing-to-the-user-settings-store).  
