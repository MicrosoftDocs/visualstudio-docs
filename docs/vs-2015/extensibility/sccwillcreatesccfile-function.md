...
The latest version of this topic can be found at [SccWillCreateSccFile Function](https://docs.microsoft.com/visualstudio/extensibility/sccwillcreatesccfile-function).  
