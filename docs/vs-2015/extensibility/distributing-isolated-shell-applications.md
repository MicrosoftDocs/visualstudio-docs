...
The latest version of this topic can be found at [Distributing Isolated Shell Applications](https://docs.microsoft.com/visualstudio/extensibility/distributing-isolated-shell-applications).  
