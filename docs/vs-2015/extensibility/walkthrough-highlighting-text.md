...
The latest version of this topic can be found at [Walkthrough: Highlighting Text](https://docs.microsoft.com/visualstudio/extensibility/walkthrough-highlighting-text).  
