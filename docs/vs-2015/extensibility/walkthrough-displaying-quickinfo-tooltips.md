...
The latest version of this topic can be found at [Walkthrough: Displaying QuickInfo Tooltips](https://docs.microsoft.com/visualstudio/extensibility/walkthrough-displaying-quickinfo-tooltips).  
