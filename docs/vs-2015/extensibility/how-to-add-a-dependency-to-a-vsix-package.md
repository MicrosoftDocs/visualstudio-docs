...
The latest version of this topic can be found at [How to: Add a Dependency to a VSIX Package](https://docs.microsoft.com/visualstudio/extensibility/how-to-add-a-dependency-to-a-vsix-package).  
