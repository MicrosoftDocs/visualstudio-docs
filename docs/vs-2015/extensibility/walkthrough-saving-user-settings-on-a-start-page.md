...
The latest version of this topic can be found at [Walkthrough: Saving User Settings on a Start Page](https://docs.microsoft.com/visualstudio/extensibility/walkthrough-saving-user-settings-on-a-start-page).  
