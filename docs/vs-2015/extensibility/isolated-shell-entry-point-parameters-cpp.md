...
The latest version of this topic can be found at [Isolated Shell Entry Point Parameters (C++)](https://docs.microsoft.com/visualstudio/extensibility/isolated-shell-entry-point-parameters-cpp).  
