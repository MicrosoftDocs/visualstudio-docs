...
- The [Windows Installer XML Toolset](https://documentation.help/WiX-Toolset/index.html/) version 3.6  
...
## Creating an MSI for Your Shell  
 To build your MSI package, we recommend that you use the [Windows Installer XML Toolset](https://documentation.help/WiX-Toolset/index.html) because it gives greater flexibility than a standard Setup project.  
