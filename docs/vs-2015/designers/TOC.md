...
## [Designing XAML in Visual Studio and Blend for Visual Studio](designing-xaml-in-visual-studio.md)
### [Creating a UI by using XAML Designer](creating-a-ui-by-using-xaml-designer-in-visual-studio.md)
#### [Working with elements in XAML Designer](working-with-elements-in-xaml-designer.md)
#### [Organize objects into layout containers](organize-objects-into-layout-containers-in-xaml-designer.md)
...
#### [Insert controls and modify their behavior](insert-controls-and-modify-their-behavior-in-xaml-designer.md)
#### [Insert images, videos, and audio clips](insert-images-videos-and-audio-clips-in-xaml-designer.md)
#### [Draw shapes and paths](draw-shapes-and-paths.md)
#### [Modify the style of objects](modify-the-style-of-objects-in-blend.md)
#### [Animate objects](animate-objects-in-xaml-designer.md)
#### [Display data](display-data-in-blend.md)
#### [Keyboard shortcuts and modifier keys](keyboard-shortcuts-and-modifier-keys-in-blend.md)
...
#### [Accessibility products and services](accessibility-products-and-services-blend.md)
### [Keyboard shortcuts  for XAML Designer  in Visual Studio and Blend for Visual Studio](keyboard-shortcuts-for-xaml-designer.md)
