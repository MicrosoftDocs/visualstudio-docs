...
The latest version of this topic can be found at [XAttribute Class Dynamic Properties](https://docs.microsoft.com/visualstudio/designers/xattribute-class-dynamic-properties).  
