...
The latest version of this topic can be found at [Getting Started with WPF](https://docs.microsoft.com/visualstudio/designers/getting-started-with-wpf).  
...
|New to .NET?|[Overview of the .NET Framework](https://msdn.microsoft.com/library/zw4w595w\(v=vs.140\).aspx)<br /><br /> [Application Essentials](../Topic/.NET%20Framework%20Application%20Essentials.md)<br /><br /> [Getting Started with Visual C# and Visual Basic](https://msdn.microsoft.com/library/dd492171\(v=vs.140\).aspx)|  
