...
The latest version of this topic can be found at [How to: Create a Basic Lambert Shader](https://docs.microsoft.com/visualstudio/designers/how-to-create-a-basic-lambert-shader).  
