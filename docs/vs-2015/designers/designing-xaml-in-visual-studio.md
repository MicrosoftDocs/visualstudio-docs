...
The latest version of this topic can be found at [Designing XAML in Visual Studio](https://docs.microsoft.com/visualstudio/designers/designing-xaml-in-visual-studio).  
