...
The latest version of this topic can be found at [Learn app-building basics with Xamarin.Forms in Visual Studio](https://docs.microsoft.com/visualstudio/cross-platform/learn-app-building-basics-with-xamarin-forms-in-visual-studio).  
