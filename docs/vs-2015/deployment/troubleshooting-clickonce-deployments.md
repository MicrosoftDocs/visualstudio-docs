...
This topic helps you diagnose and resolve the most common issues with [!INCLUDE[ndptecclick](../includes/ndptecclick-md.md)] deployments.  
 ...
 Describes how to redirect all [!INCLUDE[ndptecclick](../includes/ndptecclick-md.md)] activation failures on a machine to a single log file.  
 ...
 Describes how to increase the detail that [!INCLUDE[ndptecclick](../includes/ndptecclick-md.md)] writes to log files.  
 ...
 Describes various issues with the configuration of your Web server that could cause difficulty downloading [!INCLUDE[ndptecclick](../includes/ndptecclick-md.md)] applications.  
 ...
 Describes miscellaneous issues surrounding [!INCLUDE[ndptecclick](../includes/ndptecclick-md.md)] deployments.  
 ...
 Describes specific scenarios in which a [!INCLUDE[ndptecclick](../includes/ndptecclick-md.md)] deployment cannot succeed, and provides steps for resolving them.  
