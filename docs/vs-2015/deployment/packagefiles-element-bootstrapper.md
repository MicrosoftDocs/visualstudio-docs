...
## Example  
 The following code example defines packages for the [!INCLUDE[dnprdnshort](../includes/dnprdnshort-md.md)] redistributable package and its dependencies, such as the Windows Installer.  
