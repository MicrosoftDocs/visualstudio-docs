...
The latest version of this topic can be found at [&lt;assemblyIdentity&gt; Element (ClickOnce Application)](https://docs.microsoft.com/visualstudio/deployment/assemblyidentity-element-clickonce-application).  
