...
For the latest documentation on Visual Studio, see [CA1707: Identifiers should not contain underscores](https://docs.microsoft.com/visualstudio/code-quality/ca1707-identifiers-should-not-contain-underscores) on docs.microsoft.com.  
