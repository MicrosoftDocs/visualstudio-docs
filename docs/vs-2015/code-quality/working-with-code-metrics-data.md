...
The latest version of this topic can be found at [Working with Code Metrics Data](https://docs.microsoft.com/visualstudio/code-quality/working-with-code-metrics-data).  
