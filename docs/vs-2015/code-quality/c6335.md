...
```  
 ...
 For more information, see [CreateProcess Function](https://msdn.microsoft.com/library/ms682425.aspx) and [CloseHandle Function](https://msdn.microsoft.com/library/ms724211.aspx).
