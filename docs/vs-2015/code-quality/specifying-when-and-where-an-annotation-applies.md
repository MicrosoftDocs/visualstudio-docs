...
The latest version of this topic can be found at [Specifying When and Where an Annotation Applies](https://docs.microsoft.com/visualstudio/code-quality/specifying-when-and-where-an-annotation-applies).  
