...
The latest version of this topic can be found at [C6262](https://docs.microsoft.com/visualstudio/code-quality/c6262).  
...
## See Also  
 [/STACK (Stack Allocations)](http://msdn.microsoft.com/library/73283660-e4bd-47cc-b5ca-04c5d739034c)   
