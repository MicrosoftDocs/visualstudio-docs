...
The latest version of this topic can be found at [Extended Correctness Rules rule set for managed code](https://docs.microsoft.com/visualstudio/code-quality/extended-correctness-rules-rule-set-for-managed-code).  
