...
The latest version of this topic can be found at [C6297](https://docs.microsoft.com/visualstudio/code-quality/c6297).  
...
## See Also  
 [Compiler Warning (level 1) C4293](http://msdn.microsoft.com/library/babecd96-eb51-41a5-9835-462c7a46dbad)
