...
warning C26130: Missing annotation *Requires_lock_held\\*(\<lock>) or *No_competing_thread\\* at function \<func>. Otherwise it could be a race condition. Variable \<var> should be protected by lock \<lock>.  
