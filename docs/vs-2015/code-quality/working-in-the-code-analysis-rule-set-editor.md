...
The latest version of this topic can be found at [Working in the Code Analysis Rule Set Editor](https://docs.microsoft.com/visualstudio/code-quality/working-in-the-code-analysis-rule-set-editor).  
