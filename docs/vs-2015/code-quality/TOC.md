# [Analyzing Application Quality](analyzing-application-quality-by-using-code-analysis-tools.md)
## [Analyzing Managed Code Quality](analyzing-managed-code-quality-by-using-code-analysis.md)
### [Code Analysis for Managed Code Overview](code-analysis-for-managed-code-overview.md)
### [How to: Enable and Disable Automatic Code Analysis](how-to-enable-and-disable-automatic-code-analysis-for-managed-code.md)
### [How to: Enable and Disable Full Solution Analysis](how-to-enable-and-disable-full-solution-analysis-for-managed-code.md)
### [Automatic feature suspension](automatic-feature-suspension.md)
### [How to: Run Code Analysis Manually](how-to-run-code-analysis-manually-for-managed-code.md)
...
### [How to: Suppress Warnings for Generated Code](how-to-suppress-code-analysis-warnings-for-generated-code.md)
...
#### [Warnings By CheckId](code-analysis-warnings-for-managed-code-by-checkid.md)
...
## [Analyzing C/C++ Code Quality](analyzing-c-cpp-code-quality-by-using-code-analysis.md)
...
### [How to: Specify Rule Sets for Multiple Projects in a Solution](how-to-specify-managed-code-rule-sets-for-multiple-projects-in-a-solution.md)
### [Creating Custom Rule Sets](creating-custom-code-analysis-rule-sets.md)
#### [How to: Create a Custom Rule Set](how-to-create-a-custom-rule-set.md)
#### [Working in the Rule Set Editor](working-in-the-code-analysis-rule-set-editor.md)
...
#### [Implementing Custom Check-in Policies for Managed Code](implementing-custom-code-analysis-check-in-policies-for-managed-code.md)
