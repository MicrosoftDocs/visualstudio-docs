...
The latest version of this topic can be found at [Create a Windows Form to search data](https://docs.microsoft.com/visualstudio/data-tools/create-a-windows-form-to-search-data).  
