...
The latest version of this topic can be found at [Display related data in WPF applications](https://docs.microsoft.com/visualstudio/data-tools/display-related-data-in-wpf-applications).  
