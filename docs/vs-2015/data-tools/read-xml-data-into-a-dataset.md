...
The latest version of this topic can be found at [Read XML data into a dataset](https://docs.microsoft.com/visualstudio/data-tools/read-xml-data-into-a-dataset).  
...
-   Two <xref:System.Windows.Forms.Button> controls.  
    ...
    -   A second button extracts the schema from the dataset, and through a <xref:System.IO.StringWriter%2A> displays it in the <xref:System.Windows.Forms.TextBox> control.  
