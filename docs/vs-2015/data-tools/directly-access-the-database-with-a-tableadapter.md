...
The latest version of this topic can be found at [Directly access the database with a TableAdapter](https://docs.microsoft.com/visualstudio/data-tools/directly-access-the-database-with-a-tableadapter).  
