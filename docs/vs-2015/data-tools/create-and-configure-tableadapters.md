...
-   Run the [Data Source Configuration Wizard](../Topic/Data%20Source%20Configuration%20Wizard.md) and select either the **Database** or **Web Service** data source type.  
