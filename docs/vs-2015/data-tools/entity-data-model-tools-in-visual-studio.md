...
|[Getting Started on Full .NET (Console, WinForms, WPF, etc.)](https://docs.microsoft.com/ef/ef6/get-started)|Provides tutorials on how to create .NET desktop applications that use Entity Framework 7.|
