...
The latest version of this topic can be found at [Turn off constraints while filling a dataset](https://docs.microsoft.com/visualstudio/data-tools/turn-off-constraints-while-filling-a-dataset).  
