...
The latest version of this topic can be found at [Create a user control that supports simple data binding](https://docs.microsoft.com/visualstudio/data-tools/create-a-windows-forms-user-control-that-supports-simple-data-binding).  
