...
The latest version of this topic can be found at [Create and configure datasets in Visual Studio](https://docs.microsoft.com/visualstudio/data-tools/create-and-configure-datasets-in-visual-studio).  
