...
The latest version of this topic can be found at [XML Schema Designer Workspace](https://docs.microsoft.com/visualstudio/xml-tools/xml-schema-designer-workspace).  
