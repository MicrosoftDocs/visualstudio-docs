...
The latest version of this topic can be found at [Walkthrough: Using XSLT Hierarchy](https://docs.microsoft.com/visualstudio/xml-tools/walkthrough-using-xslt-hierarchy).  
