...
The latest version of this topic can be found at [How to: Change the Build Output Directory](https://docs.microsoft.com/visualstudio/ide/how-to-change-the-build-output-directory).  
