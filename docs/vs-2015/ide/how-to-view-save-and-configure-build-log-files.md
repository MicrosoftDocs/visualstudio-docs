...
The latest version of this topic can be found at [How to: View, Save, and Configure Build Log Files](https://docs.microsoft.com/visualstudio/ide/how-to-view-save-and-configure-build-log-files).  
