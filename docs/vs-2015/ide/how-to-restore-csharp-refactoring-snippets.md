...
The latest version of this topic can be found at [How to: Restore C# Refactoring Snippets](https://docs.microsoft.com/visualstudio/ide/how-to-restore-csharp-refactoring-snippets).  
