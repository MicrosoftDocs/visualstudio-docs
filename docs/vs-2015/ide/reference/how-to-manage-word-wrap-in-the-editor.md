...
The latest version of this topic can be found at [How to: Manage Word Wrap in the Editor](https://docs.microsoft.com/visualstudio/ide/reference/how-to-manage-word-wrap-in-the-editor).  
