...
|**Check Microsoft Update for more redistributable components**|Clicking this link takes you to the [Bootstrapper Packages to Redistribute Components](https://msdn.microsoft.com/vstudio/bb898654.aspx) website to check for updates.|
