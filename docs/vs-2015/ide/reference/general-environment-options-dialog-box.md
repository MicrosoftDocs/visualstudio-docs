...
The latest version of this topic can be found at [General, Environment, Options Dialog Box](https://docs.microsoft.com/visualstudio/ide/reference/general-environment-options-dialog-box).  
