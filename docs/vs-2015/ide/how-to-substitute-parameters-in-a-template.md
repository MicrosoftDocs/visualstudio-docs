...
The latest version of this topic can be found at [How to: Substitute Parameters in a Template](https://docs.microsoft.com/visualstudio/ide/how-to-substitute-parameters-in-a-template).  
