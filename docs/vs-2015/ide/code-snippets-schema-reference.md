...
The latest version of this topic can be found at [Code Snippets Schema Reference](https://docs.microsoft.com/visualstudio/ide/code-snippets-schema-reference).  
