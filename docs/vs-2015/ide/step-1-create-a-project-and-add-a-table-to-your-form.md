...
The latest version of this topic can be found at [Step 1: Create a Project and Add a Table to Your Form](https://docs.microsoft.com/visualstudio/ide/step-1-create-a-project-and-add-a-table-to-your-form).  
