...
-   A component that uses [!INCLUDE[net_v40_short](../includes/net-v40-short-md.md)] is incompatible with a project that targets the [!INCLUDE[net_v45](../includes/net-v45-md.md)].  
     ...
     When you create a new application, some projects target the [!INCLUDE[net_v45](../includes/net-v45-md.md)] by default. For more information, see [.NET Framework Client Profile](../Topic/.NET%20Framework%20Client%20Profile.md).  
