...
The latest version of this topic can be found at [Adding and Removing Project Items](https://docs.microsoft.com/visualstudio/ide/adding-and-removing-project-items).  
