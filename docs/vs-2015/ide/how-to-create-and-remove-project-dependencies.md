...
The latest version of this topic can be found at [How to: Create and Remove Project Dependencies](https://docs.microsoft.com/visualstudio/ide/how-to-create-and-remove-project-dependencies).  
