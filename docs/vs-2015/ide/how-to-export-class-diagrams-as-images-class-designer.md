...
The latest version of this topic can be found at [How to: Export Class Diagrams As Images (Class Designer)](https://docs.microsoft.com/visualstudio/ide/how-to-export-class-diagrams-as-images-class-designer).  
