...
The latest version of this topic can be found at [How to: Generate Templates from Templates By Using Escape Sequences](https://docs.microsoft.com/visualstudio/modeling/how-to-generate-templates-from-templates-by-using-escape-sequences).  
