...
The latest version of this topic can be found at [Programming with the UML API](https://docs.microsoft.com/visualstudio/modeling/programming-with-the-uml-api).  
