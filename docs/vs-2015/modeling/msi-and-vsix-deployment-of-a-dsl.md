...
## <a name="msi"></a> Deploying a DSL in an MSI
 ...
 To build an MSI, you add a Setup project to your [!INCLUDE[vsprvs](../includes/vsprvs-md.md)] solution. The easiest method of creating a Setup project is to use the CreateMsiSetupProject.tt template, which you can download from the [VMSDK site](https://docs.microsoft.com/samples/browse/?redirectedfrom=MSDN-samples).
...
4. Go to [Visualization and Modeling SDK home page](https://docs.microsoft.com/samples/browse/?redirectedfrom=MSDN-samples), and from the **Downloads** tab, download **CreateMsiSetupProject.tt**.
...
11. In the target computer, create a new file that has the file extension of your DSL. Verify that:
    ...
    If you prefer, you can create the Setup project manually, instead of using the text template. For a walkthrough that includes this procedure see Chapter 5 of the [Visualization and Modeling SDK Lab](https://docs.microsoft.com/samples/browse/?redirectedfrom=MSDN-samples).
