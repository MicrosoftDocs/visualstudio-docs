...
The latest version of this topic can be found at [How to: Add a Command to the Shortcut Menu](https://docs.microsoft.com/visualstudio/modeling/how-to-add-a-command-to-the-shortcut-menu).  
