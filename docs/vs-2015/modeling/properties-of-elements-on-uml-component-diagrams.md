...
The latest version of this topic can be found at [Properties of elements on UML component diagrams](https://docs.microsoft.com/visualstudio/modeling/properties-of-elements-on-uml-component-diagrams).  
