...
The latest version of this topic can be found at [Properties of elements on UML sequence diagrams](https://docs.microsoft.com/visualstudio/modeling/properties-of-elements-on-uml-sequence-diagrams).  
