...
The latest version of this topic can be found at [Debugging a T4 Text Template](https://docs.microsoft.com/visualstudio/modeling/debugging-a-t4-text-template).  
