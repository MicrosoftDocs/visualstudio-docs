...
The latest version of this topic can be found at [Add commands and gestures to dependency diagrams](https://docs.microsoft.com/visualstudio/modeling/add-commands-and-gestures-to-layer-diagrams).  
