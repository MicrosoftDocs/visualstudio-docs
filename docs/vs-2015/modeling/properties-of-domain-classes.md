...
The latest version of this topic can be found at [Properties of Domain Classes](https://docs.microsoft.com/visualstudio/modeling/properties-of-domain-classes).  
