...
## Enumerating Relationships
 All properties of the UML model that return multiple values conform to the IEnumerable<> interface. This means that you can use [Linq Query Expressions](/dotnet/csharp/linq/index) and the extension methods defined in the **System.Linq** namespace.
