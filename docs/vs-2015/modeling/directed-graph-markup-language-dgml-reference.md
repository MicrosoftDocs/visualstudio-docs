...
The latest version of this topic can be found at [Directed Graph Markup Language (DGML) reference](https://docs.microsoft.com/visualstudio/modeling/directed-graph-markup-language-dgml-reference).  
