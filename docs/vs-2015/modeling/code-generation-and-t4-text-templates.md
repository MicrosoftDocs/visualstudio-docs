...
The latest version of this topic can be found at [Code Generation and T4 Text Templates](https://docs.microsoft.com/visualstudio/modeling/code-generation-and-t4-text-templates).  
