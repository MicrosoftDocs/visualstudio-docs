...
The latest version of this topic can be found at [Adding Extensions to DSL Definitions](https://docs.microsoft.com/visualstudio/modeling/adding-extensions-to-dsl-definitions).  
