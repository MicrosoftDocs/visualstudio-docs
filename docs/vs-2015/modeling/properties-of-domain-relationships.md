...
The latest version of this topic can be found at [Properties of Domain Relationships](https://docs.microsoft.com/visualstudio/modeling/properties-of-domain-relationships).  
