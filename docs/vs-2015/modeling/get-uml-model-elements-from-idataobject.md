...
The latest version of this topic can be found at [Get UML model elements from IDataObject](https://docs.microsoft.com/visualstudio/modeling/get-uml-model-elements-from-idataobject).  
