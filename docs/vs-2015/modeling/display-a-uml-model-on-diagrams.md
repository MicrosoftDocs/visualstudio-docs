...
The latest version of this topic can be found at [Display a UML model on diagrams](https://docs.microsoft.com/visualstudio/modeling/display-a-uml-model-on-diagrams).  
