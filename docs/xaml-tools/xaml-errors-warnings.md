...
|C# Edit & Continue|XECxxxx| Visual Studio 2019 version 16.1 or lower |
|C# Hot Reload | XHRxxxx | Visual Studio 2019 version 16.2 or higher |

For more details on the rebranding of C# Edit & Continue as XAML Hot Reload see our [release notes](https://docs.microsoft.com/visualstudio/releases/2019/release-notes-v16.2#wpfuwp-tooling)
