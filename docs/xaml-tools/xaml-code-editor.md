...
- **Surround with...** - Use surround-with code snippets, which are added around a selected block of code. <br>See also: [Surround selected code with a snippet](../ide/code-snippets.md#surround-selected-code-with-a-snippet).
