...
description: Learn about the layout panels and controls in XAML Designer for arranging objects on a page, including Grid, Canvas, StackPanel, Viewbox, and more.
