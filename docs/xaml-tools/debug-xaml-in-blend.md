...
For more information about debugging your app, see [Debug UWP apps in Visual Studio](/visualstudio/debugger/debugging-windows-store-and-windows-universal-apps).
