...
description: Learn about the Visual Studio extensions in the Visual Studio SDK, including Visual Studio architecture, components, services, schemas, and utilities. 
