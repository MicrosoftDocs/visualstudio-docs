...
description: Learn how to filer the AddItem dialog box for a nested project in Visual Studio by implementing the IVsFilterAddProjectItemDlg interface of the parent project.
