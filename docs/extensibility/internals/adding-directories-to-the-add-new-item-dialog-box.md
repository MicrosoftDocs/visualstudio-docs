...
description: Learn how to add directories to the Add New Item dialog box by using a registry script to register them under the Projects subkey for Visual Studio.
