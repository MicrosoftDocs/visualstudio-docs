...
description: Learn how Visual Studio implements a coloring service in a legacy language service to identify elements of the language and display them in colors in an editor.
