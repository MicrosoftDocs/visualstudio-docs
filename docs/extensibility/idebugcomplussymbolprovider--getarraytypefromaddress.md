...
#### Parameters  
 `pAddress`  
 [in] The debug address represented by an [IDebugAddress](../extensibility/idebugaddress.md) interface.  
 ...
 `ppField`  
 [out] Returns the array type as represented by an [IDebugClassField](../extensibility/idebugclassfield.md) interface.  
