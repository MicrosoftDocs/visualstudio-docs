...
#### Parameters  
 ...
 `ppPortProcess`  
 [out] Returns an [IDebugPendingBreakpoint2](../extensibility/idebugpendingbreakpoint2.md) object that represents the launched process.  
  
## Return Value  
 If successful, returns `S_OK`; otherwise, returns an error code.  
  
## Remarks  
 This method should launch the process so that it is suspended and not running any code. The [ResumeProcess](../extensibility/idebugportex2--resumeprocess.md) method is called to resume the process.  
  
 A program can also be launched from a debug engine. For details, see [Launching a Program](../extensibility/launching-a-program.md).  
  
## See Also  
 [IDebugPortEx2](../extensibility/idebugportex2.md)   
 [IDebugPendingBreakpoint2](../extensibility/idebugpendingbreakpoint2.md)   
 [ResumeProcess](../extensibility/idebugportex2--resumeprocess.md)   
