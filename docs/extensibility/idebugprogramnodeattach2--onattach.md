...
---
# IDebugProgramNodeAttach2::OnAttach
Attaches to the associated program or defers the attach process to the [Attach](../extensibility/idebugengine2--attach.md) method.  
