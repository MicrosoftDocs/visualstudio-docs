...
### Example  
 This example shows an implementation of the \<xref:Microsoft.VisualStudio.Package.LanguageService.ValidateBreakpointLocation*> method that calls the parser to obtain the span of code (if any) at the specified location.  
