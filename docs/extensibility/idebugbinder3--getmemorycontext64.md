...
#### Parameters  
 `pField`  
 [in] An [IDebugField](../extensibility/idebugfield.md) that describes the object to locate. If `NULL`, then use `dwConstant` instead.  
...
## Example  
 The following examples creates an object that implements the [IDebugBinder3](../extensibility/idebugbinder3.md) interface and uses this method to retrieve the memory context.  
