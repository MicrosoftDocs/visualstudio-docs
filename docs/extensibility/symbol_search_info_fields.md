...
## Remarks  
 These flags are passed as a parameter to the [GetSymbolInfo](../extensibility/idebugmodule3--getsymbolinfo.md) method to determine the amount of information returned.  
