...
## Members  
 ...
 `pFuncPos`  
 The [IDebugFunctionPosition2](../extensibility/idebugfunctionposition2.md) object that describes the name of the function and the relative position from the beginning of the function.  
