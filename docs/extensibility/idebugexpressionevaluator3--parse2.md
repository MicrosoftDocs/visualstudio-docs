...
## Example  
 The following example shows how to implement this method for a **CEE** object that exposes the [IDebugExpressionEvaluator3](../extensibility/idebugexpressionevaluator3.md) interface.  
