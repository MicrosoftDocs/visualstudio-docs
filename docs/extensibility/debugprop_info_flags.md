...
## Members  
 ...
 DEBUGPROP_INFO_PROP,  
 Initialize/use the `pProperty` field that contains an [IDebugProperty2](../extensibility/idebugproperty2.md) interface.  
...
## Remarks  
 These values are passed to the [GetPropertyInfo](../extensibility/idebugproperty2--getpropertyinfo.md), [EnumChildren](../extensibility/idebugproperty2--enumchildren.md), and [EnumProperties](../extensibility/idebugstackframe2--enumproperties.md) methods to indicate which fields are to be initialized the [DEBUG_PROPERTY_INFO](../extensibility/debug_property_info.md) structure.  
