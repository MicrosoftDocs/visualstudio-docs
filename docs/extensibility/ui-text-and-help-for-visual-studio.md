...
#### Supplemental instructions  
 ...
 ![Supplemental text in Visual Studio](../extensibility/media/0601-b_supplementaltext1.png "0601-b_SupplementalText1")  
  
 **Supplemental text in Visual Studio**  
  
 ![Supplemental text in Visual Studio](../extensibility/media/0601-c_supplementaltext2.png "0601-c_SupplementalText2")  
...
#### InfoTips  
 ...
 ![InfoTip in Visual Studio](../extensibility/media/0601-d_infotip.png "0601-d_InfoTip")  
...
#### Control labels  
 ...
 For more information about control label format and placement within the UI, refer to [Layout for Visual Studio](../extensibility/layout-for-visual-studio.md).  
...
-   When launching dialogs, maintain the standards for ellipses: no ellipsis for navigation, ellipses if the task requires additional UI.  
     ...
     ![Help link in Visual Studio](../extensibility/media/0601-e_helplink.png "0601-e_HelpLink")  
...
-   In place of the control label:  
     ...
     ![Hint text in Visual Studio](../extensibility/media/0601-f_hinttext1.png "0601-f_HintText1")  
  
-   With a verb, giving instructions:  
  
     ![Hint text in Visual Studio](../extensibility/media/0601-g_hinttext2.png "0601-g_HintText2")  
  
-   With text indicating a required entry:  
  
     ![Hint text in Visual Studio](../extensibility/media/0601-h_hinttext3.png "0601-h_HintText3")  
...
#### Watermark text  
 ...
 ![Watermark text in Visual Studio](../extensibility/media/0601-i_watermarktext.png "0601-i_WatermarkText")  
...
|Good|Bad|  
|----------|---------|  
|“The number you dialed is no longer in service. Please check the number and dial again or dial 0 for the operator.”|-   “Error (449): Illegal number”<br />-   “This unhandled exception error indicates that the operation completed successfully.”<br /><br /> ![Bad error message in Visual Studio](../extensibility/media/0602-a_errordialog.png "0602-a_ErrorDialog")|  
...
#### Instructional and supplemental text in dialogs  
 In dialogs that support complex tasks, there might be a need to give instructional text within the UI, often at the top of the dialog or near complex controls. See [UI text and terminology](../extensibility/ui-text-and-help-for-visual-studio.md#BKMK_UITextAndTerminology) for details on writing style.  
...
#### Hyperlinks to Help topics  
 Hyperlinks can be used to perform an action, navigate within the IDE, or launch Help in a browser. See [UI text and terminology](../extensibility/ui-text-and-help-for-visual-studio.md#BKMK_UITextAndTerminology) for details on language and 07.10.01 Buttons and hyperlinks for visual and layout guidelines.  
