...
description: You may be able to attach a new document view to an existing document data object. Use this procedure to determine if you can attach the view.
