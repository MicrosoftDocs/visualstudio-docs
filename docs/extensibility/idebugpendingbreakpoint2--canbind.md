...
#### Parameters  
 `ppErrorEnum`  
 [out] Returns an [IEnumDebugErrorBreakpoints2](../extensibility/ienumdebugerrorbreakpoints2.md) object that contains a list of [IDebugErrorBreakpoint2](../extensibility/idebugerrorbreakpoint2.md) objects if there could be errors.  
...
## Remarks  
 This method is called to determine what would happen if this pending breakpoint was bound. Call the [Bind](../extensibility/idebugpendingbreakpoint2--bind.md) method to actually bind the pending breakpoint.  
