...
#### Parameters  
 ...
 `pSymbolProvider`  
 [in] The symbol provider expressed as an [IDebugSymbolProvider](../extensibility/idebugsymbolprovider.md) object.  
  
 `pAddress`  
 [in] An address within the method, expressed as an [IDebugAddress](../extensibility/idebugaddress.md) object.  
  
 `pBinder`  
 [in] The binder expressed as an [IDebugBinder](../extensibility/idebugbinder.md) object.  
  
 `ppProperty`  
 [out] Returns an [IDebugProperty2](../extensibility/idebugproperty2.md) interface that represents the memory address.  
