...
-   [Scrollbars](../extensibility/common-control-patterns-for-visual-studio.md#BKMK_Scrollbars)  
  
-   [Input fields](../extensibility/common-control-patterns-for-visual-studio.md#BKMK_InputFields)  
  
-   [Combo boxes and drop-down lists](../extensibility/common-control-patterns-for-visual-studio.md#BKMK_ComboBoxesAndDropDowns)  
  
-   [Check boxes](../extensibility/common-control-patterns-for-visual-studio.md#BKMK_CheckBoxes)  
  
-   [Radio buttons](../extensibility/common-control-patterns-for-visual-studio.md#BKMK_RadioButtons)  
  
-   [Group frames](../extensibility/common-control-patterns-for-visual-studio.md#BKMK_GroupFrames)  
...
-   [Tree views](../extensibility/common-control-patterns-for-visual-studio.md#BKMK_TreeViews)  
...
-   Error validation: See [Notifications and Progress for Visual Studio](../extensibility/notifications-and-progress-for-visual-studio.md)  
...
-   Input fields should be sized to fit the content, not to fit the width of the window in which they are shown, nor to arbitrarily match the length of a long field, such as a path. Length might be an indication to the user of limitations as to how many characters are allowed in the field.  
     ...
     ![Incorrect input field control width](../extensibility/media/0707-01_incorrectinputfieldcontrol.png "0707-01_IncorrectInputFieldControl")   
     **Incorrect input field length: It is unlikely that the name will be this long.**  
  
     ![Correct input field control width](../extensibility/media/0707-02_correctinputfieldcontrol.png "0707-02_CorrectInputFieldControl")   
...
#### Layout  
 ...
 ![Incorrect drop&#45;down layout](../extensibility/media/0707-03_incorrectdropdownlayout.png "0707-03_IncorrectDropDownLayout")  
  
 **Incorrect field length for a drop-down control**  
  
 ![Correct drop&#45;down layout](../extensibility/media/0707-04_correctdropdownlayout.png "0707-04_CorrectDropDownLayout")  
...
-   Align check boxes with the baseline of the first line of text.  
     ...
     ![Incorrect check box alignment](../extensibility/media/0707-05_incorrectcheckboxalign.png "0707-05_IncorrectCheckBoxAlign")   
     **Incorrect check box alignment: Check box is centered on the text.**  
  
     ![Correct check box alignment](../extensibility/media/0707-06_correctcheckboxalign.png "0707-06_CorrectCheckBoxAlign")   
...
-   In utility dialogs, labels should appear non-bold, in the standard environment font and text color. See [Fonts and Formatting for Visual Studio](../extensibility/fonts-and-formatting-for-visual-studio.md).  
...
#### Dynamic labels  
 ...
 ![Dynamic label used with dynamic content](../extensibility/media/070702-01_dynamiclabel.png "070702-01_DynamicLabel")  
...
##### Formatting  
 Instructional text should be Environment font, standard (non-themed) control text. See [Fonts and Formatting for Visual Studio](../extensibility/fonts-and-formatting-for-visual-studio.md).  
  
 For details on writing instructional text, see [UI text and terminology](../extensibility/ui-text-and-help-for-visual-studio.md#BKMK_UITextAndTerminology).  
  
 ![Instructional text formatting](../extensibility/media/070702-02_instructionaltextformatting.png "070702-02_InstructionalTextFormatting")  
...
##### Dynamic (context-specific) text  
 ...
 ![Dynamic information text](../extensibility/media/070702-03_informationaldynamictext.png "070702-03_InformationalDynamicText")  
...
##### Formatting  
 ...
 ![Informational text formatting for read&#45;only fields](../extensibility/media/070702-04_informationalformatting.png "070702-04_InformationalFormatting")  
...
-   If possible, include links in the watermark to help the user get started.  
 ...
 ![Watermark text in a designer window](../extensibility/media/070702-05_watermark1.png "070702-05_Watermark1")  
  
 ![Watermark text in a tool window](../extensibility/media/070702-06_watermark2.png "070702-06_Watermark2")  
...
#### Examples  
 ![Infobar command links following a status message](../extensibility/media/070703-01_commandlinkinfobar.png "070703-01_CommandLinkInfobar")  
  
 **Command links used in the InfoBar following a status message**  
  
 ![Links used in the CodeLens popup](../extensibility/media/070703-02_linksincodelens.png "070703-02_LinksInCodeLens")  
  
 **Links used in the CodeLens popup**  
  
 ![Links used as secondary commands](../extensibility/media/070703-03_linksassecondarycommands.png "070703-03_LinksAsSecondaryCommands")  
...
#### Text  
 Follow the writing guidelines in [UI text and terminology](../extensibility/ui-text-and-help-for-visual-studio.md#BKMK_UITextAndTerminology).  
...
##### Themed  
 In some instances, buttons may be used within styled UI and these buttons must be styled appropriately. See [Dialogs](../extensibility/application-patterns-for-visual-studio.md#BKMK_Dialogs) for information on themed controls.  
 ...
 **[Browse…]** buttons are used in grids, dialogs, and tool windows and other modeless UI elements. They display a picker that assists the user in filling a value into a control. There are two variations of this button, long and short.  
 ...
 ![Long &#91;Browse...&#93; button](../extensibility/media/070703-04_browselong.gif "070703-04_BrowseLong")  
  
 **The long [Browse…] button**  
  
 ![Short ellipsis&#45;only &#91;Browse...&#93; button](../extensibility/media/070703-05_browseshort.gif "070703-05_BrowseShort")  
...
##### Sizing and spacing  
 ![Sizing &#91;Browse...&#93; buttons](../extensibility/media/070703-06_browsesizing.png "070703-06_BrowseSizing")  
  
 **Sizing [Browse…] buttons**  
  
 ![Spacing &#91;Browse...&#93; buttons](../extensibility/media/070703-07_browsespacing.png "070703-07_BrowseSpacing")  
...
|||  
|-|-|  
|Add|![Graphical "Add" button](../extensibility/media/070703-08_buttonadd.png "070703-08_ButtonAdd")|  
|Remove|![Graphical "Remove" button](../extensibility/media/070703-09_buttonremove.png "070703-09_ButtonRemove")|  
|Add All|![Graphical "Add All" button](../extensibility/media/070703-10_buttonaddall.png "070703-10_ButtonAddAll")|  
|Remove All|![Graphical "Remove All" button](../extensibility/media/070703-11_buttonremoveall.png "070703-11_ButtonRemoveAll")|  
|Move Up|![Graphical "Move Up" button](../extensibility/media/070703-12_buttonmoveup.png "070703-12_ButtonMoveUp")|  
|Move Down|![Graphical "Move Down" button](../extensibility/media/070703-13_buttonmovedown.png "070703-13_ButtonMoveDown")|  
|Delete|![Graphical "Delete" button](../extensibility/media/070703-14_buttondelete.png "070703-14_ButtonDelete")|  
  
##### Sizing and spacing  
 Sizing for graphical buttons is the same as for the short version of the **[Browse…]** button (26x23 pixels):  
  
 ![Button with and without transparent color showing](../extensibility/media/070703-15_graphicalbuttonspacing.png "070703-15_GraphicalButtonSpacing")  
...
-   Hyperlinks should always use [The VSColor Service](../extensibility/colors-and-styling-for-visual-studio.md#BKMK_TheVSColorService). If a hyperlink is not styled correctly, it flashes red when active or shows a different color after being visited.  
...
-   [Visual style](../extensibility/common-control-patterns-for-visual-studio.md#BKMK_TreeViewVisualStyle)  
  
-   [Interactions](../extensibility/common-control-patterns-for-visual-studio.md#BKMK_TreeViewInteractions)  
...
#### Expanders  
 ...
 ![Correct tree view control](../extensibility/media/070705-1_treeviewcorrect.png "070705-1_TreeViewCorrect")  
  
 **Correct: proper style of tree view node using an expander control**  
  
 ![Incorrect tree view nodes](../extensibility/media/070705-2_treeviewincorrect1.png "070705-2_TreeViewIncorrect1")  
 ...
 **Correct: highlight of the selected node fits the entire width of the tree view control.**  
 ...
 ![Incorrect tree view highlighting](../extensibility/media/070705-3_treeviewincorrect2.png "070705-3_TreeViewIncorrect2")  
...
#### Scroll bars  
 ...
 ![Tree view with scroll bars](../extensibility/media/070705-4_scrollbars.png "070705-4_Scrollbars")  
...
#### Context menus  
 ...
 ![Selected tree node and context menu](../extensibility/media/070705-5_contextmenu.png "070705-5_ContextMenu")  
...
-   **Shift + Tab:** Navigates to the nearest cell on the left.  At the beginning of the row, navigation continues to the rightmost cell in the previous row.  
 ...
 ![Trid control in Visual Studio](../extensibility/media/070705-6_trid.png "070705-6_Trid")  
