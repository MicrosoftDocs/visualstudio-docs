...
## Members  
 BPREQI_BPLOCATION  
 Initialize/use the `bpLocation` (breakpoint location) field of the [BP_REQUEST_INFO](../extensibility/bp_request_info.md) or [BP_REQUEST_INFO2](../extensibility/bp_request_info2.md) structure.  
...
## Remarks  
 Passed as an argument to the [GetRequestInfo](../extensibility/idebugbreakpointrequest2--getrequestinfo.md) and [BP_REQUEST_INFO](../extensibility/bp_request_info.md) methods to specify which fields of the [BP_REQUEST_INFO](../extensibility/bp_request_info.md) and [BP_REQUEST_INFO2](../extensibility/bp_request_info2.md) structures are to be initialized.  
