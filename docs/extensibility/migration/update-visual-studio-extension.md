...
> [!IMPORTANT]
> The advice in this guide is intended to guide developers in migrating extensions that require significant changes to work both in Visual Studio 2019 and 2022 where having two projects and conditional compilation is the best path forward.
...
> We recommended you try your extension and evaluate what option is best for your extension.
