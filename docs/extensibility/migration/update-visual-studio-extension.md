...
> [!IMPORTANT]
> The advice in this guide is intended to guide developers in migrating extensions that require major changes to work both in Visual Studio 2019 and 2022. In those case we recommend modernizing the extension by having two VSIX projects and conditional compilation.
...
> We recommend you try your extension and evaluate what option is best for your extension.
