...
```  
 ...
 The [LoadSymbols](../extensibility/idebugengine3--loadsymbols.md) method performs the actual load of the symbols.  
  
## See Also  
 [LoadSymbols](../extensibility/idebugengine3--loadsymbols.md)   
