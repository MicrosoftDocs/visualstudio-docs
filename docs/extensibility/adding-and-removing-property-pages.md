...
description: Learn how to add and remove property pages in the Project Designer that provides a centralized location for managing project properties in Visual Studio. 
