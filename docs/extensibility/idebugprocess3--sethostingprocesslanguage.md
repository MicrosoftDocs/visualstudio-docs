...
## Remarks  
 [GetHostingProcessLanguage](../extensibility/idebugprocess3--gethostingprocesslanguage.md) can be used to retrieve the current language setting.  
  
## See Also  
 [IDebugProcess3](../extensibility/idebugprocess3.md)   
 [GetHostingProcessLanguage](../extensibility/idebugprocess3--gethostingprocesslanguage.md)