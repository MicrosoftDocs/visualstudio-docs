...
## Can I now install my extension assets to any locaion with VSIX v3?

No, the VSIX v3 `InstallRoot property` does not allow you to install anything outside the Visual Studio install folder structure. See the [Installing outside the extensions folder](set_install-root.md) topic for supported locations. 
