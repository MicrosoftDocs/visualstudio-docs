...
-   [To create the native and Windows Runtime libraries](../extensibility/walkthrough--creating-an-sdk-using-c--.md#createClassLibrary)  
  
-   [To create the NativeMathVSIX extension project](../extensibility/walkthrough--creating-an-sdk-using-c--.md#createVSIX)  
  
-   [To create a sample app that uses the class library](../extensibility/walkthrough--creating-an-sdk-using-c--.md#createSample)  
