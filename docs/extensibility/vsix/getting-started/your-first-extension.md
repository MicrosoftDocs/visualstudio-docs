...
> [!VIDEO https://www.microsoft.com/en-us/videoplayer/embed/RWPmjK]

Before you start writing your first Visual Studio extension (it's easy, I promise!), make sure you've got the [tools needed](get-the-tools.md).
