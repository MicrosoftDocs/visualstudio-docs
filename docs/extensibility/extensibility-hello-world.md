...
1. From the **File** menu, select **New** > **Project**. Search for "vsix" and select the Visual C# **VSIX Project** and then **Next**.
...
1. In **Solution Explorer**, find the VSCT file for your extension VS package. In this case, it will be called *HelloWorldPackage.vsct*.
