...
#### Parameters  
 `dataIn`  
 [in] An [IEEDataStorage](../extensibility/ieedatastorage.md) object holding the data to be copied.  
...
## Remarks  
 This method is given an [IEEDataStorage](../extensibility/ieedatastorage.md) object representing an array of bytes. This incoming data object is typically not implemented by the EE. However, the object returned by this method is always implemented by the EE, which lets the EE implement the `IEEDataStorage` interface on whatever class is desired.  
