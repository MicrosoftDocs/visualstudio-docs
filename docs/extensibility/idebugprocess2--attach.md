...
#### Parameters  
 `pCallback`  
 [in] An [IDebugEventCallback2](../extensibility/idebugeventcallback2.md) object that is used for debug event notification.  
...
## Remarks  
 ...
 All debug events that occur in the process are sent to the given [IDebugEventCallback2](../extensibility/idebugeventcallback2.md) object. This `IDebugEventCallback2` object is provided when the SDM calls this method.  
