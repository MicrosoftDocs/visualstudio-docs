...
description: The articles in this section describe complete interface specification that enables source control systems to be integrated with Visual Studio.
