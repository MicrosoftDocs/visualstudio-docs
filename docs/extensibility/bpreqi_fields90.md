...
#### Parameters  
 BPREQI90_BPLOCATION  
 Initialize or use the `bpLocation` (breakpoint location) field of the [BP_REQUEST_INFO](../extensibility/bp_request_info.md) or [BP_REQUEST_INFO2](../extensibility/bp_request_info2.md) structure.  
