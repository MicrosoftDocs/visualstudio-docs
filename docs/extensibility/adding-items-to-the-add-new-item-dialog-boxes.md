...
>  The GUIDS for the Visual C# and Visual Basic project types are as follows:[!INCLUDE[csprcs](../datatools/includes/csprcs_md.md)]: {FAE04EC0-301F-11D3-BF4B-00C04F79EFBC}[!INCLUDE[vbprvb](../codequality/includes/vbprvb_md.md)]: {F184B08F-C81C-45F6-A57F-5ABD9991F28F}  
 ...
 However, you do not have to have everything in one .vsdir file. You can have one .vsdir file for every item in the directory. For more information, see [Wizard (.Vsz) File](../extensibility/wizard--.vsz--file.md) and [Template Directory Description (.Vsdir) Files](../extensibility/template-directory-description--.vsdir--files.md).  
