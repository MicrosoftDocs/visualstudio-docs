...
# [Creating your First Extension: Hello World](extensibility-hello-world.md)
...
##[File Contexts](open-folder-file-contexts.md)
##[Indexing](open-folder-indexing.md)
...
### [Supporting EditorConfig](supporting-editorconfig.md)
...
### [VSIX Language Pack Schema 2.0 Reference](vsix-language-pack-schema-2-0-reference.md)
