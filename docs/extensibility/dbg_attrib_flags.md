...
---
# DBG_ATTRIB_FLAGS
Describes various attributes for an [IDebugProperty2](../extensibility/idebugproperty2.md) or an [IDebugReference2](../extensibility/idebugreference2.md) interface. Member of the [DEBUG_PROPERTY_INFO](../extensibility/debug_property_info.md) structure.  
