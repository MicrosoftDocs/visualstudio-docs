...
## Members  
 ...
 Starts seeking at the given code location identifier. Code location identifiers are obtained by calling [GetCurrentLocation](../extensibility/idebugdisassemblystream2--getcurrentlocation.md).  
  
## Remarks  
 Passed as an argument to the [Seek](../extensibility/idebugdisassemblystream2--seek.md) method.  
