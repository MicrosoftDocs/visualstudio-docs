...
```  
 ...
 We looked at the \<TemplateData> section in the [New Project Generation: Under the Hood, Part One](../extensibility/new-project-generation--under-the-hood--part-one.md). The tags in this section are used to control the appearance of the **New Project** dialog box.  
...
```  
 ...
 ![SimpleSolution](../extensibility/media/simplesolution.png "SimpleSolution")  
