...
description: Learn how to create a command group, which is a collection of commands that appear together on a menu or toolbar. Command groups typically contain buttons.
