...
[!NOTE] We are in the process of migrating the publishing experience to Visual Studio Marketplace.  In the meantime, please continue to use Visual Studio Gallery to publish your extensions.  Your extensions will appear in the Visual Studio Marketplace once it has been published.
