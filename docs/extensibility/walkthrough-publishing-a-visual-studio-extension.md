...
1. Ask member (that you want to add) to login their account on Marketplace and get the User Id. User Id will be visible by hovering over email. As shown in the image.
