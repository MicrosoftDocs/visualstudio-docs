...
4.  \<xref:Microsoft.VisualStudio.Package.ExpansionProvider.OnAfterInsertion*>  
 ...
 For more information on getting a list of installed code snippets for your language service, see [Walkthrough: Getting a List of Installed Code Snippets (Legacy Implementation)](../extensibility/walkthrough--getting-a-list-of-installed-code-snippets--legacy-implementation-.md).  
