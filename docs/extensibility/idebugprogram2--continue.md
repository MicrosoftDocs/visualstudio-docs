...
> [!NOTE]
>  This method is deprecated. Use the [Continue](../extensibility/idebugprocess3--continue.md) method instead.  
...
#### Parameters  
 `pThread`  
 [in] An [IDebugThread2](../extensibility/idebugthread2.md) object that represents the thread.  
