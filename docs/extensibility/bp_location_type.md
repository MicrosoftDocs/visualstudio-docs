...
## Remarks  
 Passed as a parameter to the [GetLocationType](../extensibility/idebugbreakpointrequest2--getlocationtype.md) method.  
 ...
 `BPT_CODE` and `BPT_DATA` are members of the [BP_TYPE](../extensibility/bp_type.md) enumeration.  
...
## See Also  
 ...
 [GetLocationType](../extensibility/idebugbreakpointrequest2--getlocationtype.md)   
