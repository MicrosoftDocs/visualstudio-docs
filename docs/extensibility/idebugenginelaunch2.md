...
|Method|Description|  
|------------|-----------------|  
|[LaunchSuspended](../extensibility/idebugenginelaunch2--launchsuspended.md)|Launches a process by means of the DE.|  
|[ResumeProcess](../extensibility/idebugenginelaunch2--resumeprocess.md)|Resumes process execution.|  
|[CanTerminateProcess](../extensibility/idebugenginelaunch2--canterminateprocess.md)|Determines if a process can be terminated.|  
|[TerminateProcess](../extensibility/idebugenginelaunch2--terminateprocess.md)|Terminates a process.|  
