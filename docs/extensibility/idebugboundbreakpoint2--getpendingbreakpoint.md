...
#### Parameters  
 `ppPendingBreakpoint`  
 [out] Returns the [IDebugPendingBreakpoint2](../extensibility/idebugpendingbreakpoint2.md) object that represents the pending breakpoint that was used to create this bound breakpoint.  
