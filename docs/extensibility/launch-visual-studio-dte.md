...
description: Learn how to launch Visual Studio 2019 using DTE to support side-by-side installations of major releases. This article includes a code example.
