...
|[Legacy interfaces in the editor](../vs-2015/extensibility/legacy-interfaces-in-the-editor.md?view=vs-2015)|Links to documents that explain how to access the core editor from existing code.|
