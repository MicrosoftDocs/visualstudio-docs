...
description: You can extend most features of the Visual Studio code editor, which is based on the Windows Presentation Foundation and is written in managed code.
