...
## Methods  
 In addition to the methods on the [IDebugAlias](../extensibility/idebugalias.md) interface, this interface implements the following method:  
  
|Method|Description|  
|------------|-----------------|  
|[GetAppDomainId](../extensibility/idebugalias2--getappdomainid.md)|Retrieves the identifier for the application domain.|  
