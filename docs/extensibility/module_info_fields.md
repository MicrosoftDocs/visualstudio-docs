...
## Members  
 ...
 MIF_NAME  
 Initialize/use the `m_bstrName` field in the [MODULE_INFO](../extensibility/module_info.md) structure.  
...
## Remarks  
 These values are passed as an argument to the [GetInfo](../extensibility/idebugmodule2--getinfo.md) method to indicate which fields of the [MODULE_INFO](../extensibility/module_info.md) structure are to be initialized.  
