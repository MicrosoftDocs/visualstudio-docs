...
- [Query the project API (VisualStudio.Extensibility)](#query-the-project-api-visualstudioextensibility)
  - [Work with the project query API](#work-with-the-project-query-api)
  - [Access the project query space](#access-the-project-query-space)
    - [Using VisualStudio.Extensibility](#using-visualstudioextensibility)
    - [Using a service broker](#using-a-service-broker)
  ...
  - [Specify the project parameters to be included in the query result](#specify-the-project-parameters-to-be-included-in-the-query-result)
    - [`With` clauses for each parameter](#with-clauses-for-each-parameter)
    - [Single `With` clause to specify multiple parameters](#single-with-clause-to-specify-multiple-parameters)
    - [Example using a `WithRequired` clause](#example-using-a-withrequired-clause)
  - [Filter the query result](#filter-the-query-result)
    - [`Where` statements](#where-statements)
    - [Query methods with built-in filtering](#query-methods-with-built-in-filtering)
      - [`RuleResultsByRuleName` statement](#ruleresultsbyrulename-statement)
      - [`ProjectsByCapabilities` statement](#projectsbycapabilities-statement)
  ...
  - [Modify a project](#modify-a-project)
    - [Example of adding a file to a project in a query result](#example-of-adding-a-file-to-a-project-in-a-query-result)
    - [Example renaming a project](#example-renaming-a-project)
  ...
  - [Query for projects that own a specific source file](#query-for-projects-that-own-a-specific-source-file)
    - [Example of finding projects that own a given file](#example-of-finding-projects-that-own-a-given-file)
    - [Example of finding solution folders that contain a given file](#example-of-finding-solution-folders-that-contain-a-given-file)
  ...
  - [Query for project-to-project references](#query-for-project-to-project-references)
    - [Example of finding all projects referenced by the current project](#example-of-finding-all-projects-referenced-by-the-current-project)
    - [Example of finding all projects referencing the current project](#example-of-finding-all-projects-referencing-the-current-project)
  - [Query for package references](#query-for-package-references)
    - [Example of finding all packages referenced by the current project](#example-of-finding-all-packages-referenced-by-the-current-project)
    - [Example of finding all projects referencing a specific NuGet package](#example-of-finding-all-projects-referencing-a-specific-nuget-package)
  - [Query for project output groups](#query-for-project-output-groups)
  - [Query for startup projects](#query-for-startup-projects)
    - [Action to set the startup project](#action-to-set-the-startup-project)
  - [Query for solution configurations](#query-for-solution-configurations)
    - [Example of adding a solution configuration](#example-of-adding-a-solution-configuration)
    - [Example of deleting a solution configuration](#example-of-deleting-a-solution-configuration)
  ...
  - [Action query to build solutions/projects](#action-query-to-build-solutionsprojects)
    - [Building the solution level](#building-the-solution-level)
    - [Building on the project level](#building-on-the-project-level)
  - [Action query to save solutions/projects](#action-query-to-save-solutionsprojects)
    - [Saving on the solution level](#saving-on-the-solution-level)
    - [Saving on the project level](#saving-on-the-project-level)
