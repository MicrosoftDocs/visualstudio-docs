...
description: Learn about a debug session, which is all processes, related or unrelated, that have been launched or attached to from a single instance of the IDE.
