...
description: Learn how the Common Language Runtime interacts with the debug engine and how to integrate proprietary a programming language into the Visual Studio IDE.
