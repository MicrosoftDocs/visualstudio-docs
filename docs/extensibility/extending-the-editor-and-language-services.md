...
|[Adapt legacy code to the editor](../vs-2015/extensibility/adapting-legacy-code-to-the-editor.md?view=vs-2015)|Explains different ways to adapt legacy code (pre-Visual Studio 2010) to extend the editor.|
