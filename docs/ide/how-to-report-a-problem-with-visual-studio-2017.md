...
## Sign in to Visual Studio
 If you haven't already done so, you'll want to sign in to Visual Studio before you report a problem. That way, not only can you report a problem that you're experiencing, but you can also vote or comment on it or on any other problem that you see posted, too. Here's how.

  1. Click the Sign In icon that appears on the left-hand side of the tool.
