...
2.  Choose the Visual Basic or the Visual C# **WPF App** template by choosing the **Installed** > **Visual C#** or **Visual Basic** > **Windows Classic Desktop** category, and then choosing the **WPF App (.NET Framework)** template.  Name the project `HelloWPFApp` at the bottom of the **New Project** dialog.
