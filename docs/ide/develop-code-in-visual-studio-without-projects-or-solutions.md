...
1. On the Visual Studio menu, choose **Debug**. On the drop-down menu, choose the project or file that you want to display as the startup item in Solution Explorer.
...
#### <a name="buildtask"/>To create a custom build task
...
#### <a name="arbitrary"/>Define arbitrary tasks in tasks.vs.json
