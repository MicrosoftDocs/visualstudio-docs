...
titleSuffix: ''
description: Learn about Visual Studio's support of Federal Information Processing Standard (FIPS) Publication 140-2 approved mode of operation for Windows, Azure, and .NET.
