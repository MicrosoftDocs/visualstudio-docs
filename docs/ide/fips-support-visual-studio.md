...
When you enable FIPS mode in Windows, it makes the operating system and its subsystems use only FIPS-validated cryptographic algorithms. Enabling FIPS mode also causes the .NET Framework to disallow the use of non-validated algorithms.
