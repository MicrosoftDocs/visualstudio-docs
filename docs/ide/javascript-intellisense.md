...
> [!NOTE]
> The JavaScript language service in [!include[vs_dev15](../misc/includes/vs_dev15_md.md)] uses a new engine for the language service (called "Salsa"). Details are included in this topic, and you can also read this [blog post](https://devblogs.microsoft.com/visualstudio/more-productive-javascript-in-visual-studio-2017-rc/). The new editing experience also mostly applies to Visual Studio Code. See the [VS Code docs](https://code.visualstudio.com/docs/languages/javascript) for more info.
