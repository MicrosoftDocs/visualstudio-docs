---
title: Find Command
description: Learn about the Find command and how it searches files using a subset of the options available on the Find in Files tab of the Find and Replace window.
