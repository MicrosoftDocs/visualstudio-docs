...
- *SolnConfigName*
  ...
  Optional. The name of the solution configuration to be used to build the solution named in *SolutionName*. If this argument is unspecified or an empty string (`""`), the tool uses the solution's active configuration.
