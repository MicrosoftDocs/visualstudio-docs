...
1. Highlight the name of the class to perform the action on, or just put the text cursor somewhere in the class name.
   ...
   ![Highlighted code](media/extractinterface-highlight-cs.png)
...
1. Click **OK**.
   ...
   ![Resulting Class](media/extractinterface-class-cs.png)
   ![Resulting Interface](media/extractinterface-interface-cs.png)
