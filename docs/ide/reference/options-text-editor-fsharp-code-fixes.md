...
- **Remove unused open statements**
  ...
  If this check box is selected, documents are analyzed for unused `open` declarations, and a [Quick Action](../ide/quick-actions.md) light bulb appears with an action to remove all unused `open` declarations.
