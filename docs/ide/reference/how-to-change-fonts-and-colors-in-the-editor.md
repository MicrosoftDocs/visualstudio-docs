...
To learn more about the fonts and colors changes you can make to the IDE by using the Options dialog box, see the [Fonts and Colors, Environment, Options Dialog Box](../../ide/reference/fonts-and-colors-environment-options-dialog-box.md) page.
