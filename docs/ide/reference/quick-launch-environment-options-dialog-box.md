...
description: Learn how to use the Quick Launch page in the Environment section to quickly search and execute actions for IDE assets such as options, templates, menus.
