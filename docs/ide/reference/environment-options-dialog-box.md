...
ms.workload:
  - "multiple"
---
# Options dialog box: Environment

You can use the pages in the **Environment** folder in the **Options** dialog box to set how certain elements of the integrated development environment (IDE) display and behave. You can access the Environment pages by choosing **Tools** > **Options**, and then selecting **Environment**.
...
|To specify whether to roam settings across machines.|[Accounts, Environment, Options Dialog Box](../../ide/reference/accounts-environment-options-dialog-box.md)|
...
|Customize how updates occur and how extensions are managed.|[Extensions, Environment, Options Dialog Box](../../ide/reference/extensions-and-updates-environment-options-dialog-box.md)|
