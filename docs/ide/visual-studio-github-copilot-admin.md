...
2. Open the **Windows Local Group Policy Editor**, Navigate to Computer Configuration > Administrative Templates > Visual Studio > **Copilot Settings** and select a group policy.
   ...
   :::image type="content" source="media/vs-2022/copilot-inbox/intune-Group-Poilcy.png" alt-text="Screenshot of opilot Settings in Group Policy Editor" lightbox="media/vs-2022/copilot-inbox/intune-Group-Poilcy.png":::
