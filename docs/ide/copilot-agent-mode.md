...
+ [Visual Studio 2022 version 17.14](/visualstudio/releases/2022/release-history) or later include the Copilot Agent.
...
![Copilot Agent Tool Selector](./media/vs-2022/copilot-agent/copilot-agent-tools.png)
...
![Copilot Agent Command Approval](./media/vs-2022/copilot-agent/copilot-agent-command-approval.png)
...
![Copilot Agent List of Changes](./media/vs-2022/copilot-agent/copilot-agent-keep-undo.png)
...
![Accessing individual edit diff with Copilot Agent](./media/vs-2022/copilot-agent/copilot-agent-stepwise-diff.png)

![Accessing cumulative edit diff with Copilot Agent](./media/vs-2022/copilot-agent/copilot-agent-cumulative-diff.png)
...
![Copilot Agent List of Changes](./media/vs-2022/copilot-agent/copilot-agent-checkpoint.png)
