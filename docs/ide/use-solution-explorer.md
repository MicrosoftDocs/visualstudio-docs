...
Starting with the Visual Studio 2022 version [17.7](/visualstudio/releases/2022/release-notes-v17.7) release, you can now select two files in Solution Explorer and compare them by using the new **Compare Selected** option.
...
- Right-click a single file (`File1`) and then select the **Select for Compare** option from the context menu. Then, navigate to the second file (`File2`) in Solution Explorer, right-click the second file, and press **Compare with File1**.
