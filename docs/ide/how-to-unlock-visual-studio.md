...
To unlock Visual Studio using a Visual Studio subscription or Azure DevOps Services organization associated with a Microsoft account, or a work or school account:
...
1. Enter the credentials for either a Microsoft account or a work or school account. Visual Studio finds a Visual Studio subscription or Azure DevOps Services organization associated with your account.
