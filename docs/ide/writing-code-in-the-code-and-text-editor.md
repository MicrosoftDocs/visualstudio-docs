...
For more information about customizing the editor, see [Customizing the editor](../ide/customizing-the-editor.md). For JavaScript-specific editor options, see [JavaScript editor options](../ide/reference/options-text-editor-javascript-formatting.md).
