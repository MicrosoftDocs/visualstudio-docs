...
|||
|-|-|
|[Format Document](code-styles-and-quick-actions.md#apply-code-styles)|Sets the proper indentation of lines of code and moves curly braces to separate lines in the document.|
