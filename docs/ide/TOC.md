...
## [Quickstart: Coding in the Editor](quickstart-editor.md)
...
### [Quickstart: Create a Windows Forms app with Visual Basic](../ide/quickstart-visual-basic.md)
...
#### [Code Style Preferences](code-styles-and-quick-actions.md)
...
### [.NET Language and Formatting Conventions for EditorConfig](editorconfig-code-style-settings-reference.md)
