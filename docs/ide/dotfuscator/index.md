...
* *[Anti-rooted device][root]* to detect if the application is running on a rooted Android device, transmit incident alerts, and terminate sessions on these devices.
