...
This page details how to obtain Dotfuscator Community Edition (Dotfuscator CE) via the Visual Studio 2017 Installer, so that you can begin protecting your application.
...
If you have already installed Visual Studio 2017, you can access the installer in the following way:

1. Open the Start Menu.
2. Select *All apps*.
3. From the list of apps, select *Visual Studio Installer*.
4. The Visual Studio installer opens. Under **Installed**, locate the edition to modify, and click *Modify*.

![](media/install_ui.png)

In either event, the installer will display installation options for the selected Visual Studio edition.
...
5. When ready to install or modify your installation, click the *Install* or *Modify* button.
