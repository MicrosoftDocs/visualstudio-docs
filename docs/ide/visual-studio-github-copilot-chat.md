...
See [tips to improve Copilot chat](copilot-chat-context.md) results to learn how to use [slash commands](copilot-chat-context.md#use-slash-commands-in-copilot-chat-for-common-tasks), [references](copilot-chat-context.md#reference-scope-copilot-results-to-a-particular-file-or-entire-solution), [sources used](copilot-chat-context.md#review-the-sources-used-by-copilot-chat), and [threads](copilot-chat-context.md#organize-isolate-chats-with-copilot-into-threads) to get better answers with scoped context in Copilot Chat.
