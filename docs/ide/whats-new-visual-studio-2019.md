...
Visual Studio is constantly changing to meet the demands of developers. Join us for a tour of some of the newest features, and a sneak peek at what's to come in the following video from the **[Microsoft Build](https://mybuild.microsoft.com/)** conference library:</br>

> [!VIDEO https://channel9.msdn.com/Events/Build/2020/BOD111/player]</br>
