...
**New in 16.9**: By using cloud-powered technology, artificial intelligence, and machine learning, we've improved our search results. Not only does search in Visual Studio produce more relevant results, but it can also help you discover product features more easily.
