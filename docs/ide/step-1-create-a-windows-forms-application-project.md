...
3. In the templates list, choose **Windows Forms App (.NET Framework)**. Name the new form **PictureViewer**, and then choose the **OK** button.
    ...
    >[!NOTE]
    >If you don't see the **Windows Forms App (.NET Framework)**, use the Visual Studio Installer to install the **.NET desktop development** workload.<br/><br/>![.NET desktop development workload in the Visual Studio Installer](../ide/media/dot-net-desktop-dev-workload)<br/><br/> For more information, see the [Install Visual Studio 2017](./install/install-visual-studio.md) page.
