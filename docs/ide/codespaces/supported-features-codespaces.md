...
> [!NOTE]
> If there is a feature you are missing while using codespaces with Visual Studio, please let us know by opening an issue on https://aka.ms/feedback/report?space=8. This helps us prioritize the most wanted features.
