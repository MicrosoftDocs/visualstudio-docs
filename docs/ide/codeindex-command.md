...
To use the **CodeIndex** command, you must be a member of the **Team Foundation Administrators** security group. See [Permissions and groups defined for Azure DevOps](/vsts/organizations/security/permissions?view=vsts).
