...
|------------------|---------------------|
|`CollectionName`|Specifies the name of the Azure DevOps Project collection. If the name has spaces, enclose the name with quotation marks, for example, "Fabrikam Website".|
|`CollectionId`|Specifies the identification number of the Azure DevOps Project collection.|
...
|**/collectionName:** `CollectionName`|Specifies the name of the Azure DevOps Project collection on which to run the **CodeIndex** command. Required if you don't use **/CollectionId**.|
|**/collectionId:** `CollectionId`|Specifies the identification number of the Azure DevOps Project collection on which to run the **CodeIndex** command. Required if you don't use **/CollectionName**.|
