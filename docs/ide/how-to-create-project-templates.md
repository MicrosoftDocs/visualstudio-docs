...
>[!NOTE]
> To find your template in the **New Project** dialog box, expand **Installed** and then expand the category that corresponds to the `ProjectType` element in the .vstemplate file. For example, a .vstemplate file that contains `<ProjectType>CSharp</ProjectType>` will appear under **Installed** > **Visual C#**, by default. You can organize your template into a subdirectory of the project type just by creating a folder in that directory and placing your template's .zip file in it. For more information, see [How to: locate and organize templates](../ide/how-to-locate-and-organize-project-and-item-templates.md).

## Other ways to create project templates

You can also create project templates manually by gathering the files that will constitute the project into a folder, and then creating a .vstemplate XML file with the appropriatemetadata. For more information, see [How to: Manually create web templates](../ide/how-to-manually-create-web-templates.md).
