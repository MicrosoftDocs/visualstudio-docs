...
## In This Section  
 [How to: Add Class Diagrams to Projects](how-to-add-class-diagrams-to-projects.md)  
 ...
 [How to: Add Comments to Class Diagrams](how-to-add-comments-to-class-diagrams.md)  
  
 Describes how to add comments to a class diagram.  
  
 [To delete a type shape and its underlying code](how-to-customize-class-diagrams.md#DeleteTypeShapeAndCode)  
