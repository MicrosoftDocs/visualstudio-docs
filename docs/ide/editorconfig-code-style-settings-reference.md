...
> - Code style preferences for Visual Studio can also be set in the [Text editor options](code-styles-and-quick-actions.md) dialog. However, .editorconfig settings take precedence, and any preferences you set in **Options** are only applicable to your Visual Studio account.
