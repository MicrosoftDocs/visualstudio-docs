...
description: Learn how to add an <xref:System.Windows.Forms.OpenFileDialog> dialog component and a <xref:System.Windows.Forms.ColorDialog> dialog component to your form.
