...
You can specify the location of output generated by your project on a per-configuration basis (for debug, release, or both). With defalt settings, output folders vary by project type and SDK, with some projects using platform-specific or framework-specific subfolders.
...
1. Expand the **Build** section and scroll down to the **Output** subsection.
