...
> [!TIP]
>  Solutions have a few properties, and so do project items; these properties are accessed in the [Properties Window](../reference/properties-window.md), not **Project Designer**.  
...
### C# and Visual Basic projects  
 ...
 For information about each of the property pages in Project Designer, see [Project Properties Reference](../reference/project-properties-reference.md).  
...
### C++ and JavaScript projects  
 ...
 For information about C++ project properties, see [Working with Project Properties](../Topic/Working%20with%20Project%20Properties.md). For more information about JavaScript properties, see [Property Pages, JavaScript](../reference/property-pages--javascript.md).  
