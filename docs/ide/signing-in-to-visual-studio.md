...
> [!NOTE]
> This topic applies to Visual Studio on Windows. For Visual Studio for Mac, see [Activation for Visual Studio for Mac](/mac/activation).
...
* [Activation (Visual Studio for Mac)](/mac/activation)