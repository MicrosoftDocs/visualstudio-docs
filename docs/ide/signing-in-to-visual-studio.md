...
You can remove any of the multiple accounts you've added to Visual Studio. When you remove an account, you're signed out of Visual Studio and any resources associated with that account are no longer available.
