...
To authenticate and access Azure resources from Visual Studio, sign in to Visual Studio with an account that has access to the Azure resources and select this account for Azure Service Authentication in **Tools** > **Options** > **Azure Service Authentication** > **Account Selection**.
