...
|---------------------------|:--------------------:|:-----------------:|
| Available as | [Built-in by default in all workloads](visual-studio-github-copilot-install-and-states.md) & available through the Visual Studio Installer with Visual Studio version 17.10 Preview 3 | Built-in by default in most [workloads](../install/modify-visual-studio.md#change-workloads-or-individual-components) & available through the Visual Studio Installer |
