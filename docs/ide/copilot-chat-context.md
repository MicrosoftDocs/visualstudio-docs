...
2. Enable the feature in Visual Studio from the **Tools** > **Options** dialog. Expand the **GitHub** > **Copilot** > **Copilot Chat** section and select the **Enable custom instructions to be loaded from .github/copilot-instructions.md files and added to requests** checkbox.
