...
||Debug applications that a run under a different user account, such as ASP.NET websites.|[Debug ASP.NET and AJAX applications](/visualstudio/debugger/how-to-enable-debugging-for-aspnet-applications)|
