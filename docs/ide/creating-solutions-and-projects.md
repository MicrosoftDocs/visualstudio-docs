...
You can use the right-click context menu option, **Remove**, to remove a solution and its contents within Visual Studio, but that only removes them from the current solution or project.
