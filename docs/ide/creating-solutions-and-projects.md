...
You can use the right-click context menu to either delete or remove a solution, project, or item in Visual Studio, but that only removes them from the current solution or project.
