...
### Project References  
 ...
 If you choose to retarget [!INCLUDE[win81](../debugger/includes/win81_md.md)] projects to Windows 10, see [Porting, Migrating, and Upgrading Visual Studio Projects](../porting/port-migrating-and-upgrading-visual-studio-projects.md)  
