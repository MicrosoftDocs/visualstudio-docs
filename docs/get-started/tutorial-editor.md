...
1. To accept the suggestion, select **Tab**.
  ...
  :::image type="content" source="media/vs-2022/tutorial-editor/github-copilot-suggestions-visual-studio.gif" alt-text="Animated screenshot that shows the code suggestions generated by GitHub Copilot for the user comment." lightbox="media/vs-2022/tutorial-editor/github-copilot-completions-visual-studio.gif":::

Get started with [GitHub Copilot in Visual Studio](../ide/visual-studio-github-copilot-extension.md). Note that it requires Visual Studio 2022 17.5.5 or later. 
