...
1. Open Visual Studio.
    ...
    ::: moniker range=">=vs-2019"
    Type **Ctrl + Q** to open the search box, type **visual basic**, choose **Templates**, then choose **Create new Console App (.NET Framework) project**. In the dialog box that appears, choose **Create**.
    ::: moniker-end
    ::: moniker range="vs-2017"
