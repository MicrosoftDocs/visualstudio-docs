...
When you publish your cloud service from Visual Studio, you can profile the service and specify the profiling settings that give you the information that you want. A profiling session is started for each instance of a role. For more information about how to publish your service from Visual Studio, see [Publishing to Azure Cloud Services (extended support) from Visual Studio](vs-azure-tools-publishing-a-cloud-service.md).
...
[Publishing to Azure Cloud Services (extended support) from Visual Studio](vs-azure-tools-publishing-a-cloud-service.md)
