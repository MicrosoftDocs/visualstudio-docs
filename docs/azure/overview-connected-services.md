...
|-|-|-|
| [OpenAPI](https://github.com/OAI/OpenAPI-Specification) endpoints | N/A | A standard format for describing the capabilities of a service in computer-readable and human-readable form. |
