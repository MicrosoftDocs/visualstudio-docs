...
Windows 8 and later is required to run profiling tools with the debugger (**Diagnostic Tools** window). On Windows 7 and later, you can use the [post-mortem tools]((../profiling/profiling-feature-tour.md)).
