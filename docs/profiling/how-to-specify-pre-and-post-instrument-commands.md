...
- For 32-bit applications, the default profiler tools directory is `*Drive*\Program Files (x86)\Microsoft Visual Studio 10.0\Team Tools\Performance Tools`
- For 64-bit applications, the default profiler tools directory is `*Drive*\Program Files (x86)\Microsoft Visual Studio 10.0\Team Tools\Performance Tools\x64`
