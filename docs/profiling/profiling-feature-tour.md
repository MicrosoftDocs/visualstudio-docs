...
> [!TIP]
> To help analyze performance, you can also use [PerfTips](#Examine-performance-events) to step through code and identify how long it takes particular functions or code blocks to complete.
