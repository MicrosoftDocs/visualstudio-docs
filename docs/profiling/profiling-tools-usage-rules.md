...
|||  
|-|-|  
|[DA0002: VSPerfCorProf.dll is missing](../profiling/da0002--vsperfcorprof.dll-is-missing.md)|Command line profiling might contain incomplete data for [!INCLUDE[dnprdnshort](../codequality/includes/dnprdnshort_md.md)] binaries. This might be caused by not setting the correct environment variables.|  
