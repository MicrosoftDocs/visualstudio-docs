...
The CPU usage tool has [new visualizations](../Topic/Beginners%20Guide%20to%20Performance%20Profiling.md) to help you identify the functions that are most likely to be causing performance issues.
