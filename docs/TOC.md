...
##### [Ports & protocols to open when you use Visual Studio or Azure Services](install/visual-studio-and-azure-services-ports-and-protocols.md)
##### [Troubleshooting network errors when you install or use Visual Studio](install/troubleshooting-network-errors.md)
