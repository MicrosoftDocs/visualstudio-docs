...
##### [Viewing Type and Member Definitions](ide/go-to-and-peek-definition.md)
...
#### [Develop without projects or solutions](ide/develop-code-in-visual-studio-without-projects-or-solutions.md)
...
#### [View change history with CodeLens](ide/find-code-changes-and-other-history-with-codelens.md)
