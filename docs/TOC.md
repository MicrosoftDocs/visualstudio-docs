...
##### [.NET Language and Formatting Conventions for EditorConfig](ide/editorconfig-code-style-settings-reference.md)
...
### [Refactorings for Visual Basic](ide/reference/refactoring-vb.md)
...
## [Code Generation](ide/reference/code-generation.md)
