...
description: Create and debug a basic Node.js application that uses the Express web application framework in Visual Studio, and explore the launch.json file.
ms.date: 01/18/2023
