...
Lastly, you will need to be sure the port numbers match. Go to the **launchSettings.json** file in your .NET Core project. Get the port number from the *applicationUrl* property. (It should look something like *https://localhost:7049*)

Now, go to your *setupProxy.js* file your React project (look in the src folder). Update the target property to match the *applicationUrl* property seen in the **launchSettings.json**.
