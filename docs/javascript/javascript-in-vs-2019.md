...
* [The TypeScript npm package](https://www.npmjs.com/package/typescript). When the NuGet package for TypeScript 2.1 or higher is installed into your project, the corresponding version of the TypeScript language service gets loaded in the editor.
