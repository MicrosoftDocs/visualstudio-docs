...
| **Web launcher**               | Starts your default browser on launch and enables debugging of templates. See the [Web template debugging](python-web-application-project-templates.md#debugging-options) section for more information.                                                                                                                                                                                                                                                                         |
