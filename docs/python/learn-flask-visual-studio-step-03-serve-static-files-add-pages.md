...
- For  details on using `url_for`, see [url_for]([https://flask.palletsprojects.com/en/1.0.x/api/#flask.url_for](https://flask.palletsprojects.com/en/2.3.x/#api-reference)) within the Flask Application object documentation (flask.pocoo.org)
