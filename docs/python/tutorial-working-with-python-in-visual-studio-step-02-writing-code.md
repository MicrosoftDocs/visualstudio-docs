...
1. When you run the program, a console window appears to display the results, as if you'd run a Python interpreter with *PythonApplication1.py* from the command line. Press any key to close the window and return to the Visual Studio editor.
