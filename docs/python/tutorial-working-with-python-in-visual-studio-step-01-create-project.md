...
1. To view Python templates, search for *python*. Search is a great way to find a template when you can't remember its location in the languages tree.
   ...
   Python web support in Visual Studio includes several project templates, such as web applications in the Bottle, Flask, and Django frameworks. When installing Python with the Visual Studio Installer, check Python Web Suport in the optional column to install these templates. For this tutorial, start with an empty project.
