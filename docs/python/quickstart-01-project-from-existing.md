...
Once you've [installed Python support in Visual Studio 2017](quickstart-01-install.md), it's easy to bring existing Python code into a Visual Studio project. 
