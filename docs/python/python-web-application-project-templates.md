...
| | Django | Generates a Django project with the core Django site structure but no Django apps. For more information, see [Learning Django Step 1](learning-django-in-visual-studio-step-01-project-and-solution.md). |
...
| | Django | Generates a Django project and a Django app with three pages, authentication support, and a SQLite database (but no data models). For more information, see [Learning Django Step 4](learning-django-in-visual-studio-step-04-full-django-project-template.md). |
...
| | Django | Generates a Django project and a Django app with three pages and a SQLite database. Includes customizations to the Django administrative interface to allow an authenticated administrator to create and manage polls. For more information, see [Learning Django Step 6](learning-django-in-visual-studio-step-06-polls-django-web-project-template.md). |
