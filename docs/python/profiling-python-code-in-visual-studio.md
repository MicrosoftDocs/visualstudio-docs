...
> [!Note]
> At present, Visual Studio supports only this performance-timing aspect of full-application profiling, but we certainly want to hear your feedback on future capabilities. Use the **Product feedback** button at the bottom of this page.
