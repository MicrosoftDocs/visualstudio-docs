...
| Web Projects including Bottle, Django, Flask, and Flask/Jade | Projects for web servers based on various frameworks. See [Web Project Template](template-web.md) and [Django Web Project Template](template-django.md) for details, along with the following tutorials:<ul><li>[Bottle and Azure Table Storage on Azure](tutorial-bottle-azure-table.md)</li><li>[Bottle and MongoDB on Azure](tutorial-bottle-mongodb.md)</li><li>[Flask and Azure Table Storage on Azure](tutorial-flask-azure-table.md)</li><li>[Flask and MongoDB on Azure](tutorial-flask-mongodb.md)</li><li>[Django and SQL Database on Azure](tutorial-django-sqldb.md)</li><li>[Django and MySQL on Azure](tutorial-django-mysql.md)</li> |
