...
| DV2001: **Layer Diagram Presence** | This issue is reported on a project that do not include a layer model file but refere the dependency validation analyzers. If Dependency Validation is not been use, you can remove "Microsoft.DependencyValidation.Analyzers" directly from Solution Explorer or supress this warning. |
