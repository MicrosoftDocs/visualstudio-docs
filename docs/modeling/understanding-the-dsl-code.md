...
## Generated files in the DslPackage project
 ...
 The right-click menu commands that are visible on the diagram. You can adapt or add to this set. This file contains the code for the commands. The location of the commands on menus is determined by the Commands.vsct file. For more information, see [Writing User Commands and Actions](/visualstudio/modeling/how-to-modify-a-standard-menu-command-in-a-domain-specific-language).
...
```
 ...
 Locates the standard menu commands on menus, such as the diagram right-click (context) menu, the **Edit** menu, and so on. The code for the commands is in CommandSet.cs. You can relocate or modify the standard commands, and you can add your own commands. For more information, see [Writing User Commands and Actions](/visualstudio/modeling/how-to-modify-a-standard-menu-command-in-a-domain-specific-language).
