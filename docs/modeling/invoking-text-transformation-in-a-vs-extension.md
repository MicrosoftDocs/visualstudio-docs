...
description: Learn how you can use the text templating service to transform text templates and how to get the STextTemplating service and cast it to ITextTemplating.
