...
|Code-generated class diagrams<br /><br /> [Working with Class Diagrams (Class Designer)](/visualstudio/ide/class-designer/working-with-class-diagrams)|Types and their relationships in .NET code|
