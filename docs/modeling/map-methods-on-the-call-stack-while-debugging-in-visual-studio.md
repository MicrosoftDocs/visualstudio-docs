...
description: Learn how to create a code map to visually trace the call stack while you're debugging and learn that you can make notes on the map to track what the code is doing.
