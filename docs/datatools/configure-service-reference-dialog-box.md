...
> [!NOTE]
>  For Website projects, this option is always set to `Public` and cannot be changed. For more information, see [Troubleshooting Service References](../datatools/troubleshooting-service-references.md).  
...
## See Also  
 ...
 [Windows Communication Foundation Services and WCF Data Services](../datatools/configure-service-reference-dialog-box.md)