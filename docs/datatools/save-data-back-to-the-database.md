...
-   The transmitted SQL statement is an UPDATE statement. The adapter knows to use an UPDATE statement because the value of the \<xref:System.Data.DataRow.RowState*> property is \<xref:System.Data.DataRowState>.  
