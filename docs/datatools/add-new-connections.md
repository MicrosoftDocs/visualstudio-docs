...
## Add a connection in Server Explorer  
 ...
 ![Server Explorer New Connection icon](../datatools/media/raddata-server-explorer-new-connection-icon.png "raddata Server Explorer New Connection icon")  
  
 This brings up the **Add Connection** dialog box. Here, we have entered the name of the SQL Server LocalDB instance.  
  
 ![Add New Connection](../datatools/media/raddata-add-new-connection-dialog.png "raddata Add New Connection Dialog")  
...
## Change the provider  
 ...
 ![Change AD0.NET Data Provider](../datatools/media/raddata-change-ad0.net-data-provider.png "raddata Change AD0.NET Data Provider")  
...
## Test the connection  
 ...
 ![Test Connection](../datatools/media/raddata-test-connection.png "raddata Test Connection")  
