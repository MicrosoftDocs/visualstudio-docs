...
|Topic|Description|  
|-----------|-----------------|  
|[How to: Execute Data Service Queries](../Topic/How%20to:%20Execute%20Data%20Service%20Queries%20\(WCF%20Data%20Services\).md)|Shows how to query a data service from a [!INCLUDE[dnprdnshort](../codequality/includes/dnprdnshort_md.md)] application.|  
