...
-   Enclose the `TableAdapter.Update` method inside a `try`/`catch` block. The following example shows how to attempt an update with the contents of the `Customers` table in the `NorthwindDataSet`.  
     ...
     [!code[VbRaddataSaving#9](../datatools/codesnippet/CSharp/how-to--save-dataset-changes-to-a-database_1.cs)]
[!code[VbRaddataSaving#9](../datatools/codesnippet/VisualBasic/how-to--save-dataset-changes-to-a-database_1.vb)]  
...
-   Enclose the `DataAdapter.Update` method inside a `try`/`catch` block. The following example shows how to attempt an update to a data source with the contents of `Table1` in `DataSet1`.  
     ...
     [!code[VbRaddataSaving#26](../datatools/codesnippet/VisualBasic/how-to--save-dataset-changes-to-a-database_2.vb)]
...
3.  Child table: insert and update records.  
 ...
 For detailed information on saving data from multiple tables, see [Save data to a database (multiple tables)](../datatools/save-data-to-a-database--multiple-tables-.md).  
...
4.  Dispose of the temporary data tables to release the resources.  
     ...
     [!code[VbRaddataSaving#27](../datatools/codesnippet/VisualBasic/how-to--save-dataset-changes-to-a-database_3.vb)]
[!code[VbRaddataSaving#27](../datatools/codesnippet/CSharp/how-to--save-dataset-changes-to-a-database_3.cs)]  
