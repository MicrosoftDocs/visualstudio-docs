...
## In this section  
 ...
 [Visual Studio data tools for .NET](assetId:///6b145922-2f00-47db-befc-bf351b4809a1)  
...
## Related topics  
 ...
 Describes how to use [!INCLUDE[ssAstoria](../datatools/includes/ssastoria_md.md)] to deploy data services on the web or an intranet that implement the [Open Data Protocol (OData)](http://go.microsoft.com/fwlink/?LinkID=182204).  
