...
Once the installers have completed (see [Setup and install](../cross-platform/setup-and-install.md)), spend a few minutes to verify that everything is ready to experience Xamarin development.  
 ...
 Once you have finished verify the installation, try either or both of the following walkthroughs:  
...
These actions create a solution four projects: a shared .NET Standard 2.0 library project and application project for Android, iOS, and the Universal Windows Platform (UWP):  
