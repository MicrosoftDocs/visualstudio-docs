...
3. Attach to the Visual Studio for Mac instance using the PID:
    ...
    ```  
3. Retrieve the stacktrace for all the threads:
    ```shell  
    bt all
    ```  
