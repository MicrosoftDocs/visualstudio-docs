...
### Shader files without code coloration when using VS2017
Please make sure that the "Desktop Development with C++" workload is installed in your VS2017. The C/C++ parser used for code coloration is bundled with this workload.
