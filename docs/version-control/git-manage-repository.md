...
## Changing the last commit (Amend)
...
:::image type="content" source="media/vs-2022/Git-Repository-EditCommit.png" alt-text="Edit a commit message":::

When you are done editing your commit message, click **Amend**.

:::image type="content" source="media/vs-2022/Git-Repository-AmendCommit.png" alt-text="Save the edited message by clicking Amend":::
...
:::image type="content" source="media/vs-2022/Git-Changes-AmendCommit.png" alt-text="Amend code changes using Git Changes window":::
...
:::image type="content" source="media/vs-2022/Git-Repository-SquashCMD.png" alt-text="Update pick to squash":::
...
:::image type="content" source="media/vs-2022/Git-Repository-SquashVS.png" alt-text="Squash commits in VS":::
...
:::image type="content" source="media/vs-2022/Git-Repository-Merge.png" alt-text="Merge branches in VS":::
...
:::image type="content" source="media/vs-2022/Git-Repository-Rebase.png" alt-text="Rebase branches in VS":::
...
To do the same in Visual Studio, preview the branch you would like to cherry-pick a commit from by selecting it with a single click. Then right click on the targeted commit and chose **cherry-pick**.

:::image type="content" source="media/vs-2022/Git-Repository-CherryPick.png" alt-text="Cherry-Pick in VS":::
...
:::image type="content" source="media/vs-2022/Git-Repository-Revert.png" alt-text="Revert in VS":::

Click on the new commit to confirm that it undoes the changes of the commit we reverted. 

:::image type="content" source="media/vs-2022/Git-Repository-RevertConfermation.png" alt-text="Confirm revert operation":::
...
:::image type="content" source="media/vs-2022/Git-Repository-Reset.png" alt-text="Reset a branch in VS":::
