...
1. The **Track remote branch** checkbox, which is only shown if you select **Remote** in the **Based on** section, is selected by default if the remote has a matching branch name. See [Remote branches](https://git-scm.com/book/en/v2/Git-Branching-Remote-Branches).
