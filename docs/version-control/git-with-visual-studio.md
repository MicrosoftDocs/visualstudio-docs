...
:::image type="content" source="media/visualstudio/git-source-control-repository-management.png" alt-text="The Visual Studio IDE. The Create a new branch window and the Git Changes tab in Solution Explorer are shown." lightbox="media/visualstudio/git-source-control-repository-management.png":::
