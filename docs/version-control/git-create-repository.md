...
1. In the **Create a new GitHub repository** section of the **Create a Git repository** dialog, enter the name of the repo you want to create. (If you haven't yet signed in to your GitHub account, you can do so from this screen, too.)
    ...
    With Visual Studio 2022 version 17.12 and later, you can choose the visibility of the new repo. Under **Visibility**, choose **public**, **private**, or **internal** (see [About internal repositories](https://docs.github.com/enterprise-cloud@latest/repositories/creating-and-managing-repositories/about-repositories#about-internal-repositories)). Internal requires that you be signed in to a [GitHub Enterprise account](https://enterprise.github.com/login). With earlier versions, select the checkbox if you want a private repo.
