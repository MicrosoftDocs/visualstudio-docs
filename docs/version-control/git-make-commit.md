...
When you're ready to make a commit, use the sparkly pen icon (tooltip: **Add AI generated commit message**) at the lower right to request an AI-generated commit message. Once the message is generated, read it carefully to see if it's accurate. The AI-generated text is added to anything you already had. You have the option of accepting the insertion or discarding it. If you accept the insertion, you can then edit the text before submitting it as you normally would (choose the **Commit Staged** button, or one of the other commit options available in the dropdown).

> [!NOTE]
> Read about how GitHub Copilot uses your data at [GitHub Copilot Business Privacy Statement](https://docs.github.com/site-policy/privacy-policies/github-copilot-business-privacy-statement).
