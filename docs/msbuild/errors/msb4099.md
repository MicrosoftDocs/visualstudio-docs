...
{StrBegin="MSB4099: "}
-->
This error occurs when a project is using an Item in a condition in a Property, PropertyGroup or Import element, and these elements are evaluated before Items are available in the data model. See [How MSBuild builds projects](../build-process-overview.md#evaluation-phase).
<!-- :::editable-content-end::: -->
