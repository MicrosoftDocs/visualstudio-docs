...
If the extension is incorrect, perhaps when a project or solution file was renamed without paying attention to the file extension conventions, you might get this error. MSBuild expects project files to have an extension that ends with `proj`.
