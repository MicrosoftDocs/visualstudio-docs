---
title: "MSB3774: Could not find SDK"
description: "This error occurs when an MSBuild project SDK could not be loaded."
ms.date: "06/18/2021"
...
The .NET SDK should not fail to load, unless [global.json](/dotnet/core/tools/global-json) points to an SDK that isn't installed. Look for the version specified in the `version` property of the `sdk` object in *global.json*: 
