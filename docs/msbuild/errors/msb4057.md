...
If you're using .NET multitargeting and referencing targets in other projects using `ProjectReference` elements, note that any targets defined in referenced projects  only appear in the referencing project when the target framework matches.
