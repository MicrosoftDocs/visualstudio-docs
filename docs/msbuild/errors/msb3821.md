...
If all else fails and you can't fix the error directly in Visual Studio from the **Properties** tab you should close Visual Studio and go to the projects folder in File Explorer and simply open the **Properties menu** of the file that's giving you the error using the (Alt key + Enter) then you should see a checkbox with the label **Unblock** and check that box and Apply the changes then close the window. After that you should reopen your Visual Studio and head to your project and now you should not be getting the error anymore.
