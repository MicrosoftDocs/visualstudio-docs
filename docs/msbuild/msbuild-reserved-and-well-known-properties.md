...
| `MSBuildUserExtensionsPath` | Well-known | This path provides the location for MSBuild installation folders and standard build import files. It can be reset to provide local, per-user customizations. See [Customize your local build](customize-your-local-build.md#msbuildextensionspath-and-msbuilduserextensionspath).  |
