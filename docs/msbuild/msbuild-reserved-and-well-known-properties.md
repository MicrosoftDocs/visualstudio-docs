...
| `MSBuildVersion` | Reserved | The version of [! INCLUDE [vstecmsbuild] (../ extensibility / internals / includes / vstecmsbuild_md.md)] used to build the project. <br /> <br/> This property can not be overridden, otherwise the error message `MSB4004 - The 'MSBuildVersion" property is reserved, and can not be modified.` is returned. |
