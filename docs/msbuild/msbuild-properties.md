...
description: Learn how MSBuild name-value property pairs can pass values to tasks, evaluate conditions, and store values to reference throughout the project file.
