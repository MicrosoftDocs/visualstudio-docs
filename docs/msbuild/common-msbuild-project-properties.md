...
description: Learn about common MSBuild project properties that are defined in the Visual Studio project files or included in .targets files that MSBuild provides.
