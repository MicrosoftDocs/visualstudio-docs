...
The following tables describe the parameters of the **ClangCompile** task.
...
|**EnableNeonCodegen**|Enables code generation for NEON floating point hardware. This is applicable for arm architecture only.Optional **bool** parameter.<br/><br/>|
