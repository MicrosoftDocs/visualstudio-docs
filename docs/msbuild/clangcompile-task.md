...
|**CompileAs**|Optional **string** parameter.<br/><br/>Select compile language option for .c and .cpp files. Default will detect based on .c or .cpp extension.<br/><br/>Use `-x c`, `-x c++`.|
