...
description: Escape special characters like semicolons (;) and asterisks (*) in Visual Studio so you can use these characters as literals in MSBuild project files.
ms.date: 11/04/2016
ms.topic: conceptual
helpviewer_keywords:
