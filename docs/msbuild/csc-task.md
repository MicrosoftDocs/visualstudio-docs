...
|`OutputRefAssembly`|Optional `String` output parameter.<br /><br /> Specifies the name of the output reference assembly file. For more information, see [/refout (C# Compiler Options)](/dotnet/csharp/language-reference/compiler-options/refout-compiler-option).|  
