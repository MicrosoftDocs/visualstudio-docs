...
|------------|----------------|-----------------|
|-detailedSummary[:`True` or `False`]|-ds[:`True` or `False`]|Show detailed information at the end of the build log about the configurations that were built and how they were scheduled to nodes.|
