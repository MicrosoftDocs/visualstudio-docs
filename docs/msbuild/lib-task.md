...
description: Learn how MSBuild uses the LIB task to wraps the Microsoft 32-bit Library Manager tool, lib.exe, which creates and manages a library of COFF object files. 
