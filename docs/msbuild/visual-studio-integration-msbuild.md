...
description: Learn how Visual Studio can host projects in MSBuild format, even if they were authored by a different tools and had customized build processes.
