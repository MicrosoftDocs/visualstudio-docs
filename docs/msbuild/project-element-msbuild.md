...
| [ImportGroup](../msbuild/importgroup-element-msbuild.md) | Optional element.<br /><br /> Contains a collection of `Import` elements that are grouped under an optional condition. |
