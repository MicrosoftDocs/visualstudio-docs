...
This article lists all the common project items defined in MSBuild itself. Properties provided by the .NET SDK are documented at [MSBuild properties for Microsoft.Net.Sdk](/dotnet/core/project-sdk/msbuild-props).
