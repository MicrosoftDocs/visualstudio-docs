...
|%(DefiningProjectFullPath)|Contains the full path of the project that defines this item.|
|%(DefiningProjectDirectory)|Contains the project directory of the project that defines this item.|
|%(DefiningProjectName)|Contains the name of the project file that defines this item (without the extension).|
|%(DefiningProjectExtension)|Contains the extension of the project file that defines this item. |
