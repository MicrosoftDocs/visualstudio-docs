---
title: Create a Windows Forms user control with data binding with ADO.NET (.NET Framework)
...
---
# Create a Windows Forms user control that supports complex data binding with ADO.NET (.NET Framework)
