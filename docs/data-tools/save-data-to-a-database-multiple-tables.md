...
description: In this walkthrough, save data from multiple tables to a database using DataSet tools in ADO.NET .NET Framework application development in Visual Studio.
ms.date: 11/04/2016
ms.topic: how-to
dev_langs:
- VB
