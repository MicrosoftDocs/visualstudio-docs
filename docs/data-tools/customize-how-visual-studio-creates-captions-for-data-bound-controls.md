---
title: Customize captions for data-bound controls in ADO.NET applications (.NET Framework)
...
---
# Customize how Visual Studio creates captions for data-bound controls in ADO.NET applications (.NET Framework)
