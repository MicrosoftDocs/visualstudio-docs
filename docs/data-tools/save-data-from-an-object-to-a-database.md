---
title: Save data from an object to a database in an ADO.NET application (.NET Framework)
...
---
# Save data from an object to a database in an ADO.NET application (.NET Framework)
