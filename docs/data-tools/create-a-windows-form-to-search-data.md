...
description: Read an example of how to create a Windows Form to search data in ADO.NET .NET Framework applications with Visual Studio. Create the Windows Form application, data source, and form. Add parameterization. Test the app.
ms.date: 06/07/2021
ms.topic: conceptual
helpviewer_keywords:
