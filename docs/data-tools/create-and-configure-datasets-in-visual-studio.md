...
description: Create and configure datasets in ADO.NET .NET Framework applications with Visual Studio. A dataset is a set of objects that store data from a DB in memory and supports CRUD operations on that data.
ms.date: 10/07/2022
ms.topic: how-to
helpviewer_keywords:
