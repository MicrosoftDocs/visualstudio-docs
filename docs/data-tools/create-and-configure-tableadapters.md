...
description: Review how to create and configure a TableAdapter in ADO.NET .NET Framework applications with Visual Studio. TableAdapters provide communication between your application and a database.
ms.date: 09/01/2017
ms.topic: how-to
helpviewer_keywords:
