...
description: In ADO.NET .NET Framework application development with Visual Studio, create relationships between datasets in Visual Studio. Understand DataRelation objects and constraints. Manually create a data relation in Dataset Manager.
ms.date: 11/04/2016
ms.topic: how-to
f1_keywords:
