...
The**Dataset Designer** is a set of visual tools that you can use to create and edit typed datasets and the individual items that they contain.  
 ...
 To open the **Dataset Designer**, double-click a dataset in **Solution Explorer**, or right-click a dataset in the **Data Sources** window and click **Edit DataSet with Designer**. For more information, see [Walkthrough: Createing a Dataset in the Dataset Designer](walkthrough-creating-a-dataset-with-the-dataset-designer.md).
). Adding a new <xref:System.Data.DataSet> item with the **Add New Item** dialog box will open the **Dataset Designer** with an empty dataset ready for editing.  
...
|To|See|  
|--------|---------|  
|Create and edit a TableAdapter|[Create and configure TableAdapters](create-and-configure-tableadapters.md)|  
|Create a TableAdapter query|[How to: Create TableAdapter Queries](how-to-create-tableadapter-queries.md)|  
|Edit a TableAdapter query|[How to: Update Data by Using a TableAdapter](update-data-by-using-a-tableadapter.md)|  
|Create a <xref:System.Data.DataTable>|[How to: Create Data Tables](how-to-create-data-tables.md)|  
|Edit a <xref:System.Data.DataTable>|[Designing DataTables](designing-datatables.md)|  
...
|Relation (<xref:System.Data.DataRelation>)|Represents a parent-child relationship between two <xref:System.Data.DataTable>s. For more information, see [Relationships in datasets](relationships-in-datasets.md)|  
