...
description: Directly access a database with a TableAdapter in ADO.NET .NET Framework applications with Visual Studio, using methods such as Insert, Update, and Delete to manipulate data directly in the database.
ms.date: 11/04/2016
ms.topic: how-to
dev_langs:
- VB
