...
description: Understand the difference between typed and untyped datasets. Contrast data access in typed and untyped datasets when developing ADO.NET .NET Framework applications with Visual Studio.
ms.date: 11/04/2016
ms.topic: conceptual
dev_langs:
- VB
