...
description: In ADO.NET .NET Framework application development with Visual Studio, read XML data into a dataset. In this walkthrough, you create a Windows application that loads XML data into a dataset.
ms.date: 11/04/2016
ms.topic: how-to
dev_langs:
- VB
