...
1.  For a C# project: In **Solution Explorer**, expand the **Properties** node under the project, and then open the **Settings.settings** file.  
    For a VB project: In **Solution Explorer**, click **Show All Files**, expand the **My Project** node, and then open the **Settings.settings** file.
...
#### Create event handlers  
 Double-click the three buttons on the Navigation form to create empty event-handler methods. This will also create necessary WithEvents variables in the Designer code.  
...
[!code-vb[Navigation#1](../data-tools/codesnippet/VisualBasic/Navigation.vb#1)]   
...
#### Create event handlers  
 Create an empty Click event handler for each button on the NewCustomer form by double-clicking on each button. This will also create necessary WithEvents variables in the Designer code.    
...
[!code-vb[NewCustomer#1](../data-tools/codesnippet/VisualBasic/NewCustomer.vb#1)]  
...
#### Create event handlers  
 Create empty Click event handlers for the four buttons on the FillOrCancel form by double-clicking the buttons. This will also create necessary WithEvents variables in the Designer code.  
...
[!code-vb[FillOrCancel#1](../data-tools/codesnippet/VisualBasic/FillOrCancel.vb#1)]  
