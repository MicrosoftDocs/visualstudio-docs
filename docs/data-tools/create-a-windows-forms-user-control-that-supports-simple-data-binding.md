...
description: Learn to create a Windows Forms user control that supports simple data binding in an ADO.NET .NET Framework application, using the DefaultBindingPropertyAttribute class in Visual Studio.
ms.date: 11/04/2016
ms.topic: conceptual
dev_langs:
- VB
