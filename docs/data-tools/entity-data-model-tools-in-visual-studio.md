...
Entity Framework Tools are designed to help you build Entity Framework (EF) applications. The complete documentation for Entity Framework is here: [EF Core and EF 6](https://docs.microsoft.com/en-us/ef/).  
...
The tools generate or modify an .edmx file. This .edmx file contains information that describes the conceptual model, the storage model, and the mappings between them. For more information, see  [EDMX](https://msdn.microsoft.com/en-us/data/jj650889.aspx).  
...
|[Entity Framework (EF) Documentation)](https://msdn.microsoft.com/en-us/library/ee712907(v=vs.113).aspx)|Provides an index of videos, tutorials, and advanced documentation to help you make the most of Entity Framework.|  
