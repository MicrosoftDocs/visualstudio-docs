...
description: Understand how to connect to data in an Access database (either an .mdb file or an .accdb.file) with ADO.NET in .NET Framework applications with Visual Studio.
ms.date: 10/07/2022
ms.topic: how-to
helpviewer_keywords:
