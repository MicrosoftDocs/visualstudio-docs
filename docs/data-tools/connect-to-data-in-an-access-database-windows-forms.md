...
9. Back in the **Add Connection** dialog box, select **Microsoft Office 12.0 Access Database Engine OLE DB Provider** from the **OLE DB Provider** drop-down.  
     ...
     > [!NOTE]
     >  If you don't see the **Microsoft Office 12.0 Access Database Engine OLE DB Provider** OLE DB provider in the drop-down, you may need to install the [2007 Office System Driver: Data Connectivity Components](https://www.microsoft.com/en-us/download/confirmation.aspx?id=23734).
