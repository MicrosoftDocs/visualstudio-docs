---
title: Add custom controls to the Data Sources window using ADO.NET (.NET Framework)
...
---
# Add custom controls to the Data Sources window using ADO.NET (.NET Framework)
