...
3. In the drop-down menu, click **Customize**. One of the following dialog boxes opens:
    ...
    - If the **Windows Forms Designer** is open, the **Data UI Customization** page of the **Options** dialog box opens. For more information, see [Data UI Customization options dialog box](../ide/reference/options-wfdesigner-data-ui-customizations.md).
...
- [Data UI Customization options dialog box](../ide/reference/options-wfdesigner-data-ui-customizations.md)