...
Associations between entity classes in language integrated query (LINQ) to SQL are analogous to relationships between tables in a database. You can create associations between entity classes by using the **Association Editor** dialog box.
