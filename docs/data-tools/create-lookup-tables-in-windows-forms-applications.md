---
title: Create lookup tables in Windows Forms applications with ADO.NET (.NET Framework)
...
---
# Create lookup tables in Windows Forms applications with ADO.NET (.NET Framework)
