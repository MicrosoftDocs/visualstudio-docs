...
description: In ADO.NET .NET Framework applications with Visual Studio, learn to extend the functionality of a TableAdapter by adding code to the TableAdapter's partial class file.
ms.date: 11/04/2016
ms.topic: how-to
dev_langs:
- VB
