...
### Entity classes
 Create an Entity Framework model as a data source by first running the **Entity Data Model Wizard** to create the entity classes (**Project** > **Add New Item** > **ADO.NET Entity Data Model**).
