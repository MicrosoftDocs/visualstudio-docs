---
title: Dataset tools
description: Review the dataset tools available for ADO.NET .NET Framework application development in Visual Studio. Read about dataset workflow, datasets and N-tier architecture, and datasets and XML.
ms.date: 11/21/2018
ms.topic: conceptual
f1_keywords:
- vs.data.DataSet
