...
To install these components by using the manual installer, download and run the [Build Tools for Visual Studio](https://aka.ms/vs/download/#build-tools-for-visual-studio-2019).
