...
| ------ | ------- | --------- | ----------- |
| RDP | *.cloudapp.net <br>Custom domain <br> This is the default for most RDP listeners. | RDP | 3389 | Desktop connection to VMs |
...
| Updated web publish tooling checks and extension recommendations  | marketplace.visualstudio.com (via FWLink 859659) <br> visualstudiogallery.msdn.microsoft.com (via FWLinks 320773, 615538) | https | 443 | Used for checking for the availability of updated publish tooling. If disabled, a potential recommended extension for web publishing may not be shown |
| Updated Azure Resource Creation Endpoint Information  | *.blob.core.windows.net (via FWLink 391739) | https | 443 | Used to update the endpoints used for the creation of Azure Resources for certain Azure Services. If disabled, the last downloaded or built in endpoint locations will be used instead |
| Updated Azure Resource Creation UI Settings | www.microsoft.com (via FWLinks 722336, 855893, 836755, 836756) | http | 80 | Used to update the user interface settings for the creation of Azure Resource as seen when electing to create new resources via the App Service node in Server Explorer, Cloud Explorer or Web Publish. If disabled, the last downloaded or built in settings will be used instead |
| Web Documentation Links | Docs.Microsoft.com (via FWLinks 331311, 331309, 865438, 832029, 839002, 834448, 848461, 859495, 517593,313770,274910, 847273, 847274, 847272, 299423, 299422, 299424, 299425, 204140, 204658, 313770, 248973, 301862, 301864, 313242, 316888, 320754, 320755, 320757, 320758, 320759, 320760, 320763, 320764, 320765, 320766, 320767, 320770, 320771, 320779, 320780, 320956, 320957, 320959, 320960, 320961, 320962, 320963, 320964, 403804, 615519, 615520, 615523, 615524, 615528, 615529, 615530, 615531, 615532, 615535, 615541, 615542, 615543, 615545) <br><br> msdn.microsoft.com (via FWLinks 208121, 246068, 179181, 301874, 301879, 301880) <br><br> blogs.msdn.microsoft.com (via FWLinks 859831, 859830, 849106, 852275, 125889, 208121, 615797, 226949, 301863, 317594, 320756, 320761, 320762, 320777, 320958, 615526, 615527) <br> www.microsoft.com (via FWLinks 256245, 245956, 241526, 391939, 248304, 248305, 248306, 248307, 248308) <br> Github.com (via FWLinks 320976, 852740, 865095) <br><br> www.windowsazure.com (via FWLink 330318, redirects to docs.microsoft.com) <br><br>Azure.microsoft.com (via FWLinks 287054, 330099, 391940) <br><br>www.asp.net (via FWLink  245139, 248974, 273732, 301865, 301867, 301870, 301872, 320769, 320772, 320778, 320955, 320965, 320966, 615534, 615537, 615544, 615546)<br><br>docs.docker.com (via FWLink 834551) <br><br>vishaljoshi.blogspot.com (via FWLink 124618) <br><br>www.iis.net (via FWLinks 109366, 109365) <br><br>Blog.iis.net (via FWLink 178035) <br><br>Technet.microsoft.com (via FWLinks 178589, 178036) <br><br>support.microsoft.com (via FWLinks 178587, 178034) <br><br>privacy.microsoft.com (via FWLink 391941) <br><br>hosting.asp.net (via FWLinks 245143, 615536) <br><br>www.visualstudio.com (via FWLinks 320768, 615533) | https <br> http | 443 <br> 80 | Presented as links the user may click to learn more about certain web tooling features. If disabled, the links will not present the content |
...
| Active Directory Graph | graph.windows.net | https | 443 | Used for provisioning new Azure Active Directory applications. If disabled, new web projects with organizational authentication selected will not be able to create or configure the required Azure Active Directory application |
| Azure Functions CLI Update Check | functionscdn.azureedge.net (via fwlink 835724) | https | 443 | Used for checking for updated versions of the Azure Functions CLI. If disabled, a cached copy (or the copy carried by the Azure Functions component) of the CLI will be used instead |
| Xamarin | | | | |
| Cordova | | | | |
| Node | | | | |
...
| Office Web Add-in  <br><br> Manifest Verification Service | verificationservice.osi.office.net<br> <br>(https://verificationservice.osi.office.net/ova/addincheckingagent.svc/api/addincheck?format=html) | https | 443 | Use to validate manifests for Office web add-ins |
