...
| Customer Experience <br>Improvement Program (CEIP) <br><br>PerfWatson.exe | az667904.vo.msecnd.net <br><br>visualstudio-devdiv-c2s.msedge.net <br><br>scus-breeziest-in.cloudapp.net<br>  |   |  | Used to collect anonymous usage patterns and error logs <br><br>Used to track UI freeze issues|
