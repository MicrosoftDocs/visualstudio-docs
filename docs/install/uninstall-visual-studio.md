...
1.  Find the Visual Studio Installer on your computer.  
     ...
     For example, on a computer running Windows 10 Anniversary Update, select **Start**, and then scroll to the letter **V**, where it is listed as **Visual Studio Installer**.  
