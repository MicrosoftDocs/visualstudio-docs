...
The Visual Studio administrator update package that is published to the Microsoft Update system is available through three distribution channels:
   1. The [Microsoft Update Catalog](https://www.catalog.update.microsoft.com) channel, where you can download the package and use it to either [update a layout](/visualstudio/install/create-a-network-installation-of-visual-studio#update-the-layout-to-a-specific-version-of-the-product) or update a [client instance](./install/update-visual-studio.md#update-from-the-microsoft-catalog).
