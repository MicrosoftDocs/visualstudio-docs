...
For more information about how to use these IDs, see the [Use command-line parameters to install Visual Studio](../use-command-line-parameters-to-install-visual-studio.md) page. And, for a list of workload and component IDs for other products, see the [Visual Studio 2017 workload and component IDs](../workload-and-component-ids.md?view=vs-2019) page.
