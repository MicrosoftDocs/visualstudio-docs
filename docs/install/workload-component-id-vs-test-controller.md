...
To install these components by using the manual installer, download and run the [Test Controller for Visual Studio](https://visualstudio.microsoft.com/downloads/#agents-for-visual-studio-2026).

[!include[Visual Studio Test Controller 2026](includes/vs-2026/workload-component-id-vs-test-controller.md)]
