...
**Update**: For Visual Studio 2017 version 15.8 or later, you can manually install the certificates by right-clicking each of the certificate files, selecting Install Certificate, and then clicking through the Certificate Manager wizard.
...
2. Create a batch file with the following commands:
   ...
   ```
   **Update**: For Visual Studio 2017 version 15.8 or later, create the batch file with the following commands:
...
**Update**: For Visual Studio 2017 version 15.8 or later, the Visual Studio Installer requires only the root certificates to be installed on the system.
