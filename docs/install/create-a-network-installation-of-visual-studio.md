...
Administrators may run setup to push Visual Studio onto client machines. Or, users who have administrator rights can run setup directly from the share to install Visual Studio on their machine.
