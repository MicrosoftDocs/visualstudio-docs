...
| `--fix` | **New in 15.3, optional**: Verify the contents of a layout. If any files are corrupt or missing, they are redownloaded. Internet access is required to fix a layout. |
...
| `--fix` | **Optional**: Verify the contents of a layout.  If any files are corrupt or missing, they are redownloaded. Internet access is required to fix a layout. |
