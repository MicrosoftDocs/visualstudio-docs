...
description: The file element identifies all nonassembly files downloaded and used by the application. The file element identifies all nonassembly files downloaded and used by the application.
