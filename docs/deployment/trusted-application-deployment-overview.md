...
- *CertMgr.exe*, which is a component of Internet Explorer. For more information, see [Certmgr.exe (Certificate Manager Tool)](/dotnet/framework/tools/certmgr-exe-certificate-manager-tool).
