...
In a team environment, you can use Azure Pipelines to enable continuous deployment of your app. For more information, see [Azure Pipelines](/vsts/build-release/index) and [Deploy to Azure](/vsts/deploy-azure/index).
