...
| **Publish a Windows app:** You can easily build, submit, and sell your apps from the Microsoft Store to customers around the world. |[Publish Windows apps](https://developer.microsoft.com/store/publish-apps) |
