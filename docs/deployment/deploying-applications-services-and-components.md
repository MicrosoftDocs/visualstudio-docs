...
In a team environment, you can use Visual Studio Team Services (VSTS) to enable continuous deployment of your app. For more information, see [Build and Release](/azure/devops/build-release/index) and [Deploy to Azure](/azure/devops/deploy-azure/index).
