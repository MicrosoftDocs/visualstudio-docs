...
1. In File Explorer, open the **Packages** folder.
    ...
    By default, the path is : 
      - For VS2015 : *C:\Program Files\Microsoft Visual Studio 14.0\SDK\Bootstrapper\Packages* on a 32-bit system and *C:\Program Files (x86)\Microsoft Visual Studio 14.0\SDK\Bootstrapper\Packages* on a 64-bit system.
      - For VS2017 : *C:\Program Files (x86)\Microsoft SDKs\ClickOnce Bootstrapper\Packages\*
