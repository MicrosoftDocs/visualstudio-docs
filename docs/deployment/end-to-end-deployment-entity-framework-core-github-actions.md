...
> [!NOTE]
> If you get any errors regarding the connection, try to wrap it in single quotes: `dotnet ef database update -p DotNetCoreSqlDb --connection '${{ secrets.DBConnection }}'`
