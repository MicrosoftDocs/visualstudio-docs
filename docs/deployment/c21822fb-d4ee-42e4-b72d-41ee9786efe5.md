...
1.  Open a Visual Studio command prompt or a [!INCLUDE[winsdkshort](../debugger/includes/winsdkshort_md.md)] command prompt, and change to the directory in which you will store your [!INCLUDE[ndptecclick](../deployment/includes/ndptecclick_md.md)] files.  
...
1.  Open a Visual Studio command prompt or a [!INCLUDE[winsdkshort](../debugger/includes/winsdkshort_md.md)] command prompt, and navigate to the directory in which you will store your [!INCLUDE[ndptecclick](../deployment/includes/ndptecclick_md.md)] files.  
