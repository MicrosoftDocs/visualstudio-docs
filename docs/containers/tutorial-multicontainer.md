...
![Create ASP.NET Core Web App project](./media/tutorial-multicontainer/vs-2022/create-web-project.png)
...
1. Run the site locally now (**F5** or **Ctrl+F5**) to verify that it works as expected. If everything is configured correctly, you see weather forecast data.
