...
This article illustrates how to use Visual Studio to start an app in a local Docker container, make changes, and then refresh the browser to see the changes. This article also shows you how to set breakpoints for debugging for containerized apps. Supported project types include .NET Framework and .NET Core web and console apps, and (with Visual Studio 2022 17.2 Preview 2 or later) Azure Functions. In this article, we use ASP.NET Core web apps and .NET Framework console apps.
