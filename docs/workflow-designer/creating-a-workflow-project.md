...
helpviewer_keywords:
  ...
  - "Visual Studio Workflow Designer, creating a workflow project"
...
The first four topics below describe how to use of the Workflow Templates found on the **New Project** window. These templates can be accessed by opening Visual Studio and selecting **File** > **New** > **Project**, then the **Workflow** category from the **Installed Templates** section on the left, under either the **Visual Basic** or **Visual C#** node.
