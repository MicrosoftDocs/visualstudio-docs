...
4.  Invoke the debugger as described in [How to: Invoke the Workflow Debugger](/visualstudio/workflow-designer/debugging-workflows-with-the-workflow-designer).
