...
description: Learn how the Assign activity designer is used to create and configure an Assign activity, and how the Assign activity assigns a value to a variable or argument.
