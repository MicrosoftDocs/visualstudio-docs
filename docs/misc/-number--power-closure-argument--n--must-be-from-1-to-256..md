...
1.  Enter a number between 1 and 256 and try again. For more information on syntax, see [Regular Expressions](../ide/using-regular-expressions-in-visual-studio.md).  
