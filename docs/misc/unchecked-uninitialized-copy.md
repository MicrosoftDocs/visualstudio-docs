...
---
# unchecked_uninitialized_copy
Same as [uninitialized_copy](http://msdn.microsoft.com/Library/23a09cb8-4116-475e-b0bb-5d3e7daca5aa) but allows the use of an unchecked iterator as output iterator when _SECURE_SCL=1 is defined. This function is defined in the [stdext Namespace](/visual-cpp/standard-library/stdext-namespace) namespace.  
