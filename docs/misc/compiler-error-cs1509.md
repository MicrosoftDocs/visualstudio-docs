...
Referenced file 'file' is not an assembly; use '/addmodule' option instead  
 ...
 An output file (output file 1), produced in a compilation that used [/target:module](http://msdn.microsoft.com/Library/9af1e4fa-c749-44e7-ae58-90a3d05d4e72) (does not have an assembly manifest), was specified to [/reference](/dotnet/csharp/language-reference/compiler-options/reference-compiler-option). So, rather than appending an assembly to the assembly for the current program, the metadata information in output file 1 will be added to the assembly for the current program.