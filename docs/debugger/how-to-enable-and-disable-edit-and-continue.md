...
**Edit and Continue** works only in debug builds. You can disable or enable **Edit and Continue** in the Visual Studio **Options** dialog box at design time. You cannot change the **Edit and Continue** setting while you are debugging. For more information, see [Edit and Continue](../debugger/edit-and-continue.md). 
...
1.  If you are in a debugging session, stop debugging (**Debug** > **Stop Debugging** or **Shift**+**F5**).
