...
|Remote debug a Windows Universal (UWP), OneCore, HoloLens, or IoT app|Debug installed app package|N/A|Use [Debug Installed App Package](../debugger/debug-installed-app-package.md) instead of **Attach to process**|
|Debug a Windows Universal (UWP), OneCore, HoloLens, or IoT app that you didn't start from Visual Studio|Debug installed app package|N/A|Use [Debug Installed App Package](../debugger/debug-installed-app-package.md) instead of **Attach to process**|
