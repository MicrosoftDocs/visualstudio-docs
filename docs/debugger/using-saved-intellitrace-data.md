...
-   An .iTrace file from one of these sources:
    ...
    |A test session in Microsoft Test Manager. This attaches an .iTrace file to a Team Foundation Server work item.|[Collect more diagnostic data in manual tests](/azure/devops/manual-test/mtm/collect-more-diagnostic-data-in-manual-tests)|
...
### Where can I get more information?
 ...
 [Collect more diagnostic data in manual tests](/azure/devops/manual-test/mtm/collect-more-diagnostic-data-in-manual-tests)
