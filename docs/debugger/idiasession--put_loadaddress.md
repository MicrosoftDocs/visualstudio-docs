...
> [!NOTE]
>  You must call this method when you get the [IDiaSession](../debugger/idiasession.md) object and before you start using the object if you need to use any virtual properties on symbols.  
