...
|**Limited support**|-   .NET Core and ASP.NET Core apps supported for events only<br />-   F# apps on an experimental basis<br />-   Microsoft Store apps supported for events only|  
