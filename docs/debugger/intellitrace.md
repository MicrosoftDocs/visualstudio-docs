...
|**Collect IntelliTrace data during a test session in Test Manager**|- [Collect more diagnostic data in manual tests](/azure/devops/manual-test/mtm/collect-more-diagnostic-data-in-manual-tests)|
