...
Retrieves the ID of the register that holds a base pointer to the parameters. Use when the [SymTagEnum Enumeration](../debugger/symtagenum.md) is set to `SymTagFunction`.  
