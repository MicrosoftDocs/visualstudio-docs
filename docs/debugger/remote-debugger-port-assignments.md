...
|Visual Studio Version|Default Port|
|-|-|
...
In other words, the number of the port assigned to the remote debugger is incremented by two for each release. You can set a different port number if you like. We will explain how to set port numbers in a later section.
