...
On the **Role services** step, select the IIS role services you desire or accept the default role services provided. If you plan enable deployment using publish settings and Web Deploy, make sure that **IIS Management Scripts and Tools** is selected.
