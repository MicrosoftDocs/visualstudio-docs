...
|Version|Link|Notes|
|-|-|-|
|Visual Studio 2022|[Remote tools for the Preview](https://visualstudio.microsoft.com/downloads/)|Compatible with all Visual Studio 2022 versions. Download the version matching your device operating system (x86, x64, or ARM64). On Windows Server, see [Unblock the file download](../../debugger/remote-debugging-unblock-file-download.md) for help downloading the remote tools.|
