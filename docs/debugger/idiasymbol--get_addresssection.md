...
Retrieves the section part of an address location. Use when the [LocationType Enumeration](../debugger/locationtype.md) is set to `LocIsStatic`.  
...
## Remarks  
 ...
 To get the offset part of an address, call the [IDiaSymbol::get_addressOffset](../debugger/idiasymbol--get_addressoffset.md) method.  
