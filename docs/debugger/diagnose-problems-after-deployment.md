...
Visual Studio 2017 and later versions do not include the *BuildInfo.config* file, which was deprecated and then removed. This was required to use IntelliTrace with ASP.NET apps. To debug ASP.NET web apps after deployment, use one of the following methods:
...
For more information, see [Diagnose problems after deployment (Visual Studio 2015)](/previous-versions/visualstudio/visual-studio-2015/debugger/diagnose-problems-after-deployment?view=vs-2015).
