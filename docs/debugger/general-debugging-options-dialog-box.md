...
The debugger will use the Visual Studio 2013 C#/Visual Basic expression evaluators rather than the Visual Studio 2015 Roslyn-based expression evaluators.
