...
- Snapshot debugging does not work on App Services that have [Local Caching](https://docs.microsoft.com/azure/app-service/app-service-local-cache) turned on.
...
- Create a [Deployment Slot](https://docs.microsoft.com/azure/app-service/web-sites-staged-publishing) within your App Service and deploy your site to the Slot.
