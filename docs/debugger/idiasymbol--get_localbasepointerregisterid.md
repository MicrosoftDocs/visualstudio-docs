...
Retrieves the ID of the register that holds a base pointer to local variables on the stack. Use when the [SymTagEnum Enumeration](../debugger/symtagenum.md) is set to `SymTagFunction`.  
