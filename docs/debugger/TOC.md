...
## [View events with IntelliTrace](walkthrough-using-intellitrace.md)
...
## [Use saved IntelliTrace data](using-saved-intellitrace-data.md)
...
### [Run UWP apps from Visual Studio](run-store-apps-from-visual-studio.md)
#### [Run UWP apps on the local machine](run-windows-store-apps-on-the-local-machine.md)
...
### [Debug UWP apps in Visual Studio](debug-store-apps-in-visual-studio.md)
#### [Start a debugging session for a UWP app in Visual Studio (VB, C#, C++ and XAML)](start-a-debugging-session-for-a-store-app-in-visual-studio-vb-csharp-cpp-and-xaml.md)
...
#### [Start a debugging session for UWP Apps in Visual Studio (JavaScript)](start-a-debugging-session-for-store-apps-in-visual-studio-javascript.md)
#### [Control execution of a UWP app in a Visual Studio debug session (JavaScript)](control-execution-of-a-store-app-in-a-visual-studio-debug-session-for-windows-store-apps-javascript.md)
...
### [How to trigger suspend, resume, and background events in UWP apps]()
### [Debug prefetched content in UWP apps](prefetch-content-for-windows-store-apps.md)
