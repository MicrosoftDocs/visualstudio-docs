...
#### [How to trigger suspend, resume, and background events for Microsoft Store apps](how-to-trigger-suspend-resume-and-background-events-for-windows-store-apps-in-visual-studio.md)
