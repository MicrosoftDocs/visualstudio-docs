...
## [Application type considerations](debugging-applications.md)
...
#### [How to trigger suspend, resume, and background events for Microsoft Store apps in Visual Studio](how-to-trigger-suspend-resume-and-background-events-for-windows-store-apps-in-visual-studio.md)
