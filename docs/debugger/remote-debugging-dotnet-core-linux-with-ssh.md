...
> [!NOTE]
> For debugging Linux running on Azure Kubernetes Service (AKS), [Bridge to Kubernetes](../bridge/overview-bridge-to-kubernetes.md) is recommended instead of attach to process.
