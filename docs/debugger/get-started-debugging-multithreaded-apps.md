...
You can click the the **Show Only Flagged Threads** button to toggle back to **Show All Threads** mode. (You can also right-click in the **Parallel Watch** window and choose **Unflag**.)
