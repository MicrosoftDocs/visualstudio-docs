...
|[IDiaSymbol::get_InlSpec](../../debugger/debug-interface-access/idiasymbol-get-inlspec.md)|`BOOL`|`TRUE` if the function has been marked with one of the [inline, **inline, \**forceinline](/cpp/cpp/inline-functions-cpp) attributes.|
