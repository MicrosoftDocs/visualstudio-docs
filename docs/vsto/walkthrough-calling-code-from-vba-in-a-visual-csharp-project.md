...
-   Call code in a VSTO Add-in from VBA. For more information, see [Walkthrough: Call code in an VSTO Add-in from VBA](../vsto/walkthrough-calling-code-in-a-vsto-add-in-from-vba.md).  
