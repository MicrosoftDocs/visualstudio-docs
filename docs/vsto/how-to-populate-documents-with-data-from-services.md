...
description: Learn how you can use bring the data from services into your solution, and how you can use Windows Forms controls to display the data in a document.
