...
Partial Public NotInheritable Class ThisDocument
    ...
    Friend WithEvents PlainTextContentControl1 As Microsoft.Office.Tools.Word.PlainTextContentControl

    Friend WithEvents DatePickerContentControl1 As Microsoft.Office.Tools.Word.DatePickerContentControl

    Friend WithEvents ComboBoxContentControl1 As Microsoft.Office.Tools.Word.ComboBoxContentControl

    Friend WithEvents PictureContentControl1 As Microsoft.Office.Tools.Word.PictureContentControl

    Friend WithEvents PlainTextContentControl2 As Microsoft.Office.Tools.Word.PlainTextContentControl

    Friend WithEvents DropDownListContentControl1 As Microsoft.Office.Tools.Word.DropDownListContentControl
    ...
    Private Sub BeginInitialization()
        ...
        Me.PlainTextContentControl1.BeginInit()
        Me.DatePickerContentControl1.BeginInit()
        Me.ComboBoxContentControl1.BeginInit()
        Me.PictureContentControl1.BeginInit()
        Me.PlainTextContentControl2.BeginInit()
        Me.DropDownListContentControl1.BeginInit()
    ...
    Private Sub EndInitialization()
        ...
        Me.DropDownListContentControl1.EndInit()
        Me.PlainTextContentControl2.EndInit()
        Me.PictureContentControl1.EndInit()
        Me.ComboBoxContentControl1.EndInit()
        Me.DatePickerContentControl1.EndInit()
        Me.PlainTextContentControl1.EndInit()
    ...
    Private Sub InitializeControls()
        ...
        Me.PlainTextContentControl1 = Globals.Factory.CreatePlainTextContentControl(Nothing, Nothing, "3676458139", "PlainTextContentControl1", Me)
        Me.DatePickerContentControl1 = Globals.Factory.CreateDatePickerContentControl(Nothing, Nothing, "3676458140", "DatePickerContentControl1", Me)
        Me.ComboBoxContentControl1 = Globals.Factory.CreateComboBoxContentControl(Nothing, Nothing, "3676458141", "ComboBoxContentControl1", Me)
        Me.PictureContentControl1 = Globals.Factory.CreatePictureContentControl(Nothing, Nothing, "3676458142", "PictureContentControl1", Me)
        Me.PlainTextContentControl2 = Globals.Factory.CreatePlainTextContentControl(Nothing, Nothing, "3676458143", "PlainTextContentControl2", Me)
        Me.DropDownListContentControl1 = Globals.Factory.CreateDropDownListContentControl(Nothing, Nothing, "3676458144", "DropDownListContentControl1", Me)
        Me.RichTextContentControl1 = Globals.Factory.CreateRichTextContentControl(Nothing, Nothing, "3676458145", "RichTextContentControl1", Me)
    End Sub
    ...
    Protected Overrides Sub OnShutdown()
        ...
        Me.DropDownListContentControl1.Dispose()
        Me.PlainTextContentControl2.Dispose()
        Me.PictureContentControl1.Dispose()
        Me.ComboBoxContentControl1.Dispose()
        Me.DatePickerContentControl1.Dispose()
        Me.PlainTextContentControl1.Dispose()
