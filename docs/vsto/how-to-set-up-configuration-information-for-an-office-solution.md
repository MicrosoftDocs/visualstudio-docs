...
6.  Create your configuration file according to the application configuration file schema. For more information, see [Configuration File Schema for the .NET Framework](/dotnet/articles/framework/configure-apps/file-schema/index).  
  
 There are no special considerations for using configuration files with Office projects.  
  
## See Also  
 [Configuration File Schema for the .NET Framework](/dotnet/articles/framework/configure-apps/file-schema/index)   
