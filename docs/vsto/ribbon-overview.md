...
|[Walkthrough: Updating the Controls on a Ribbon at runtime](../vsto/walkthrough-updating-the-controls-on-a-Ribbon-at-run-time.md)|Demonstrates how to use the Ribbon object model to update the controls on a Ribbon after the Ribbon is loaded into the Office application.|  
...
|[Accessing the Ribbon at runtime](../vsto/accessing-the-Ribbon-at-run-time.md)|Shows how to show, hide, and modify the Ribbon, and enable users to run the code from controls in a custom task pane, actions pane, or Outlook form region.|  
