...
-   [Add NamedRange controls at run time in an VSTO Add-in project](#runtimeaddin)  
...
##  <a name="runtimeaddin"></a> Add NamedRange controls at run time in an VSTO Add-in project  
