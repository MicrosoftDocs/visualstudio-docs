...
# Extend Word documents and Excel workbooks in VSTO add-ins at runtime
  You can use an VSTO Add-in to customize Word documents and Excel workbooks in the following ways:  
