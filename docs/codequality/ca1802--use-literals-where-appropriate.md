...
## Cause  
 A field is declared `static` and `readonly` (`Shared` and `ReadOnly` in [!INCLUDE[vbprvb](../codequality/includes/vbprvb_md.md)]), and is initialized with a value that is computable at compile time.  
...
## Example  
 ...
 [!code[FxCop.Performance.UseLiterals#1](../codequality/codesnippet/VisualBasic/ca1802--use-literals-where-appropriate_1.vb)]
[!code[FxCop.Performance.UseLiterals#1](../codequality/codesnippet/CSharp/ca1802--use-literals-where-appropriate_1.cs)]