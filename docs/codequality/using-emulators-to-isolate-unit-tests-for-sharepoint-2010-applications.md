...
The Microsoft.SharePoint.Emulators package provides a set of libraries that help you to create isolated unit tests for Microsoft SharePoint 2010 applications. Emulators use [shims](../codequality/using-shims-to-isolate-your-application-from-other-assemblies-for-unit-testing.md) from the [Microsoft Fakes](../codequality/isolating-code-under-test-with-microsoft-fakes.md) isolation framework to create lightweight in-memory objects that mimic the most common objects and methods of the SharePoint API. When a SharePoint method is not emulated, or when you want to change the default behavior of an emulator, you can create Fakes shims to provide the results that you want.  
...
-   Microsoft SharePoint Emulators NuGet package  
 ...
 You should also be familiar with the [basics of unit testing in Visual Studio](../codequality/unit-test-basics.md) and some knowledge of [Microsoft Fakes](../codequality/isolating-code-under-test-with-microsoft-fakes.md).  
...
##  <a name="BKMK_The_AppointmentsWebPart_example"></a> The AppointmentsWebPart example  
 ...
 ![Appointments Web Part](../codequality/media/ut_emulators_appointmentswebpart.png "UT_EMULATORS_AppointmentsWebPart")  
...
3.  Search the **Online** category for `Microsoft.SharePoint.Emulators`, and then choose **Install**.  
 ...
 ![Sharepoint Emulators NuGet package](../codequality/media/ut_emulators_nuget.png "UT_EMULATORS_Nuget")  
...
```  
 ...
 ![Emulator execution flow](../codequality/media/ut_emulators_flowchart.png "UT_EMULATORS_FlowChart")  
...
2.  Rebuild the test project at least once after you have installed the Microsoft SharePoint Emulators package and if you have edited the Microsoft.SharePoint.Fakes file. Building the project creates and populates a **FakesAssembly** folder in your on-disk project root folder.  
     ...
     ![FakesAssembly folder](../codequality/media/ut_emulators_fakesassemblyfolder.png "UT_EMULATORS_FakesAssemblyFolder")  
