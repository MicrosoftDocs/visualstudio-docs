...
## Example  
 [!code[FxCop.Security.CA2149.TransparentMethodsMustNotCallNativeCode#1](../codequality/codesnippet/CSharp/ca2149--transparent-methods-must-not-call-into-native-code_1.cs)]