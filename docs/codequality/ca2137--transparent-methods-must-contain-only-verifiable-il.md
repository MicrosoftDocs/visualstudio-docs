...
## Example  
 ...
 [!code[FxCop.Security.CA2137.TransparentMethodsMustBeVerifiable#1](../codequality/codesnippet/CSharp/ca2137--transparent-methods-must-contain-only-verifiable-il_1.cs)]