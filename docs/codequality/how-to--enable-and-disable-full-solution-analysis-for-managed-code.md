...
3.  Select the **Enable full solution analysis** check box to enable full solution analysis, or clear the box to disable it. Choose the **OK** button when you're done.  
     ...
     ![Enable full solution analysis check box.](../codequality/media/fsa_toolsoptions.png "FSA_ToolsOptions")  
...
## Results of enabling and disabling full solution analysis  
 ...
 ![Full solution analysis enabled.](../codequality/media/fsa_enabled.png "FSA_Enabled")  
 ...
 ![Full solution analysis disabled.](../codequality/media/fsa_disabled.png "FSA_Disabled")  
