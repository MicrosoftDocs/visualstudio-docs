...
## Example  
 ...
 [!code[FxCop.Security.CA2135.SecurityRuleSetLevel2MethodsShouldNotBeProtectedWithLinkDemands#1](../codequality/codesnippet/CSharp/ca2135--level-2-assemblies-should-not-contain-linkdemands_1.cs)]