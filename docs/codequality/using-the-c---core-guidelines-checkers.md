...
2.  In the **NuGet Package Manager** window, search for Microsoft.CppCoreCheck.  
     ...
     ![Nuget Package Manager window shows CppCoreCheck package](../codequality/media/cppcorecheck_nuget_window.PNG "CPPCoreCheck_Nuget_Window")  
...
3.  Select the Microsoft.CppCoreCheck package and then choose the **Install** button to add the rules to your project.  
 ...
 ![Property page for Code Analysis General settings](../codequality/media/cppcorecheck_codeanalysis_general.png "CPPCoreCheck_CodeAnalysis_General")  
 ...
 ![Property page for Code Analysis Extensions settings](../codequality/media/cppcorecheck_codeanalysis_extensions.png "CPPCoreCheck_CodeAnalysis_Extensions")  
