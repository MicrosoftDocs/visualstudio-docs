...
### .pdb (symbol) files are unavailable  
 ...
 If the .pdb and .dll or .exe files are in different places, copy the .pdb file to the same directory. It is also possible to configure code coverage engine to search for .pdb files in another location. For more information, see [Customizing Code Coverage Analysis](../codequality/customizing-code-coverage-analysis.md).  
...
### Custom .runsettings file with bad syntax  
 ...
 Explanation  
 You can run your unit tests with a custom .runsettings file to configure code coverage options. The options allow you to include or exclude files. For more information, see [Customizing Code Coverage Analysis](../codequality/customizing-code-coverage-analysis.md).  
...
### Custom .runsettings file with incorrect exclusions  
 ...
 Make sure the DataCollectors node specifies Code Coverage. Compare it with the sample in [Customizing Code Coverage Analysis](../codequality/customizing-code-coverage-analysis.md).  
