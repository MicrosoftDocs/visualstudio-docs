...
You can use the work item tracking feature to log work item from within [!INCLUDE[vsPreLong](../codequality/includes/vsprelong_md.md)]. To use this feature, your project must be part of Team Project in [!INCLUDE[esprfound](../codequality/includes/esprfound_md.md)].  
