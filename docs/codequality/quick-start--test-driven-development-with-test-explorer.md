...
## Using Test Explorer  
 ![Unit Test Explorer showing Run All button](../codequality/media/unittestexplorer-beta-.png "UnitTestExplorer(beta)")  
...
2.  Create a Test project.  
    ...
    -   In the **New Project** dialog, choose **Visual C#**, **Test** and then choose **Unit Test Project**.  
         ...
         ![New code and test projects](../codequality/media/unittestexplorerwalk1.png "UnitTestExplorerWalk1")  
...
7.  Select the items under **Stack Trace** to see where the test failed.  
 ...
 ![Unit Test Explorer showing failed test.](../codequality/media/unittestexplorerwalkthrough2.png "UnitTestExplorerWalkthrough2")  
...
2.  In Test Explorer, choose **Run All**.  
     ...
     ![Unit Test Explorer showing a passing test.](../codequality/media/unittestexplorerwalkthrough3.png "UnitTestExplorerWalkthrough3")  
...
2.  Choose **Run All**.  
     ...
     ![Unit Test Explorer showing 3 passed tests.](../codequality/media/unittestexplorerwalkthrough4.png "UnitTestExplorerWalkthrough4")