...
description: "A security transparent method calls a method in an assembly that is not marked with the System.Security.AllowPartiallyTrustedCallersAttribute (APTCA) attribute, or a security transparent method satisfies a System.Security.Permissions.SecurityAction.LinkDemand for a type or a method."
ms.date: 11/04/2016
ms.topic: reference
f1_keywords:
- CA2141
