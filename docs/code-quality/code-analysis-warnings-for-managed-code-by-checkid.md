...
| CA5385 | [CA5385 Use Rivest–Shamir–Adleman (RSA) algorithm with sufficient key size](../code-quality/ca5385.md) | When RSA's key size is less than 2048, it's vulnerable to brute force attacks. |
