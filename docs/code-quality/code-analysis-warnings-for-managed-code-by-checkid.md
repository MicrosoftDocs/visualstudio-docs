...
| CA5399 | [CA5399 Definitely disable HttpClient certificate revocation list check](../code-quality/ca5399.md) | Revoked certificate isn't trusted anymore, it could be used by attackers passing some malicious data or stealing sensitive data in HTTP communication. |
| CA5400 | [CA5400 Ensure HttpClient certificate revocation list check is not disabled](../code-quality/ca5400.md) | Revoked certificate isn't trusted anymore, it could be used by attackers passing some malicious data or stealing sensitive data in HTTP communication. |
