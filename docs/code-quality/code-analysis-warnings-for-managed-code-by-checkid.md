...
| CA5379 | [CA5379 Do Not Use Weak Key Derivation Function Algorithm](../code-quality/ca5379.md) | Some implementations of the <xref:System.Security.Cryptography.Rfc2898DeriveBytes> class allow for a hashAlgorithm to be specified in the constructor parameter or overwritten in the <xref:System.Security.Cryptography.Rfc2898DeriveBytes.HashAlgorithm> property. If this exists, then it should be used with <xref:System.Security.Cryptography.SHA256> or higher as the hashAlgorithm parameter. |
