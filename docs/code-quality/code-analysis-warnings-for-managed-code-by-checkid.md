...
| CA1825 |[CA1825: Avoid zero-length array allocations](../code-quality/ca1825.md) | Allocating a zero-length array leads to an unnecessary memory allocation. Instead, use the statically allocated empty array instance by invoking <xref:System.Array.Empty> method. This allocation is shared across all invocations of this method. |
