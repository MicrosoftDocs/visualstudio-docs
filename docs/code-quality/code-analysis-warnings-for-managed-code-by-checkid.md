...
| CA5387 | [CA5387 Do not use weak key derivation function with insufficient iteration count](../code-quality/ca5387.md) | This rule checks if the iteraration count is less than 100k definitely when invoking <xref:System.Security.Cryptography.Rfc2898DeriveBytes.GetBytes%2A>. |
| CA5388 | [CA5388 Ensure sufficient iteration count when using weak key derivation function](../code-quality/ca5388.md) | This rule checks if the iteraration count is less than 100k possibly when invoking <xref:System.Security.Cryptography.Rfc2898DeriveBytes.GetBytes%2A>. |
