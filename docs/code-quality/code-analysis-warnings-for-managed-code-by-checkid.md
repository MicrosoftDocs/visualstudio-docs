...
| CA5362 | [CA5362 Do Not Refer Self In Serializable Class](../code-quality/ca5362.md) | A field or property may participate in a reference cycle. The serialization of such classes will lead to memory exhaustion so that valid users can't access the service or surrounding envrionment could get impacted. |
