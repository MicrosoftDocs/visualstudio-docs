...
It is not required by compiler to clearly state that a method overrides its base. But this may lead to subtle issues if virtual specification ever changes in the hierarchy. This also decreases readability and makes interface’s polymorphic behavior less obvious. If method is clearly marked as ‘override’, it enables compiler to check consistency of the interface and help to spot issues before they manifest themselves at runtime.
