...
|[CA2248: Provide correct 'enum' argument to 'Enum.HasFlag'](../code-quality/ca2248.md)|The enum type passed as argument to the `HasFlag` method call is different from the calling enum type.|
