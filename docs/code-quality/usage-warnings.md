...
|[CA2249: Consider using String.Contains instead of String.IndexOf](../code-quality/ca2249.md)|Calls to `string.IndexOf` where the result is used to check for the presence or absence of a substring can be replaced by `string.Contains`.|
