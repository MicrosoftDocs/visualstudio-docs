...
description: "This warning fires on a method that binds a delegate that is marked with the System.Security.SecurityCriticalAttribute to a method that is transparent or that is marked with the System.Security.SecuritySafeCriticalAttribute, or that binds a delegate that is transparent or safe-critical to a critical method."
ms.date: 11/04/2016
ms.topic: reference
f1_keywords:
- CA2133
