...
- If it is a authentication cookie and is set as secure with <xref:Microsoft.AspNetCore.Authorization.AuthorizationMiddleware?displayProperty=fullName> in `Startup`, such as in the following example:
