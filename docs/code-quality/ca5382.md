...
- If the web.config is still available, for example, hosting on IIS, and the requireSSL attribute of system.web.httpCookies has already been set to true, such as in the following example:
