...
description: "A type participates in type equivalence and a either the type itself, or a member or field of the type, is marked with the System.Security.SecurityCriticalAttribute attribute."
ms.date: 11/04/2016
ms.topic: reference
f1_keywords:
  - "CA2131"
