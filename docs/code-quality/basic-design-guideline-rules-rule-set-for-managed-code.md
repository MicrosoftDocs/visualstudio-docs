...
ms.date: 11/04/2016
description: Learn about the Basic Design Guideline Rules rule set in Visual Studio, which can help make your code easier to understand and use. See rule descriptions.
