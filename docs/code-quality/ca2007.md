...
You can suppress this warning if you know that the consumer is a graphical user interface (GUI) app or if the consumer does not have a <xref:System.Threading.SynchronizationContext>.
