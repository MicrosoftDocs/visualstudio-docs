...
```ini
dotnet_code_quality.CA5393.unsafe_DllImportSearchPath_bits = 2 | 256 | 512
```

This enumeration allows a bitwise combination of its member values. So, you can also use it in the way below:
