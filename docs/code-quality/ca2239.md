...
description: "A type has a field that is marked with the System.Runtime.Serialization.OptionalFieldAttribute attribute and the type does not provide de-serialization event handling methods."
ms.date: 11/04/2016
ms.topic: reference
f1_keywords:
- CA2239
