...
```
 ...
 For more information, see [CreateProcess Function](https://docs.microsoft.com/windows/win32/api/processthreadsapi/nf-processthreadsapi-createprocessa) and [CloseHandle Function](http://go.microsoft.com/fwlink/?LinkId=181207).
