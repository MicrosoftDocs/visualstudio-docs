...
description: "An externally visible method contains a reference parameter of type <xref:System.Object?displayProperty=fullName>, and the containing assembly targets .NET Framework 2.0."
ms.date: 11/04/2016
ms.topic: reference
f1_keywords:
- CA1007
