...
|[CA2008: Do not create tasks without passing a TaskScheduler](../code-quality/ca2008.md)|A task creation or continuation operation uses a method overload that does not specify a <xref:System.Threading.Tasks.TaskScheduler> parameter.|
