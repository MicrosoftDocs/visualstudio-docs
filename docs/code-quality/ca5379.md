...
Because <xref:System.Security.Cryptography.MD5> or <xref:System.Security.Cryptography.SHA1> are vulnerable to collisions, use <xref:System.Security.Cryptography.SHA256> or higher when specifying the hash algorithm name for <xref:System.Security.Cryptography.Rfc2898DeriveBytes> or its derived classes.
...
### Specify the HashAlgorithm property of derived classes of Rfc2898DeriveBytes
