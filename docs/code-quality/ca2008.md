...
The following task creation and continuation methods in the .NET Framework have overloads that allow specifying or omitting a <xref:System.Threading.Tasks.TaskScheduler> instance:
