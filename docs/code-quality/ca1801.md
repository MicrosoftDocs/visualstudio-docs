...
- Serialization constructors ([see guidelines](https://docs.microsoft.com/dotnet/standard/serialization/serialization-guidelines#supporting-runtime-serialization)).
