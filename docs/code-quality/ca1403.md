...
description: "A Component Object Model (COM) visible value type is marked with the System.Runtime.InteropServices.StructLayoutAttribute attribute set to System.Runtime.InteropServices.LayoutKind.Auto."
ms.date: 11/04/2016
ms.topic: reference
f1_keywords:
