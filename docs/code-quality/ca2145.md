...
description: "A transparent method, a method that is marked with the System.Security.SecuritySafeCriticalAttribute method, or a type that contains a method is marked with the System.Security.SuppressUnmanagedCodeSecurityAttribute attribute."
ms.date: 11/04/2016
ms.topic: reference
f1_keywords:
  - "CA2145"
