...
Starting in version 3.0.0 of the analyzers, you can configure whether to exclude indirect base types from the rule. By default, this rule is set to true, which restricts analysis to the current base type.
