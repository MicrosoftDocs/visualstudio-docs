...
- [CA1502](/visualstudio/code-quality/ca1502)
...
2. Add the desired thresholds to the text file in the following format:
   ...
   In this example, rule [CA1502](/visualstudio/code-quality/ca1502) is configured to fire when a method's cyclomatic complexity is greater than 10.
