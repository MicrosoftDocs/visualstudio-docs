...
- [Terminating a Thread](https://docs.microsoft.com/windows/win32/procthread/terminating-a-thread)
- [WaitForSingleObject](https://docs.microsoft.com/windows/win32/api/synchapi/nf-synchapi-waitforsingleobject)
- [SetEvent](https://docs.microsoft.com/windows/win32/api/synchapi/nf-synchapi-setevent)
