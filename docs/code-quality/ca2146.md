...
description: "A transparent type is derived from a type that is marked with the System.Security.SecuritySafeCriticalAttribute or the System.Security.SecurityCriticalAttribute, or a type that is marked with the System.Security.SecuritySafeCriticalAttribute attribute is derived from a type that is marked with the System.Security.SecurityCriticalAttribute attribute."
ms.date: 11/04/2016
ms.topic: reference
f1_keywords:
  - "CA2146"
