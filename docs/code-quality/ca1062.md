...
1. Whether or not to analyze extension method 'this' parameter.
2. Specify null check validation methods in referenced libraries or projects, which validate that arguments passed to it are non-null.
3. Parts of codebase to exclude from analysis.
