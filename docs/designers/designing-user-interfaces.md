...
| Creating XAML UI while your app is running using XAML Hot Reload in Visual Studio and Blend for Visual Studio | [Write and debug running XAML code with XAML hot reload](../debugger/xaml-hot-reload.md) |
