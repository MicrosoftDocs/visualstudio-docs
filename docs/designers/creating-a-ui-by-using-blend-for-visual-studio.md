...
![Tools panel in Blend for Visual Studio](../designers/media/blend-tools-panel.png)
...
![Assets window in Blend for Visual Studio](../designers/media/blend-assets-window.png)
...
![Object and Timeline window in animation mode](../designers/media/storyboard-timeline.png)
