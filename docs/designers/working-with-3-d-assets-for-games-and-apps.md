---
title: "Working with 3D Assets for Games and Apps | Microsoft Docs"
ms.custom: ""
ms.date: "11/04/2016"
ms.technology:
  - "vs-ide-designers"
...
### 3D models
 ...
 You can use the [!INCLUDE[vsprvs](../code-quality/includes/vsprvs_md.md)] Model Editor to work with 3D models in several common formats.
...
|[Working with 3D Models](../designers/working-with-3-d-models.md)|Describes how to use [!INCLUDE[vsprvs](../code-quality/includes/vsprvs_md.md)] to work with 3D models.|
