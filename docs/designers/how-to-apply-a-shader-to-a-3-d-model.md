---
title: "How to: Apply a Shader to a 3D Model | Microsoft Docs"
ms.custom: ""
ms.date: "11/04/2016"
ms.technology:
  - "vs-ide-designers"
...
This document demonstrates how to use the Model Editor to apply a Directed Graph Shader Language (DGSL) shader to a 3D model.

 This document demonstrates this activity:

-   Applying a shader to a 3D model
...
#### To apply a shader to a 3D model
