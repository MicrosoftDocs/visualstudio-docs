...
|Language-specific|A resource file that contains strings localized for a language and a culture. For example, "fr-CA" for French Canadian.|
 ...
 For more information, see [Hierarchical Organization of Resources for Localization](/visualstudio/ide/hierarchical-organization-of-resources-for-localization?view=vs-2015&redirectedfrom=MSDN).
