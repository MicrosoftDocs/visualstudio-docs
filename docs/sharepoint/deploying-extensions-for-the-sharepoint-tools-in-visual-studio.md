...
description: Deploy extensions for SharePoint tools in Visual Studio. Use Visual Studio extension (VSIX) projects to create VSIX packages. Create VSIX packages manually.
