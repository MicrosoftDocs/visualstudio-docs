...
description: Provide packaging and deployment information in project items using feature properties, feature receivers, project output references, and safe control entities.
