...
|[Set up a general development environment for SharePoint](../../sharepoint/dev/general-development/set-up-a-general-development-environment-for-sharepoint)|Describes specific applications that are required for creating SharePoint Solutions|
