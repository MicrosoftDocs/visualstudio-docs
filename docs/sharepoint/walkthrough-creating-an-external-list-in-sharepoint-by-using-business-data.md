...
- Access to the AdventureWorks sample database. For more information about how to install the AdventureWorks database, see [SQL Server Sample Databases](https://archive.codeplex.com/?p=msftdbprodsamples).
