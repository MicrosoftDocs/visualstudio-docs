...
As of the last update to this page, the version of R Tools for Visual Studio (RTVS) was **1.0.30531.2148**. Your version may vary depending on your version of Visual Studio and whether you're using a preview channel.
...
To update your version of RTVS in Visual Studio 2017, go to the Visual Studio installer and select the **Update** button or go to [aka.ms/rtvs-current](https://aka.ms/rtvs-current)
