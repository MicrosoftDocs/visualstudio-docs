...
![Todo List Manager Screenshot](media/todo-list-sample.png){: style="width:50%;" }
{ .text-center }
...
1. Once extracted, use your favorite code editor to open the project. If you're in need of
    ...
    ![Screenshot of Visual Studio Code opened with the app loaded](media/ide-screenshot.png){: style="width:650px;margin-top:20px;"}
    {: .text-center }
