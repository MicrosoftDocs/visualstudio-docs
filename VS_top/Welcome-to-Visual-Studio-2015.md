...
### Test your app  
 ...
 Plan, create and run manual and automated tests for your app. Test plans, suites, test cases and your test results are stored in the cloud with Visual Studio Team Services or on-premises with Team Foundation Server. Learn more about [testing the application](../VS_IDE/Improve-Code-Quality.md).  
...
-   [Extensibility in Visual Studio](../Topic/Extensibility%20in%20Visual%20Studio.md)  
