...
### Clone a test plan and its test cases  
 ...
 ![Cloning test suites](../dv_TeamTestALM/media/MTR_Clone3.png "MTR_Clone3")  
...
|Test results|![Topic does not apply](../dv_TeamTestALM/media/DoesNotApply.gif "DoesNotApply")||  
