...
## Get started: Run unit tests with your builds  
 ...
 ![Build def, edit VS Test task](../dv_TeamTestALM/media/BUILD_EditVSTestTask.png "BUILD_EditVSTestTask")  
 ...
 ![Build definition: customize unit test run](../dv_TeamTestALM/media/BUILD_CustomizeUnitTests.png "BUILD_CustomizeUnitTests")  
 ...
 After your build finishes, [review your test results](../dv_TeamTestALM/Review-continuous-test-results-after-a-build.md). You can check the build summary or find the test run using the Runs tab in the Test hub:  
...
1.  [Create environments](../dv_TeamTestALM/Set-up-environments-for-continuous-testing-with-builds.md) from physical or virtual machines that you've already set up.  
  
2.  [Set up your build to run your app and tests](../dv_TeamTestALM/Set-up-continuous-testing-for-builds.md) in the environments that you created.  
  
3.  After your build finishes, [review your test results](../dv_TeamTestALM/Review-continuous-test-results-after-a-build.md) to start resolving problems that you found.  
...
4.  In your build definition, provide the path to the test framework:  
     ...
     ![Build def, VSTest task, custom test framework](../dv_TeamTestALM/media/BUILD_OtherTestFrameworks.png "BUILD_OtherTestFrameworks")  
