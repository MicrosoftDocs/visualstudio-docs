...
You can create your own validation rules. To do this, you derive your own rule class from a validation rule class. Validation rules derive from the <xref:Microsoft.VisualStudio.TestTools.WebTesting.ValidationRule?qualifyHint=False> base class.  
  
 Visual Studio Enterprise provides some predefined validation rules. For more information, see [Using Validation and Extraction Rules in Web Performance Tests](../Topic/Using%20Validation%20and%20Extraction%20Rules%20in%20Web%20Performance%20Tests.md).  
  
> [!NOTE]
>  You can also create custom extraction rules. For more information, see [Create custom code and plug-ins for load tests](../dv_TeamTestALM/Create-custom-code-and-plug-ins-for-load-tests.md).  
...
4.  Create a class that derives from the <xref:Microsoft.VisualStudio.TestTools.WebTesting.ValidationRule?qualifyHint=False> class. Implement the <xref:Microsoft.VisualStudio.TestTools.WebTesting.ValidationRule.Validate?qualifyHint=False> and <xref:Microsoft.VisualStudio.TestTools.WebTesting.ValidationRule.RuleName?qualifyHint=False> members.  
...
## See Also  
 <xref:Microsoft.VisualStudio.TestTools.WebTesting.ValidationRule?qualifyHint=False>   
 <xref:Microsoft.VisualStudio.TestTools.WebTesting.Rules?qualifyHint=False>   
 <xref:Microsoft.VisualStudio.TestTools.WebTesting.Rules.ValidateFormField?qualifyHint=False>   
 <xref:Microsoft.VisualStudio.TestTools.WebTesting.Rules.ValidationRuleFindText?qualifyHint=False>   
 <xref:Microsoft.VisualStudio.TestTools.WebTesting.Rules.ValidationRuleRequestTime?qualifyHint=False>   
 <xref:Microsoft.VisualStudio.TestTools.WebTesting.Rules.ValidationRuleRequiredAttributeValue?qualifyHint=False>   
 <xref:Microsoft.VisualStudio.TestTools.WebTesting.Rules.ValidationRuleRequiredTag?qualifyHint=False>   
 ...
 [How to: Add a Validation Rule to a Web Performance Test](../Topic/How%20to:%20Add%20a%20Validation%20Rule%20to%20a%20Web%20Performance%20Test.md)   
