 ...
 **Type**: **SCVMM** This option is disabled? Then you need to [set up SCVMM](../dv_TeamTestALM/Configure-Lab-Management-for-SCVMM-environments.md).  
...
|Stored Virtual Machine|When you add a virtual machine, an exact copy of it is made in your lab environment.<br /><br /> If you want to create more than one running copy of a stored VM, you will have to change the machine name. Typically, a stored virtual machine is part of a workgroup.<br /><br /> If you want to run tests on more than one set of machines without changing their domain names, consider setting up a [Network-Isolated Environment](../dv_TeamTestALM/Creating-and-using-a-network-isolated-environment.md).|  
...
###  <a name="advanced"></a> New Environment: Advanced  
 Advanced properties are used only for [automated system tests](../dv_TeamTestALM/Automate-system-tests.md).  
