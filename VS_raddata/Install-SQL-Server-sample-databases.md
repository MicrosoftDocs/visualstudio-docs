...
2.  In SQL Server Object Explorer, right-click any SQL Server database engine(for example, localdb), and select**New Query**.  
     ...
     ![SQL Server Object Explorer New Query](../VS_raddata/media/raddata-SQL-Server-Object-Explorer-New-Query.png "raddata SQL Server Object Explorer New Query")  
...
2.  In the SSMS **Object Explorer** window, right-click the **Databases** node, select**Restore Database**, and provide the location of the .bak file.  
     ...
     ![SSMS Restore Database](../VS_raddata/media/raddata-SSMS-Restore-Database.png "raddata SSMS Restore Database")