...
## Add a connection in Server Explorer  
 ...
 ![Server Explorer New Connection icon](../VS_raddata/media/raddata-Server-Explorer-New-Connection-icon.png "raddata Server Explorer New Connection icon")  
  
 This brings up the **Add Connection** dialog box. Here, we have entered the name of the SQL Server LocalDB instance.  
  
 ![Add New Connection](../VS_raddata/media/raddata-Add-New-Connection-Dialog.png "raddata Add New Connection Dialog")  
...
## Change the provider  
 ...
 ![Change AD0.NET Data Provider](../VS_raddata/media/raddata-Change-AD0.NET-Data-Provider.png "raddata Change AD0.NET Data Provider")  
...
## Test the connection  
 ...
 ![Test Connection](../VS_raddata/media/raddata-Test-Connection.png "raddata Test Connection")  
