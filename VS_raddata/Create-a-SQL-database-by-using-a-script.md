...
In this walkthrough, you use Visual Studio to create a small database that contains the sample code for [Create a simple data application by using ADO.NET](../VS_raddata/Create-a-simple-data-application-by-using-ADO.NET.md).  
  
 **In this topic**  
  
-   [Create a script that contains a database schema](../VS_raddata/Create-a-SQL-database-by-using-a-script.md#CreateScript)  
  
-   [Create a database project and import a schema](../VS_raddata/Create-a-SQL-database-by-using-a-script.md#CreateProject)  
  
-   [Deploy the database](../VS_raddata/Create-a-SQL-database-by-using-a-script.md#DeployDatabase)  
...
1.  In Visual Studio, on the menu bar, select **File** > **New** > **File**.  
