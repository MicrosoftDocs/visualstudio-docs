...
-   [Create a project and a local database file](../VS_raddata/Create-a-SQL-database-by-using-a-designer.md#BKMK_CreateNewSQLDB)  
  
-   [Create tables, columns, primary keys, and foreign keys](../VS_raddata/Create-a-SQL-database-by-using-a-designer.md#BKMK_CreateNewTbls)  
  
-   [Populate the tables with data](../VS_raddata/Create-a-SQL-database-by-using-a-designer.md#BKMK_Populating)  
...
3.  In the list of item templates, scroll down and select **Service-based Database**.  
     ...
     ![Item Templates dialog box](../VS_raddata/media/raddata-VSItemTemplates.png "raddata VSItemTemplates")  
...
6.  Name the Customers table by updating the first line in the script pane to match the following sample:  
    ...
    ```  
     ...
     ![Table Designer](../VS_raddata/media/raddata-Table-Designer.png "raddata Table Designer")  
...
1.  In the context pane on the right side of the grid, open the shortcut menu for **Foreign Keys**, and then select **Add New Foreign Key**, as the following illustration shows.  
     ...
     ![Adding a foreign key in Table Designer](../VS_raddata/media/ForeignKey.png "ForeignKey")  
