...
## In This Section  
 ...
 Allows you to select which <xref:System.Windows.Forms.BindingSource?qualifyHint=False> to use when more than one <xref:System.Windows.Forms.BindingSource?qualifyHint=False> is available.  
...
## Related Sections  
 [Accessing Data](../VS_raddata/Accessing-data-in-Visual-Studio.md)  
